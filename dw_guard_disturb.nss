//::///////////////////////////////////////////////
//:: FileName dw_guard_disturb
//:://////////////////////////////////////////////
/*
    When the object this script is attached to is disturbed, the script finds the nearest
    creature of the same faction and gets them to attack the disturber.
    NB - if a member of a chest's faction sees the chest get opened they will attack regardless.
*/
//:://////////////////////////////////////////////
...
void main()
{
object Player1 = GetLastDisturbed();
...
//This long "for"-sentence ultimately finds the closest creature of the same faction of the chest/door.
for (i=0; i<=19; i++)
{
    if (i==0)
    {
...
//Player is attacked when they disturb the object.
