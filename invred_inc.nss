...
const int InvRed_MAXIMO_ARMADURAS              = 4;
const int InvRed_MAXIMO_ARMAS_2MANOS           = 4;
const int InvRed_MAXIMO_ARMAS_PEQUENIAS        = 8;
const int InvRed_MAXIMO_ARMAS_PRINCIPALES      = 6;
const int InvRed_MAXIMO_ARROJADIZAS            = 400;
const int InvRed_MAXIMO_ARCOS                  = 4;
const int InvRed_MAXIMO_BALLESTAS              = 4;
const int InvRed_MAXIMO_BOTAS                  = 8;
const int InvRed_MAXIMO_CINTURONES             = 8;
const int InvRed_MAXIMO_CAPAS                  = 6;
const int InvRed_MAXIMO_CASCOS                 = 4;
const int InvRed_MAXIMO_DAGAS                  = 12;
const int InvRed_MAXIMO_ESCUDOS                = 4;
const int InvRed_MAXIMO_ESPADAS                = 8;
const int InvRed_MAXIMO_ESPADAS_CORTAS         = 8;
const int InvRed_MAXIMO_FLECHAS                = 600;
const int InvRed_MAXIMO_GUANTES                = 8;
const int InvRed_MAXIMO_PIEDRAS                = 600;
const int InvRed_MAXIMO_POCIONES               = 20;
const int InvRed_MAXIMO_ROPA                   = 12;
const int InvRed_MAXIMO_VARITAS                = 20;
const int InvRed_MAXIMO_VIROTES                = 600;
...
if (GetLocalInt(oPC, ESTADO_INVENTARIO_REDUCIDO)==INVENTARIO_REDUCIDO_ACTIVADO && GetLocalInt(GetArea(oPC), InvRed_AREA_PERMITE_CRAFT)==FALSE) {
    ...
    switch (tipoBase) {
        ...
        case BASE_ITEM_CLUB:           maximo = InvRed_MAXIMO_ARMAS_PEQUENIAS;
                                       variableParaModificar = InvRed_CANTIDAD_ARMAS_PEQUENIAS_PJ; mensaje = "armas peque�as";
                                       break;
