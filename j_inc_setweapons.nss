...
// sets the bracer and gloves to use.
void StoreUnarmedWeapon(object oTarget, object oItem = OBJECT_INVALID);
...
void SetWeapons(object oTarget = OBJECT_SELF)
{
    if(GetLocalInt(oTarget, AI_LAST_SETWEAPONS_TIME))return;
    SetLocalInt(oTarget, AI_LAST_SETWEAPONS_TIME, TRUE);
    // Just set effects every round, not every possible action (2 with haste)
//    DelayCommand(f3, DeleteLocalInt(oTarget, AI_LAST_SETWEAPONS_TIME));
    DelayCommand(f6, DeleteLocalInt(oTarget, AI_LAST_SETWEAPONS_TIME));
    ...
    CreatureMonk = GetLevelByClass(CLASS_TYPE_MONK);
...
void SortInventory(object oTarget)
{
        ...
        iCnt++)
    {
        ...
        if(GetIsObjectValid(oItem))
        {
            ...
            if(iCnt==i4)SetLocalInt(oTarget,AI_EQUIPED_VALUE_RIGHT_HAND,CurrentItemValue);
            if(iCnt==i5)SetLocalInt(oTarget,AI_EQUIPED_VALUE_LEFT_HAND,CurrentItemValue);
        }
        else
        {
            if(iCnt==i4)SetLocalInt(oTarget,AI_EQUIPED_VALUE_RIGHT_HAND,FALSE);
            if(iCnt==i5)SetLocalInt(oTarget,AI_EQUIPED_VALUE_LEFT_HAND,FALSE);
        }
    }
...
//        {
            DoEffectsOf(oTarget, oItem);
//        }
            SetLocalInt(oTarget,AI_EQUIPED_VALUE_GLOVES,CurrentItemValue);
        }
        else
        {
            SetLocalInt(oTarget,AI_EQUIPED_VALUE_GLOVES,FALSE);
        }
    }
...
void BaseEffects(object oTarget, object oItem)
{
    // Reset value
    CurrentItemValue = i0;
    CurrentItemIsUnlimited = FALSE;
    CurrentItemIsMighty = FALSE;
    if(GetIsObjectValid(oItem))
    {
        ...
        while(GetIsItemPropertyValid(ip))
        {
            switch(GetItemPropertyType(ip))
            {
                case ITEM_PROPERTY_ABILITY_BONUS:
                    switch(GetItemPropertySubType(ip))
                    {
                        ...
                        case ABILITY_CONSTITUTION:
                            CurrentItemValue += GetItemPropertyCostTableValue(ip);
                            break;
                        default:
                            CurrentItemValue += GetItemPropertyCostTableValue(ip)/i2;
                            break;
                    }
                    break;
                ...
                case ITEM_PROPERTY_AC_BONUS_VS_DAMAGE_TYPE:
                    CurrentItemValue += GetItemPropertyCostTableValue(ip)/i3;
                    break;
                case ITEM_PROPERTY_AC_BONUS_VS_RACIAL_GROUP:
                    CurrentItemValue += GetItemPropertyCostTableValue(ip)/i4;
                    break;
                case ITEM_PROPERTY_AC_BONUS_VS_SPECIFIC_ALIGNMENT:
                    CurrentItemValue += GetItemPropertyCostTableValue(ip)/i6;
                    break;
                ...
                case ITEM_PROPERTY_ENHANCEMENT_BONUS:
                    CurrentItemValue += (GetItemPropertyCostTableValue(ip)*i3)/i2;
                    break;
...
//                    break;
        ...
        // Set is unlimited to TRUE or FALSE, add 10 if TRUE.
                case ITEM_PROPERTY_UNLIMITED_AMMUNITION:
                    CurrentItemIsUnlimited = TRUE;
                    CurrentItemValue += i10;
                    break;
        // Same as above, for mighty
                case ITEM_PROPERTY_MIGHTY:
                    CurrentItemIsMighty = TRUE;
                    CurrentItemValue += i3;
                    break;
            }
        ...
        case BASE_ITEM_DIREMACE:
        {
            ...
            if(ProfExotic == TRUE)// We are proficient in exotics...
            {
                ...
                CurrentItemValue +=     // We add onto the current value some things...
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_DIREMACE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_DIREMACE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_DOUBLEAXE:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_DOUBLEAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_DOUBLEAXE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_TWOBLADEDSWORD:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_TWOBLADEDSWORD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_TWOBLADEDSWORD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_GREATAXE:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_GREATAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_GREATAXE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_GREATSWORD:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_GREATSWORD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_GREATSWORD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_HALBERD:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_HALBERD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_HALBERD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_HEAVYFLAIL:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_HEAVYFLAIL) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_HEAVYFLAIL) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SCYTHE:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SCYTHE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_SCYTHE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SHORTSPEAR:
        {
            if(ProfSimple == TRUE || ProfDruid == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SHORTSPEAR) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_SHORTSPEAR) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_MAGICSTAFF:
        {
               ...
               ProfMonk == TRUE || ProfDruid == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_QUARTERSTAFF) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_QUARTERSTAFF) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_LONGBOW:
        {
              ...
              (ProfMartial == TRUE || ProfElf == TRUE))
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LONGBOW) * i50) +// Adds 50 if can do deadly criticals in it
        ...
        case BASE_ITEM_BASTARDSWORD:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_BASTARDSWORD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_BASTARDSWORD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_BATTLEAXE:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_BATTLEAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_BATTLEAXE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_DWARVENWARAXE:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_DWAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_DWAXE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_CLUB:
        {
               ...
               ProfMonk == TRUE || ProfDruid == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_CLUB) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_CLUB) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_KATANA:
        {
            if(ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_KATANA) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_KATANA) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_LIGHTFLAIL:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LIGHTFLAIL) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_LIGHTFLAIL) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_LONGSWORD:
        {
            if(ProfMartial == TRUE || ProfElf == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LONGSWORD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_LONGSWORD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_MORNINGSTAR:
        {
            if(ProfSimple == TRUE || ProfRogue == TRUE) // Primary only
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_MORNINGSTAR) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_MORNINGSTAR) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_RAPIER:
        {
            if(ProfRogue == TRUE || ProfMartial == TRUE || ProfElf == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_RAPIER) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_RAPIER) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SCIMITAR:
        {
            if(ProfMartial == TRUE || ProfDruid == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SCIMITAR) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_SCIMITAR) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_WARHAMMER:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_WARHAMMER) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_WARHAMMER) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_HEAVYCROSSBOW:
        {
                ...
                ProfRogue == TRUE || ProfMonk == TRUE))
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_HEAVYCROSSBOW) * i50) +// Adds 50 if can do deadly criticals in it
        ...
        case BASE_ITEM_SHORTBOW:
        {
              ...
              (ProfRogue == TRUE || ProfMartial == TRUE || ProfElf == TRUE))
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SHORTBOW) * i50) +// Adds 50 if can do deadly criticals in it
        ...
        case BASE_ITEM_HANDAXE:
        {
            if(ProfMonk == TRUE || ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_HANDAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_HANDAXE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_KAMA:
        {
            if(ProfMonk == TRUE || ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_KAMA) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_KAMA) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_LIGHTHAMMER:
        {
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LIGHTHAMMER) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_LIGHTHAMMER) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_LIGHTMACE:
        {
            if(ProfSimple == TRUE || ProfRogue == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LIGHTMACE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_LIGHTMACE) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SHORTSWORD:
        {
            if(ProfRogue == TRUE || ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SHORTSWORD) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_SHORTSWORD) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SICKLE:
        {
            if(ProfSimple == TRUE || ProfDruid == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SICKLE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_SICKLE) * i20) +// Adds 20 if choice weapon
...
//              (ProfSimple == TRUE || ProfRogue == TRUE || ProfDruid == TRUE))
            if(ProfSimple == TRUE || ProfRogue == TRUE || ProfDruid == TRUE)
            {
                CurrentItemDamage = i4;// Set max damage.
                CurrentItemValue += (CurrentItemDamage +
                      (CurrentItemIsMighty * CreatureStrength) +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_DART) * i50) +// Adds 50 if can do deadly criticals in it
...
//               ProfRogue == TRUE || ProfMonk == TRUE))
               ...
               ProfRogue == TRUE || ProfMonk == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_LIGHTCROSSBOW) * i50) +// Adds 50 if can do deadly criticals in it
...
//              (ProfSimple == TRUE || ProfMonk == TRUE || ProfDruid == TRUE))
            if(ProfSimple == TRUE || ProfMonk == TRUE || ProfDruid == TRUE)
            {
                CurrentItemDamage = i4;// Set max damage.
                CurrentItemValue += (CurrentItemDamage +
                      (CurrentItemIsMighty * CreatureStrength) +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SLING) * i50) +// Adds 50 if can do deadly criticals in it
...
//            if(CreatureSize <= CREATURE_SIZE_LARGE && ProfMartial == TRUE)
            if(ProfMartial == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      (CreatureStrength) +
                      (GetHasFeat(FEAT_WEAPON_SPECIALIZATION_THROWING_AXE)) +
                      (GetHasFeat(FEAT_IMPROVED_CRITICAL_THROWING_AXE) * i2) +
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_THROWINGAXE) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_FOCUS_THROWING_AXE) * i2));
                StoreRangedWeapon(oTarget, oItem);
            }
        }
        break;
...
void BaseTinyWeapons(object oTarget, object oItem)
{
    switch (CurrentItemType)
    {
        case BASE_ITEM_DAGGER:
        {
               ...
               ProfMonk == TRUE || ProfDruid == TRUE))
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_DAGGER) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_DAGGER) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_KUKRI:
        {
            ...
            ProfExotic == TRUE)
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_KUKRI) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_OF_CHOICE_KUKRI) * i20) +// Adds 20 if choice weapon
        ...
        case BASE_ITEM_SHURIKEN:
        {
              ...
              (ProfMonk == TRUE || ProfExotic == TRUE))
            {
                ...
                CurrentItemValue += (CurrentItemDamage +
                      ...
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_SHURIKEN) * i50) +// Adds 50 if can do deadly criticals in it
        ...
        case BASE_ITEM_GLOVES:
            // monk unarmed check
            int iMonkLevels = CreatureMonk;
            if(iMonkLevels)
            {
                if(iMonkLevels<i4)
                {
                    CurrentItemDamage=(GetCreatureSize(OBJECT_SELF)>=CREATURE_SIZE_MEDIUM)?i6:i4;
                }
                else if(iMonkLevels<i8)
                {
                    CurrentItemDamage=(GetCreatureSize(OBJECT_SELF)>=CREATURE_SIZE_MEDIUM)?i8:i6;
                }
                else if(iMonkLevels<i12)
                {
                    CurrentItemDamage=(GetCreatureSize(OBJECT_SELF)>=CREATURE_SIZE_MEDIUM)?i10:i8;
                }
                else if(iMonkLevels<i16)
                {
                    CurrentItemDamage=(GetCreatureSize(OBJECT_SELF)>=CREATURE_SIZE_MEDIUM)?i12:i10;
                }
                else
                {
                    CurrentItemDamage=(GetCreatureSize(OBJECT_SELF)>=CREATURE_SIZE_MEDIUM)?i20:i12;
                }
                if(GetHasFeat(FEAT_WEAPON_FINESSE))
                {
                    CurrentItemDamage+=CreatureStrength;
                }
                CurrentItemValue += CurrentItemDamage +
                      (GetHasFeat(FEAT_IMPROVED_UNARMED_STRIKE) * i2) +
                      (GetHasFeat(FEAT_EPIC_WEAPON_SPECIALIZATION_UNARMED)) +
                      (GetHasFeat(FEAT_IMPROVED_CRITICAL_UNARMED_STRIKE) * i2) +
                      (GetHasFeat(FEAT_EPIC_DEVASTATING_CRITICAL_UNARMED) * i50) +// Adds 50 if can do deadly criticals in it
                      (GetHasFeat(FEAT_WEAPON_FOCUS_UNARMED_STRIKE) * i2);
                StoreUnarmedWeapon(oTarget, oItem);
            }
        break;
    }
}
...
void StoreUnarmedWeapon(object oTarget, object oItem = OBJECT_INVALID)
{
    // We insert the value into an array of all bracer and gloves, based
    // on value.
    ArrayOfWeapons(AI_WEAPON_GLOVES, oTarget, oItem, CurrentItemValue);
}
...
int GetWeaponSize(object oItem)
{
    switch(GetBaseItemType(oItem))
    {
        ...
        case BASE_ITEM_BRACER:
        case BASE_ITEM_GLOVES:
            return (CreatureMonk)?WEAPON_SIZE_TINY:FALSE;
        break;
        case BASE_ITEM_DAGGER:
        case BASE_ITEM_KUKRI:
        case BASE_ITEM_SHURIKEN:
...
void DeleteAllPreviousWeapons(object oTarget)
{
    ...
    DeleteDatabase(oTarget, AI_WEAPON_GLOVES);
