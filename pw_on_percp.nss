...
void main()
{
    ...
    {
        if(GetLastPerceptionSeen()&&(GetLocalInt(OBJECT_SELF,"PW_SURFACED")!=TRUE))
        {
            SetLocalInt(OBJECT_SELF,"PW_SURFACED",TRUE);
            effect eF = EffectAppear();
            ...
            DelayCommand(4.0, ResetBurrowing());
        }
        return;
    }
