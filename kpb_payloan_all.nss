...
int nNewBalanceF = (nBalance + (nNewInterest * 8));
  ...
  SetCampaignInt("kpb_bank", "KPB_LOAN_AMT", 0, oPC);
    ...
    if (nGold < nBalance)
  {
  SpeakString("Lo siento, no tiene suficiente para pagar este prestamo.", TALKVOLUME_TALK);
  }
  }
  ...
  SpeakString("Usted pago " + IntToString(nNewBalance) + " Monedas. No debe nada mas.", TALKVOLUME_TALK);
    if (nTotalDays >= 5)
    {
 ...
 SpeakString("Usted pago " + IntToString(nNewBalance) + " Monedas. No debe nada mas.", TALKVOLUME_TALK);
  ...
  SetCampaignInt("kpb_bank", "KPB_LOAN_AMT", 0, oPC);
    ...
    if (nGold < nNewBalanceD)
  {
  SpeakString("No tiene suficiente dinero.", TALKVOLUME_TALK);
  }
  }
  ...
  SetCampaignInt("kpb_bank", "KPB_LOAN_AMT", 0, oPC);
        ...
        if (nGold < nNewBalanceE)
  {
  SpeakString("Lo siento, no tiene lo suficiente para pagar este prestamo.", TALKVOLUME_TALK);
  }
  }
