...
if(GetLocalInt(oMod, "Team1") < 1)
{
SendMessageToPC(oPC, "El otro equipo esta vacio");
return;
}
SetLocalInt(oPC, "Confirmo", 1);
SetLocalInt(oMod, "Confirmaciones2", GetLocalInt(oMod, "Confirmaciones2")+1);
SendMessageToPC(oPC, IntToString(GetLocalInt(oMod, "Confirmaciones2"))+" Confirmaciones de "+IntToString(GetLocalInt(oMod, "Team2"))+ " Hechas");
