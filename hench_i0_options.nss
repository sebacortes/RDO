...
const int HENCH_GENAI_ENABLEHEARING = 0x0002;     // (obsolete) PC can use inventory on associates
...
const int HENCH_MONAI_WANDER  = 0x0000;      // monsters can wander
...
const int HENCH_MONAI_HASTE   = 0x0000;      // monsters haste themselves after being damaged
const int HENCH_MONAI_HEALPT  = 0x0000;      // monsters generate heal potions
const int HENCH_MONAI_COMP    = 0x0000;      // monsters summon familiars and animal companions
