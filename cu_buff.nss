...
void DoBuff(int nBuffType, object oTarget)
{
    ...
    if(nBuffType == 1 || nBuffType == 3) // short or all buffs
    {
        ...
        HandleSpell(SPELL_SPELL_MANTLE, 9, 1);
        ...
        HandleSpell(SPELL_UNDEATHS_ETERNAL_FOE, 0, 1);
    }
    if(nBuffType == 2 || nBuffType == 3) // long or all buffs
    {
        ...
        HandleSpell(SPELL_GREATER_MAGIC_WEAPON, 10, 0);
        HandleSpell(SPELL_MAGIC_WEAPON, 10, 0);
        HandleSpell(SPELL_DARKFIRE, 11, 0);
        HandleSpell(SPELL_FLAME_WEAPON, 11, 0);
