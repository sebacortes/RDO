...
{
   if (IPGetWeaponEnhancementBonus(oMyWeapon)<= nBonus)
    ...
    */
    ...
    if(GetIsObjectValid(oMyWeapon) )
    {
        ...
        if (nDuration>0)
        {
            ...
            SPApplyEffectToObject(DURATION_TYPE_TEMPORARY, eDur, GetItemPossessor(oMyWeapon), HoursToSeconds(nDuration),TRUE,-1,APal);
