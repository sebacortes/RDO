...
const int GlobalImmunityKnockdown                 = 0x00020000; // realy?
...
int GlobalIntelligence, GlobalIntelligenceScore, GlobalOurHitDice, GlobalOurSize, GlobalOurAC,
GlobalOurBaseAttackBonus, // Used and set for melee. USes GetBaseAttackBonus, as weapons are not set.
GlobalOurBestAttackBonus,
GlobalMeleeTargetBestAttackBonus,
...
GlobalUseSpellPercent, // = number of spell/(number of spell + number of ability)
GlobalSelfBuffer,
GlobalWeAreBuffer, // Are we a spell buffer? AI_FLAG_COMBAT_MORE_ALLY_BUFFING_SPELLS
GlobalSpellFailure,
GlobalIamBlocked, // i'm blocked, can't move away.
GlobalIamBlockedByObject, // i'm blocked by object, enemy or friend, anyway.
GlobalLocationTargetFail, // in underdark tileset, location targeting always fails.
GlobalAntiMeleeWarrior, // enemy with no caster.
GlobalAntiArcaneSpellCaster, // need special action for spellcaster enemy.
GlobalCounterSpellTargetPercentage, // we are marked with counterspell
GlobalPreventSpellDupleUse;  // for sorcerer or etc, prevent to use same spell repeatedly.
...
GlobalAOETargetObject,
GlobalCounterSpellTarget,
...
GlobalLeftHandWeapon, GlobalRightHandWeapon, GlobalGloveInArms,
GlobalLastAttacker;
...
// - Target HD, HP and race, and is RDD(fire immune)?
...
// hey. it's don't work. use GlobalFriendlyFire.
// GlobalFriendlySelectiveHostile : hit enemy only.
GlobalFriendlyFireHostile, GlobalFriendlyFireFriendly,
GlobalFriendlyFire, GlobalFriendlySelectiveHostile=i2,
...
// if there are no enemy that be seen or heard... very long ranged attack.
GlobalNoneSeenHeardEnemy,
// check last attacker valid
GlobalLastAttackerValid;

// RANGES, Ie FLOATS :-)
float GlobalRangeToMeleeTarget, GlobalSpellTargetRange, GlobalRangeToNearestEnemy,
GlobalRangeToAlly, GlobalOurReach, GlobalRangeToFuthestEnemy, GlobalBuffRangeAddon, GlobalDelayTime;

// One location - GlobalSummonLocation - for summon location :-)
location GlobalSummonLocation,
GlobalAOETargetLocation;
...
// - iMaxLoopRun : set how many check touch range.
int AI_AttemptAllSpells(int iHighestSpellLevel = i10, int iLowestSpellLevel = i0, int iMaxLoopRun = i2, int iLastCheckedRange = i1, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
...
// attempt AOE spell wrapper
int AI_AttemptCastAOESpell(int nSpell, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE);
// attempt AOE spell wrapper + object version.
int AI_AttemptCastAOESpellToObject(int nSpell, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE);
// attempt AOE spell wrapper, random version.
int AI_AttemptCastAOESpellRandom(int nSpell, int nRandom, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE);
// attempt AOE spell wrapper, random version. + object only version.
int AI_AttemptCastAOESpellToObjectRandom(int nSpell, int nRandom, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE);
// attempt instant death spells, or relate ability.
int AI_AttemptDeathSpells(int nPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// death spell
int AI_AttemptDeathSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// death ability
int AI_AttemptDeathAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// attempt mind affect spells, or relate ability.
int AI_AttemptMindSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// mind spell
int AI_AttemptMindSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// mind ability
int AI_AttemptMindAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// attempt special effect effect spells, or relate ability.
// drain, petrify, bigby... etc
int AI_AttemptEffectSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// effect spell
int AI_AttemptEffectSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// effect ability
int AI_AttemptEffectAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// attempt damage dealing spells, or relate ability.
int AI_AttemptDamageSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// damage spell
int AI_AttemptDamageSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// damage ability
int AI_AttemptDamageAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE);
// attempt additional buff spells.
int AI_AttemptAddBuffSpells(int iPriority);
// attmept ally buff spells.
int AI_AttmeptAllyBuffSpells(int iPriority);
// attempt summon spells, or relate ability.
int AI_AttemptSummonSpells();
// Important buff spell
int AI_CoreBuffSpell();
//***************************** AttemptSpell ***********************************
...
// Get best attack roll
int AI_GetBestAttackRoll(object oTarget=OBJECT_SELF);
//***************************** AttemptAttack **********************************
...
// tactical flee and hide
int AI_TacticFleeHide();
...
// beware shield damage.
// Get target has shield damage magic, or target is black blade of disaster(or mordenkainen's sword)
// return value=1 : swords, =2 : shield effect. =3 : target has damage shield but uncommandable.
int AI_GetIsMustDispelMeleeTarget(object oTarget);
...
// This will run through most avalible protections spells.
// - TRUE if we cast any.
// Used when ethereal to protect before we break the etherealness.
// - We may cast many on allies too
int AI_ActionCastWhenEthereal();
// cast caster ability increase effect spells - ,EAGLE_SPLENDOR, FOXS_CUNNING, OWLS_WISDOM
int AI_ActionCastCasterAbilitySpell();
...
int AI_ActionCastAllyBuffSpell(float fMaxRange, int iPercent, int iSpellToUse1, int iSpellToUse2 = -1, int iSpellToUse3 = -1, int iSpellToUse4 = -1, int iSpellOther1 = -1, int iSpellOther2 = -1, int iEffect = FALSE, int iSpellEffect = FALSE);
...
// - Then loops seen allies within 20M.
// See: AI_AttemptCureCondition
object AI_GetNearestAllyWithSpell(int iSpell, int iSpell1 = iM1, int iSpell2 = iM1, int iSpell3 = iM1);
...
// uses the item, if it is an equal talent. location version
int AI_ActionCastItemEqualToLocation(location lLocation, int iSpellID);
...
int AI_ActionCastSpellAtLocation(int iSpellID, int nTalent, location lLocation, int iRequirement = 0, int iItemTalentValue = -1);
...
// for fake anti magic to ally
void AI_DoRemoveEffects(object oTarget);
...
// Get any Mode is turned on.
int AI_GetMeleeMode();
// Get have any sneak attack
int AI_GetHaveSneakAttack(object oTarget=OBJECT_SELF);
// ActionMoveAwayFromObject + action in corner
void AI_AntiCornerMoveAway(object oFrom,int bRun=FALSE,float fMoveAwayRange=40.0f,int bBlocked=FALSE);
// check blocked or not.
void AI_BlockedCheck();
...
object AI_GetBestAreaSpellTarget(float fRange, float fSpread, int nLevel, int iSaveType = FALSE, int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE, int iDeathImmune = FALSE, int iNecromanticSpell = FALSE, int iDamageSpell = FALSE);
//set GlobalAOETargetObject
//set GlobalAOETargetLocation
// 0=false, 1=valid object and location, 2=valid but one enemy-use object?
int AI_GetBestAreaSpellTargetAndLocation(float fRange, float fSpread, int nLevel, int iSaveType = FALSE, int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE);
...
// check around of caster for meteor swarm
int AI_GetAreaCheckForMeteor();
...
// Returns TRUE if any of the checks the oGroupTarget is immune to.
int AI_AOENecroDeathDrainMindCheck(object oGroupTarget, int iNecromanticSpell, int iDeathImmune, int iNegativeImmune, int iMindImmune, int iMindType);
...
// is allys in shape?
int AI_GetIsAllyInShape(int nShape, float fSize, location lTarget, int bLineOfSight=FALSE, int nObjectFilter=OBJECT_TYPE_CREATURE, vector vOrigin=[0.0,0.0,0.0]);
// bigby check
// 1: spell is on, 2: spell and effect is on.
int AI_GetIsBigbyOn(object oTarget);
// enemy type is arcane spell caster?
int AI_GetIsArcaneCaster(object oTarget);
// enemy type is spell caster?
int AI_GetIsSpellCaster(object oTarget);
// target is spell castable?
int AI_GetIsTargetCastable(object oTarget);
// return percentage with spelltarget saving throw and DC
int AI_GetPercentageDC(int iDC, int nSavingThrowType);
// if cheat cast needed?
int AI_CheatCastCheck(int nSpell);
// is ranged attacker? : archer or caster...
int AI_GetIsRangedAttacker(object oTarget);
// get counterspell possibility
int AI_GetCounterSpellPossibility(object oTarget,object oSource=OBJECT_SELF);
...
void AI_SetUpUsEffects()
{
    ...
    GlobalSpellFailure = AI_GetAIHaveEffect(GlobalEffectSpellFailure);
}
// Gets the percent, of X vs Y,  iNumber/iTotal * 100 = %.
int AI_GetPercentOf(int iNumber, int iTotal)
{
    return FloatToInt((IntToFloat(iNumber)/iTotal)*i100);
}
...
void AI_EquipBestShield()
{
    // wizard or sorceror must not equip shield...
    if(AI_GetIsArcaneCaster(OBJECT_SELF) && !GetHasFeat(FEAT_EPIC_AUTOMATIC_STILL_SPELL_3) && SpellAnySpellValid)
    {
        object oShield=GetItemInSlot(INVENTORY_SLOT_LEFTHAND);
        if(GetIsObjectValid(oShield) && (GetBaseItemType(oShield)==BASE_ITEM_LARGESHIELD || GetBaseItemType(oShield)==BASE_ITEM_SMALLSHIELD || GetBaseItemType(oShield)==BASE_ITEM_TOWERSHIELD))
        {
...
{
    int iCnt;
    if(GetHasFeat(FEAT_SNEAK_ATTACK,oTarget)) return TRUE;
    // assasin death attack and blackguard sneak attack
    for(iCnt=455;iCnt<=462;iCnt++)
    {
        if(GetHasFeat(iCnt,oTarget)) return TRUE;
    }
    return FALSE;
}
...
void AI_AntiCornerMoveAway(object oFrom,int bRun=FALSE,float fMoveAwayRange=40.0f,int bBlocked=FALSE)
{
    ...
    vector vec,vecFrom;
    float face=GetFacing(OBJECT_SELF);
    int nmapx,nmapy,iTo;

    if(GetDistanceBetween(OBJECT_SELF,oFrom)>fMoveAwayRange) return;

    nmapx=GetAreaWidth(oArea)*i10;
    nmapy=GetAreaHeight(oArea)*i10;
    vec=GetPosition(OBJECT_SELF);
    // set last position for block check.
    SetLocalFloat(OBJECT_SELF,AI_LAST_X,vec.x);
    SetLocalFloat(OBJECT_SELF,AI_LAST_Y,vec.y);
    SetLocalFloat(OBJECT_SELF,AI_LAST_Z,vec.z);

    vecFrom=GetPosition(oFrom);

    // corner check
    // let's think about corner only. cant' make move in maze type map.
    vecFrom-=vec;

    // when blocked
    // maybe, the direction to the enemy is the only route..
    if(bBlocked)
    {
        float randto=VectorToAngle(vecFrom);
        randto+=(d2()==i1)?Random(i40)+i20:-(Random(i40)+i20);
        ActionMoveToLocation(Location(oArea,vec+vecFrom+AngleToVector(randto)*fMoveAwayRange,face),bRun);
        return;
    }
    // in the corner
    if((vec.x<f2 && vec.y<f2) ||
        (vec.x<f2 && vec.y>nmapy-f2) ||
        (vec.x>nmapx-f2 && vec.y<f2) ||
        (vec.x>nmapx-f2 && vec.y>nmapy-f2))
    {
        if(fabs(vecFrom.x)>fabs(vecFrom.y))
        {
            if(vec.y<f2)
                iTo=i1;
            else if(vec.y>nmapy-f2)
                iTo=iM1;
            //            iTo=(vecFrom.y>f0)?i1:iM1;
            ActionMoveToLocation(Location(oArea,Vector(vec.x,vec.y+(iTo*fMoveAwayRange),vec.z),face),bRun);
            return;
        }
        else
        {
            if(vec.x<f2)
                iTo=i1;
            else if(vec.x>nmapx-f2)
                iTo=iM1;
            //            iTo=(vecFrom.x>f0)?i1:iM1;
            ActionMoveToLocation(Location(oArea,Vector(vec.x+(iTo*fMoveAwayRange),vec.y,vec.z),face),bRun);
            return;
        }
    }
    // additional move
    // normal move is slow
    //move y factor
    if(vec.x<f2 || vec.x>nmapx-f2)
    {
        iTo=(vecFrom.y>f0)?iM1:i1;
        ActionMoveToLocation(Location(oArea,Vector(vec.x,vec.y+(iTo*fMoveAwayRange),vec.z),face),bRun);
        return;
    }
    // move x factor
    if(vec.y<f2 || vec.y>nmapy-f2)
    {
        iTo=(vecFrom.x>f0)?iM1:i1;
        ActionMoveToLocation(Location(oArea,Vector(vec.x+(iTo*fMoveAwayRange),vec.y,vec.z),face),bRun);
        return;
    }
...
void AI_BlockedCheck()
{
    float fm1=-1.0;
    float x,y,z,moved;
    vector vec=GetPosition(OBJECT_SELF);
    int iPblocked;
    x=GetLocalFloat(OBJECT_SELF,AI_LAST_X);
    y=GetLocalFloat(OBJECT_SELF,AI_LAST_Y);
    z=GetLocalFloat(OBJECT_SELF,AI_LAST_Z);

    GlobalIamBlockedByObject=FALSE;
    // i didn't be blocked.
    if(x==fm1 && y==fm1 && z==fm1)
    {
        GlobalIamBlocked=FALSE;
        SetLocalInt(OBJECT_SELF,AI_BLOCKED,GlobalIamBlocked);
        return;
    }
    // can't move more than 1.0..(0.5?).. we maybe blocked.
    GlobalIamBlocked=GetLocalInt(OBJECT_SELF,AI_BLOCKED);
    moved=sqrt(pow(x-vec.x,f2)+pow(y-vec.y,f2)+pow(z-vec.z,f2));
    iPblocked=GetLocalInt(OBJECT_SELF,AI_POSSIBLYBLOCKED);
    if(moved<f1)
    {
        SetLocalInt(OBJECT_SELF,AI_POSSIBLYBLOCKED,TRUE);
    }
    else
    {
        SetLocalInt(OBJECT_SELF,AI_POSSIBLYBLOCKED,FALSE);
    }
    if(moved<((iPblocked)?f1:0.2))
    {
        //        GlobalIamBlocked=GetLocalInt(OBJECT_SELF,AI_BLOCKED);
        if(GlobalIamBlocked<i2)
            SetLocalInt(OBJECT_SELF,AI_BLOCKED,++GlobalIamBlocked);
    }
    else
    {
        SetLocalFloat(OBJECT_SELF,AI_LAST_X,fm1);
        SetLocalFloat(OBJECT_SELF,AI_LAST_Y,fm1);
        SetLocalFloat(OBJECT_SELF,AI_LAST_Z,fm1);
        GlobalIamBlocked=FALSE;
        SetLocalInt(OBJECT_SELF,AI_BLOCKED,GlobalIamBlocked);
    }
    // is realy blocked(by creatures)?
    if(GlobalIamBlocked>=i2)
    {
        int iCheck=i0,iCnt=i1,iSize,iSizeMod;
        float fRange;
        object oCreature;
        // hey.. you are too close!!!
        oCreature=GetLocalObject(OBJECT_SELF,ARRAY_ENEMY_RANGE+IntToString(iCnt));
        while(GetIsObjectValid(oCreature))
        {
            iSize=GetCreatureSize(oCreature);
            iSizeMod=(iSize>i3)?iSize-i2:i1;
            fRange=GetDistanceToObject(oCreature);
            if(fRange<=IntToFloat(iSizeMod)+f1)iCheck+=iSizeMod;
            if(fRange>f4)break;
            oCreature=GetLocalObject(OBJECT_SELF,ARRAY_ENEMY_RANGE+IntToString(++iCnt));
        }
        iCnt=i1;
        oCreature=GetLocalObject(OBJECT_SELF,ARRAY_ALLIES_RANGE+IntToString(iCnt));
        while(GetIsObjectValid(oCreature))
        {
            iSize=GetCreatureSize(oCreature);
            iSizeMod=(iSize>i3)?iSize-i2:i1;
...
int AI_GetBestAttackRoll(object oTarget=OBJECT_SELF)
{
    object oInven;
    itemproperty ip;
    int nAttackRoll=GetBaseAttackBonus(oTarget);
    int nAttackBonus=i0;
    int nTemp;
    ...
    oInven=GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oTarget);
    if(GetIsObjectValid(oInven))
    {
        ip=GetFirstItemProperty(oInven);
        while(GetIsItemPropertyValid(ip))
        {
            if(GetItemPropertyType(ip)==ITEM_PROPERTY_ENHANCEMENT_BONUS || GetItemPropertyType(ip)==ITEM_PROPERTY_ATTACK_BONUS)
            {
                nTemp=GetItemPropertyCostTableValue(ip);
                if(nTemp>nAttackBonus)
                    nAttackBonus=nTemp;
            }
            ip=GetNextItemProperty(oInven);
        }
    }
    else
    {
        oInven=GetItemInSlot(INVENTORY_SLOT_ARMS,oTarget);
        if(GetIsObjectValid(oInven))
        {
            ip=GetFirstItemProperty(oInven);
            while(GetIsItemPropertyValid(ip))
        ...
        {
            oInven=GetItemInSlot(INVENTORY_SLOT_CWEAPON_R,oTarget);
            if(GetIsObjectValid(oInven))
            {
                ip=GetFirstItemProperty(oInven);
                while(GetIsItemPropertyValid(ip))
    ...
    nAttackRoll+=nAttackBonus;

    // need more check for ability modifier
    oInven=GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,oTarget);
    if(GetWeaponRanged(oInven))
    {
        if(GetHasFeat(FEAT_ZEN_ARCHERY,oTarget))
        {
            nAttackRoll+=GetAbilityModifier(ABILITY_WISDOM,oTarget);
        }
        else
        {
            nAttackRoll+=GetAbilityModifier(ABILITY_DEXTERITY,oTarget);
        }
    }
    else
    {
        if(GetHasFeat(FEAT_WEAPON_FINESSE,oTarget) && GetWeight(oInven)<=3)
        {
            nAttackRoll+=GetAbilityModifier(ABILITY_DEXTERITY,oTarget);
        }
        else
        {
            nAttackRoll+=GetAbilityModifier(ABILITY_STRENGTH,oTarget);
        }
    }

    // class bonus calc
    nTemp=GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER,oTarget);
    if(nTemp>i0)
    {
        nAttackRoll+=nTemp/i2;
    }
    nTemp=GetLevelByClass(CLASS_TYPE_WEAPON_MASTER,oTarget);
    if(nTemp>i0)
    {
        nAttackRoll+=nTemp/i5;
        if(nTemp>i13)
        {
            nAttackRoll+=nTemp/i3;
        }
    }
    return nAttackRoll+GetHitDice(oTarget)/10;
}
...
int AI_EquipAndAttack()
{
        ...
        && d100() < i7)
    {
        ...
        float fDelay = IntToFloat(Random(i10) + i1) / f10;
    ...
    int iAttackMethod = AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget);
    if(iAttackMethod>i1 && GlobalOurPercentHP>i40 && GetCurrentHitPoints(GlobalMeleeTarget)<=i50)
    {
        iAttackMethod=i0;
    }
    // uncommandable enemy... just normal attack for the best attack bonus(in melee only?)
    int iEnemyStatus = (AI_GetAIHaveEffect(GlobalEffectParalyze, GlobalMeleeTarget) ||
        AI_GetAIHaveEffect(GlobalEffectPetrify, GlobalMeleeTarget) ||
    ...
    /*
    else if(AI_GetAIHaveEffect(GlobalEffectEntangle))
    {
    fRange = f2;
    }
    */
    ...
    if((GlobalValidAlly && GlobalRangeToNearestEnemy > fRange && GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ATTACKING, AI_COMBAT_MASTER)) ||
        (d10() <= i8 && GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_MOVE_BACK, AI_COMBAT_MASTER)) ||
    ...
    {
        if(d10() <= i8 && !AI_GetAIHaveEffect(GlobalEffectEntangle) && GetSpawnInCondition(AI_FLAG_COMBAT_BETTER_AT_HAND_TO_HAND, AI_COMBAT_MASTER))
        {
            iRangedAttack = FALSE;
        }
        else
        {
            ...
            float fAllyToMelee = GetDistanceBetween(GlobalMeleeTarget, GetNearestCreature(CREATURE_TYPE_REPUTATION, REPUTATION_TYPE_ENEMY, GlobalMeleeTarget, i1, CREATURE_TYPE_IS_ALIVE, TRUE));
            if(fAllyToMelee==f0)
            {
                fAllyToMelee = GlobalRangeToNearestEnemy;
            }
            ...
            // + 60% chance!
            if(fAllyToMelee <= (IntToFloat(Random(i4) + i4)) &&
                d10() <= i6)
            ...
            else if(!GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,GlobalMeleeTarget))&& !AI_GetIsRangedAttacker(GlobalMeleeTarget) &&
                GlobalRangeToNearestEnemy > fRange + f5)
            {
                iRangedAttack = TRUE;
            }
        }
    ...
    /*
    if((AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget)==i1 && GlobalMeleeAttackers==i1) || GlobalRangeToNearestEnemy > fRange + f5 ||
    GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_USE_BOW, AI_COMBAT_MASTER))
    {
    iRangedAttack = TRUE;
    }
    ...
    if(iRangedAttack == TRUE && !AI_GetAIHaveEffect(GlobalEffectEntangle) && GetSpawnInCondition(AI_FLAG_COMBAT_BETTER_AT_HAND_TO_HAND, AI_COMBAT_MASTER))
    {
    if(d10() <= i8)
    {
    iRangedAttack = FALSE;
    ...
    */
    // dispel summoned sword or elemental shield caster
    if(!GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_DISPEL_WITH_MELEE, AI_OTHER_COMBAT_MASTER))
    {
        // damage shield
        if(iAttackMethod==i2)
        {
            GlobalDispelTarget=GlobalMeleeTarget;
            // try dispel target
            if(AI_ActionCastDispel())
            {
            ...
            {
                SetLocalObject(OBJECT_SELF,AI_SAVED_DISPEL_TARGET,GlobalMeleeTarget);
                AISpeakString(DISPEL_THIS_TARGET);
            }
        }
        if(iAttackMethod>=i2 && GlobalIntelligenceScore>=i8)
        {
            iRangedAttack = TRUE;
        }
    }
    // Declare everything
    object oEquipped, oMainWeapon, oMainPossessor, oPrimary, oSecondary, oTwohanded, oGloves;
    int iPickUpDisarmed, iRanged, iShield, iValidAmmo, iStrength, iPrimaryNum, iPrimaryValue,
        iSecondaryNum, iSecondaryValue, iValidPrimary, iValidSecondary, iTwoHandedNum, iTwoHandedValue, iValidTwoHanded, iPrimaryDamage,
        iEquippedShield, iShieldInSlotAlready, iEquippedMostDamaging,
        iCurRightValue, iCurLeftValue, iCurGloveValue, iGloveNum, iValidGlove, iMonkLevels, iGloveValue, iUseUnarmed,
        ...
        GetSpawnInCondition(AI_FLAG_OTHER_LAG_EQUIP_MOST_DAMAGING, AI_OTHER_MASTER))
    {
        ...
        DebugActionSpeakByInt(i1, GlobalMeleeTarget);
    ...
    {
        // Declaring
        // value of current equipped weapons
        iCurRightValue = GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND))?GetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_RIGHT_HAND):FALSE;
        iCurLeftValue = GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_LEFTHAND))?GetLocalInt(OBJECT_SELF,AI_EQUIPED_VALUE_LEFT_HAND):FALSE;
        if(iMonkLevels)
        {
            iCurGloveValue = GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_ARMS))?GetLocalInt(OBJECT_SELF,AI_EQUIPED_VALUE_GLOVES):FALSE;
        }
        ...
        {
            iValidAmmo = (GetIsObjectValid(GetItemInSlot(iValidAmmo)) || GetAIInteger(AI_WEAPON_RANGED_IS_UNLIMITED));
        }
        // Ranged attack...valid?
        ...
        // Ranged attack, but has no valid weapon?
        else if(iRangedAttack && (!iValidAmmo || !GetIsObjectValid(oMainWeapon)))
        {
            // check weapon again.
            ExecuteScript(FILE_RE_SET_WEAPONS, OBJECT_SELF);
        }
        ...
        {
            int iCurRangedEquipped=GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND));
            ...
            if(iPrimaryNum)
            {
                ...
                iPrimaryValue = GetLocalInt(OBJECT_SELF, AI_WEAPON_PRIMARY + IntToString(iPrimaryNum));
                iValidPrimary = (iCurRangedEquipped || iCurRightValue-i5<iPrimaryValue)?GetIsObjectValid(oPrimary):FALSE;
                if(iValidPrimary)
                {
                    // We want the smallest...
                    iSecondaryNum = AI_GetWeaponArray(AI_WEAPON_SECONDARY, oPrimary, i0);
                    if(iSecondaryNum)
                    {
                        oSecondary = GetLocalObject(OBJECT_SELF, AI_WEAPON_SECONDARY + IntToString(iSecondaryNum));
                        iSecondaryValue = GetLocalInt(OBJECT_SELF, AI_WEAPON_SECONDARY + IntToString(iSecondaryNum));
                        iValidSecondary = (iCurRangedEquipped || iCurLeftValue-i5<iSecondaryValue)?GetIsObjectValid(oSecondary):FALSE;
                    }
                }
            }
            // 2 handed
            iTwoHandedNum = AI_GetWeaponArray(AI_WEAPON_TWO_HANDED);
            oTwohanded = GetLocalObject(OBJECT_SELF, AI_WEAPON_TWO_HANDED + IntToString(iTwoHandedNum));
            iTwoHandedValue = GetLocalInt(OBJECT_SELF, AI_WEAPON_TWO_HANDED + IntToString(iTwoHandedNum));
            iValidTwoHanded = (iCurRangedEquipped || iCurRightValue-i5<iTwoHandedValue)?GetIsObjectValid(oTwohanded):FALSE;

            if(iMonkLevels)
            {
                // gloves
                iGloveNum = AI_GetWeaponArray(AI_WEAPON_GLOVES);
                oGloves = GetLocalObject(OBJECT_SELF, AI_WEAPON_GLOVES + IntToString(iGloveNum));
                iGloveValue = GetLocalInt(OBJECT_SELF, AI_WEAPON_GLOVES + IntToString(iGloveNum));
                iValidGlove = (!iCurRangedEquipped && iCurGloveValue-i5<iGloveValue)?GetIsObjectValid(oGloves):FALSE;
            }

            // Shield is done above.
            // Now, are any valid?
            //            if(!iValidPrimary && !iValidTwoHanded)
            if(iMonkLevels && !GetIsObjectValid(oGloves) && !GetIsObjectValid(oPrimary) && !GetIsObjectValid(oTwohanded))
            {
            ...
            else if(!iMonkLevels && !GetIsObjectValid(oPrimary) && !GetIsObjectValid(oTwohanded))
            {
                ActionEquipMostDamagingMelee(GlobalMeleeTarget, TRUE);
                ExecuteScript(FILE_RE_SET_WEAPONS, OBJECT_SELF);
                iEquippedMostDamaging = TRUE;
            ...
            else
            {
                ...
                // for monks, equip bracer or gloves...
                if(iMonkLevels && iValidGlove && iGloveValue>iPrimaryValue && iGloveValue>iTwoHandedValue)
                {
                    oEquipped = oGloves;
                    ActionUnequipItem(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND));
                    ActionUnequipItem(GetItemInSlot(INVENTORY_SLOT_LEFTHAND));
                    if(GlobalGloveInArms != oGloves)
                    {
                        ActionEquipItem(oGloves, INVENTORY_SLOT_ARMS);

                        SetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_RIGHT_HAND,FALSE);
                        SetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_LEFT_HAND,FALSE);
                        SetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_GLOVES,iGloveValue);
                    }
                }
                // Check one: Is a lot more AC better? Or keep shield equipped, even?
                // 1. Is our AC below 2x our HD? (IE under 20 at level 10)
                else if((GlobalOurAC < GlobalOurHitDice * i2) ||
                    ...
                    if(iValidPrimary)
                    {
                        ...
                        if(iValidShield)
                        {
                            ...
                            if(GlobalRightHandWeapon != oPrimary)
                            {
                                ...
                                SetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_RIGHT_HAND,iPrimaryValue);
                            }
                        ...
                        else if(iValidTwoHanded)
                        {
                            ...
                            if(GlobalRightHandWeapon != oTwohanded)
                            {
                                ...
                                SetLocalInt (OBJECT_SELF,AI_EQUIPED_VALUE_RIGHT_HAND,iTwoHandedValue);
                                SetLocalInt(OBJECT_SELF,AI_EQUIPED_VALUE_LEFT_HAND,FALSE);
                            }
                        }
                        else if(iValidSecondary)
                        {
                            ...
                            if(GlobalLeftHandWeapon != oSecondary)
                            {
                                ...
                                SetLocalInt(OBJECT_SELF,AI_EQUIPED_VALUE_LEFT_HAND,iSecondaryValue);
                            }
                        }
                        else
                        {
            ...
            if(GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND)) && (GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_CWEAPON_B)) || GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_CWEAPON_B)) || GetIsObjectValid(GetItemInSlot(INVENTORY_SLOT_CWEAPON_B))))
            {
                ActionUnequipItem(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND));
    ...
    iOurHit = GlobalOurBestAttackBonus + ((GlobalIntelligence * i2) - i2);
    // Randomise...should never get results over 20 now. (0-20 for INT 1, 0-2 for INT 10)
    iOurHit += Random(i20 - ((GlobalIntelligence - i1) * i2));

    // number of concurrency attack
    int iCurAtt=(iOurHit-GlobalMeleeTargetAC)/i5;
    if(iCurAtt<=i0)iCurAtt=i1;
    if(iCurAtt>i4)iCurAtt=i4;
    int iCnt;
    ...
    if(GlobalIntelligence >= i8)
    {
        ...
        if(GetSkillRank(SKILL_DISCIPLINE,GlobalMeleeTarget) - i20 >= iOurHit)
        {
            // No feats
            ValidFeats = FALSE;
        }
    ...
    // as a normal attack)
    if(GlobalOurBestAttackBonus + i20 <= GlobalMeleeTargetAC)
    {
    ...
    // for sneak attack
    if(iRanged && AI_GetHaveSneakAttack() && GlobalRangeToNearestEnemy>f6 && GlobalRangeToMeleeTarget>f6)
    {
        ActionMoveToObject(GlobalMeleeTarget,TRUE,f6);
        //        DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
        //        return TRUE;
    }
    ...
    // Ranged weapon?
    if(iRanged && !AI_GetAIHaveEffect(GlobalEffectPolymorph))
    {
        if(ValidFeats)
        {
            ...
            if((iOurHit - i2) >= GlobalMeleeTargetAC && GetHasFeat(FEAT_RAPID_SHOT) && !GetActionMode(OBJECT_SELF,ACTION_MODE_RAPID_SHOT))
            {
    ...
    // decent skill.
        ...
        ((GlobalMeleeTargetBestAttackBonus + i10 >= GlobalOurAC && GetSkillRank(SKILL_PARRY) >= GlobalMeleeTargetBestAttackBonus + i15) ||
        // Or forced
    ...
    {
        // react when target has elemental shield
        if(!GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_DISPEL_WITH_MELEE, AI_OTHER_COMBAT_MASTER) &&
            AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget)>=i2 && GlobalIntelligenceScore>=i8)
        {
            if(GlobalRangeToMeleeTarget>f7)
            {
                ActionMoveToObject(GlobalMeleeTarget,FALSE,f6);
            }
            else
            {
                AI_AntiCornerMoveAway(GlobalMeleeTarget,TRUE,f5);
            }
            DelayCommand(f6,DetermineCombatRound(GlobalMeleeTarget));
            return AI_NORMAL_MELEE_ATTACK;
        }

        // attack anyway.
        if(!AI_GetAIHaveEffect(GlobalEffectEntangle) && GlobalRangeToMeleeTarget>fRange)
        {
            vector vec=GetPosition(OBJECT_SELF);
            // set last position for block check. (to select nearest melee target)
            SetLocalFloat(OBJECT_SELF,AI_LAST_X,vec.x);
            SetLocalFloat(OBJECT_SELF,AI_LAST_Y,vec.y);
            SetLocalFloat(OBJECT_SELF,AI_LAST_Z,vec.z);
        }
        ...
        if(GetHasFeat(FEAT_PRESTIGE_DEATH_ATTACK_1) &&
            !GetIsInCombat(GlobalMeleeTarget) &&
        ...
        int iTargetWeaponSize, iTargetCreatureSize, iTargetCreatureRace, iOurWeaponSize,
            iCanUseMonks, iTargetAlignment, iAddingModifier;
        ...
        if((!GetIsObjectValid(oEquipped) ||
            GetBaseItemType(oEquipped) == BASE_ITEM_BRACER ||
            GetBaseItemType(oEquipped) == BASE_ITEM_GLOVES ||
        ...
        // Only basic for now...
        if(GlobalMeleeAttackers>i0 && GetHasFeat(FEAT_IMPROVED_EXPERTISE) && !GetActionMode(OBJECT_SELF,ACTION_MODE_IMPROVED_EXPERTISE))
        {
            // Our hit is over thier AC, and thier BAB hits us all the time...
            // OR when there are 3+
            if((GlobalOurBestAttackBonus >= GlobalMeleeTargetAC && abs(GlobalOurAC-GlobalMeleeTargetBestAttackBonus-i10)<=i10)
                || (GlobalOurBestAttackBonus+i20<=GlobalMeleeTargetAC && GlobalOurAC+i10>=GlobalMeleeTargetBestAttackBonus+i10)
                || (GlobalMeleeAttackers >= i3 && GlobalMeleeTargetBestAttackBonus<=GlobalOurAC+i10))
            {
                AI_SetMeleeMode(ACTION_MODE_IMPROVED_EXPERTISE);
                //                ActionAttack(GlobalMeleeTarget);
                //                return FEAT_IMPROVED_EXPERTISE;
            }
            // if target is ploted summon, shout dispel.
            if(GetIsObjectValid(GetMaster(GlobalMeleeTarget)) && GetPlotFlag(GlobalMeleeTarget))
            {
                if(!AI_GetMeleeMode())
                {
                    AI_SetMeleeMode(ACTION_MODE_IMPROVED_EXPERTISE);
        ...
        if(GlobalMeleeAttackers>i0 && GetHasFeat(FEAT_EXPERTISE)
            && !GetActionMode(OBJECT_SELF,ACTION_MODE_IMPROVED_EXPERTISE)
            && !GetActionMode(OBJECT_SELF,ACTION_MODE_EXPERTISE))
        {
            ...
            if((GlobalOurBestAttackBonus +i5 >= GlobalMeleeTargetAC &&
                abs(GlobalOurAC-GlobalMeleeTargetBestAttackBonus-i15)<=i10)
                || (GlobalOurBestAttackBonus+i20<=GlobalMeleeTargetAC && GlobalOurAC+i5>=GlobalMeleeTargetBestAttackBonus+i10)
                || GlobalMeleeAttackers >= i2 && GlobalMeleeTargetBestAttackBonus<=GlobalOurAC+i5)
            {
        ...
        if(!AI_GetMeleeMode()
            && GetHasFeat(FEAT_IMPROVED_POWER_ATTACK)
            && GlobalOurBestAttackBonus >= GlobalMeleeTargetAC+i5)
        {
            AI_SetMeleeMode(ACTION_MODE_IMPROVED_POWER_ATTACK);
            //            ActionAttack(GlobalMeleeTarget);
            //            return FEAT_IMPROVED_POWER_ATTACK;
        ...
        // as result of test, disarm is better than ki damage.
        if(GetHasFeat(FEAT_KI_DAMAGE) && !((GetHasFeat(FEAT_IMPROVED_DISARM) || GetHasFeat(FEAT_DISARM)) && iTargetWeaponSize))
        {
            //            AI_SetMeleeMode();
            for(iCnt=i0;iCnt<iCurAtt;iCnt++)
        ...
        if(iCanUseMonks && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_STUN)
            && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_MIND_SPELLS)
            ...
            && GetHasFeat(FEAT_STUNNING_FIST))
        {
            ...
            if(iMonkLevels == i1) iAddingModifier - i4;
            // We hit ETC.
            // Save is above
            if(iOurHit >= GlobalMeleeTargetAC &&
                // Save
                (i10 + (iMonkLevels / i2) + GetAbilityModifier(ABILITY_WISDOM)
                >= GetFortitudeSavingThrow(GlobalMeleeTarget) + i5 + Random(i15)))
            {
                //                AI_SetMeleeMode();
                for(iCnt=i0;iCnt<iCurAtt;iCnt++)
        ...
        if(iTargetWeaponSize>i0 && d4()<i4)
        {
            iOurWeaponSize = AI_GetWeaponSize(oEquipped);
            if(iMonkLevels>i1 && iOurWeaponSize==i0)iOurWeaponSize=i2;
            if(!iOurWeaponSize)iOurWeaponSize=i1;
        ...
        if((!GetHasFeatEffect(FEAT_KNOCKDOWN, GlobalMeleeTarget) &&
            ...
            && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_KNOCKDOWN))
        {
...
int AI_ActionCastSpell(int iSpellID, int nTalent = 0, object oTarget = OBJECT_SELF, int iRequirement = 0, int iLocation = FALSE, int iItemTalentValue = -1, int iPotionTalentValue = -1)
{
    if(GetLocalInt(OBJECT_SELF,"DEADMAGIC_SPELLFAILURE")) return FALSE;

    if(GlobalPreventSpellDupleUse && GetAIInteger(AI_LAST_CASTED_SPELL_ID)==iSpellID) return FALSE;
    ...
    if(nTalent > i0 || !iRequirement)
    {
            ...
            (iLocation || GetObjectSeen(oTarget)))
        {
            ...
            if(GetObjectSeen(oTarget))
            {
                ...
                // paladin, ranger... to many deadlock.. just cheat cast.
                if(AI_CheatCastCheck(iSpellID))
                {
            ...
            else //if(iLocation)
            {
                ...
                ActionCastSpellAtLocation(iSpellID, GetLocation(oTarget), METAMAGIC_ANY, TRUE);
                DecrementRemainingSpellUses(OBJECT_SELF, iSpellID);
            }
            SetAIInteger(AI_LAST_CASTED_SPELL_ID,iSpellID);
            // Lasts...recheck items
...
int AI_ActionCastSpellAtLocation(int iSpellID, int nTalent, location lLocation, int iRequirement = 0, int iItemTalentValue = -1)
{
    ...
    if(nTalent > i0 || !iRequirement)
    {
            ...
            GetHasSpell(iSpellID))
        {
            ...
            {
                // Attempt Concentration Check (Casting a spell, not an item)
                if(AI_AttemptConcentrationCheck(GlobalMeleeTarget)) return TRUE;
            }
            else
            {
                // Turn off all modes - remember, we can't use expertise with spellcasting!
            ...
            if(AI_CheatCastCheck(iSpellID))
            {
                ActionCastSpellAtLocation(iSpellID, lLocation, METAMAGIC_ANY,TRUE);
                DecrementRemainingSpellUses(OBJECT_SELF,iSpellID);
            }
            else
            {
                ActionCastSpellAtLocation(iSpellID, lLocation, METAMAGIC_ANY);
            }
            //            DecrementRemainingSpellUses(OBJECT_SELF, iSpellID);
            SetAIInteger(AI_LAST_CASTED_SPELL_ID,iSpellID);
            // Lasts...recheck items
    ...
    if(iItemTalentValue == iSpellID)
    {
        if(AI_ActionCastItemEqualToLocation(lLocation, iSpellID))
        {
            // Lasts...recheck items
            if(AI_GetSpellCategoryHasItem(nTalent))
            {
...
int AI_ActionCastSubSpell(int iSubSpell, int nTalent = 0, object oTarget = OBJECT_SELF, int iRequirement = 0, int iLocation = FALSE, int iItemTalentValue = -1, int iPotionTalentValue = -1)
{
    ...
    if(GlobalPreventSpellDupleUse && GetAIInteger(AI_LAST_CASTED_SPELL_ID)==iSubSpell) return FALSE;
    ...
    if(nTalent > i0 || !iRequirement)
    {
            ...
            (iLocation || GetObjectSeen(oTarget)))
        {
            ...
            // Lasts...recheck items
            SetAIInteger(AI_LAST_CASTED_SPELL_ID,iSubSpell);
            if(AI_GetSpellCategoryHasItem(nTalent))
            {
                ActionDoCommand(AI_SetItemTalentValue(nTalent));
            }
...
int AI_ActionUseEpicSpell(int nFeat, int nSpell, object oTarget = OBJECT_SELF)
{
    if(GetHasSpell(nSpell))
    {
        ...
        // We turn off hiding/searching
        AI_ActionTurnOffHiding();
        if(nSpell==AI_SPELL_EPIC_WARDING || nSpell==SPELL_EPIC_MAGE_ARMOR)
        {
        ...
        {
            ActionCastSpellAtObject(nSpell, oTarget, METAMAGIC_NONE);
        }
        return TRUE;
    }
    if(GetHasFeat(nFeat))
...
void AI_SetUpUs()
{
    ...
    GlobalIntelligenceScore = GetAbilityScore(OBJECT_SELF,ABILITY_INTELLIGENCE);
    ...
    GlobalGloveInArms = GetItemInSlot(INVENTORY_SLOT_ARMS);
    //    GlobalOurBaseAttackBonus = GetBaseAttackBonus(OBJECT_SELF);
    GlobalOurBaseAttackBonus=AI_GetBestAttackRoll();
    GlobalOurBestAttackBonus=AI_GetBestAttackRoll();
    ...
    GlobalSelfBuffer = GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_ONLY_SELF_BUFFING_SPELLS,AI_OTHER_COMBAT_MASTER);
    ...
    // Wisdom based spellcaster
        ...
        GlobalOurChosenClass == CLASS_TYPE_PALADIN ||
    ...
    // Conditional
    if(iLocalSpellInteger & AI_VALID_TALENT_BENEFICIAL_CONDITIONAL_AREAEFFECT) SpellConAre = TALENT_CATEGORY_BENEFICIAL_CONDITIONAL_AREAEFFECT;
    if(iLocalSpellInteger & AI_VALID_TALENT_BENEFICIAL_CONDITIONAL_SINGLE) SpellConSinTar = TALENT_CATEGORY_BENEFICIAL_CONDITIONAL_SINGLE;
    // Enchancement
    ...
    // get spell/ability percentage
    AssignCommand(OBJECT_SELF,SetNumberOfSpellAndAbility());

    if(GetLocalInt(OBJECT_SELF,AI_NUMBER_OF_SPELLS)+GetLocalInt(OBJECT_SELF,AI_NUMBER_OF_ABILITIES))
        GlobalUseSpellPercent = FloatToInt(IntToFloat(GetLocalInt(OBJECT_SELF,AI_NUMBER_OF_SPELLS))/
        (IntToFloat(GetLocalInt(OBJECT_SELF,AI_NUMBER_OF_SPELLS))+IntToFloat(GetLocalInt(OBJECT_SELF,AI_NUMBER_OF_ABILITIES)))*i100);
}
/*::///////////////////////////////////////////////
...
int AI_SaveImmuneAOE(object oTarget, int iSaveType, int iSpellLevel)
{
    ...
    {
        // Basic one here. Some addition and comparison.
        if(GetFortitudeSavingThrow(oTarget) - GlobalSaveStupidity >= (GlobalSpellBaseSaveDC + iSpellLevel + i20)) return TRUE;
    }
    else if(iSaveType == SAVING_THROW_REFLEX)
    {
        // Evasion - full damaged saved if the save is sucessful.
        ...
        {
            if(GetReflexSavingThrow(oTarget)- GlobalSaveStupidity >= (GlobalSpellBaseSaveDC + iSpellLevel + i20)) return TRUE;
        }
    }
    else if(iSaveType == SAVING_THROW_WILL)
    {
        // Slippery mind has a re-roll. We ignore in 1.3
        if(GetWillSavingThrow(oTarget) - GlobalSaveStupidity >= (GlobalSpellBaseSaveDC + iSpellLevel + i20))
        {
            return TRUE;
        }
    }
...
int AI_AOEDeathNecroCheck(object oGroupTarget, int iNecromanticSpell, int iDeathImmune)
{
    ...
    {
        if(AI_GetAIHaveEffect(GlobalEffectImmunityNecromancy, oGroupTarget)) return TRUE;
    }
    if(iDeathImmune)
    {
...
int AI_AOENecroDeathDrainMindCheck(object oGroupTarget, int iNecromanticSpell, int iDeathImmune, int iNegativeImmune, int iMindImmune, int iMindType)
{
    ...
    if(iNegativeImmune)
    {
        if(AI_GetAIHaveEffect(GlobalEffectImmunityDrain, oGroupTarget)) return TRUE;
    }
    if(iMindImmune)
    {
        if(AI_GetAIHaveSpellsEffect(GlobalHasMindResistanceProtections, oGroupTarget)) return TRUE;
    }
    if(iMindType)
    {
        if(GetIsImmune(oGroupTarget,iMindType)) return TRUE;
    }
    return FALSE;
}
                ...
                while(GetIsObjectValid(oGroupTarget) && bWillHitAlly != TRUE)
                {
                        ...
                        !AI_SpellResistanceImmune(oGroupTarget))
                    {
                        ...
                        if(!AI_AOEDeathNecroCheck(oGroupTarget, iNecromanticSpell, iDeathImmune) &&
                            (iDamageSpell || !AI_SaveImmuneAOE(oGroupTarget, iSaveType, nLevel)) &&
...
int AI_GetBestAreaSpellTargetAndLocation(float fRange, float fSpread, int nLevel, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE)
{
    GlobalAOETargetObject=OBJECT_INVALID;
    GlobalAOETargetLocation=GetLocation(OBJECT_SELF);

    // Delcare objects
    // (Target = Loop of nearest creatures. oResturnTarget = Who to return,
    //  and oGroupTarget is GetFirst/Next in nShape around oTarget)
    object oTarget, oGroupTarget;
    // Delcare Integers
    int iCnt,iCntEnemiesOnTarget, iCntAlliesOnTarget, iNoHittingAllies,
        iMostOnPerson, iMaxAlliesToHit, iOurToughness, iNewShape;
    // Declare Booleans
    int bWillHitAlly, bNoHittingAllies, bCheckAlliesHP, bSelfHit;
    location lTarget,lGroupTarget;
    // Float values
    float fDistance, fTargetMustBeFrom, fModSpread, fCheckRange;
    vector vCur,vTmp,vTarget;
    ...
    // - defaults to 0.0 meters unless FF is on
    if(nFriendlyFire!=i2 &&
        !AI_GetSpellLevelEffectAOE(OBJECT_SELF, nLevel) &&
        (iDamageSpell || !AI_SaveImmuneAOE(OBJECT_SELF, iSaveType, nLevel)) &&
    ...
    if(fSpread==RADIUS_SIZE_COLOSSAL || fSpread==RADIUS_SIZE_LARGE)
    {
        fModSpread=f40;
    }
    if(fSpread==RADIUS_SIZE_GARGANTUAN)
    {
        fModSpread=RADIUS_SIZE_GARGANTUAN*f5;
    }
    if(fSpread==RADIUS_SIZE_HUGE || fSpread==RADIUS_SIZE_MEDIUM || fSpread==RADIUS_SIZE_SMALL)
    {
        fModSpread=RADIUS_SIZE_SMALL*f25;
    }
    if(fModSpread==f0)
    {
        fModSpread=fSpread*((f40/fSpread)+f1);
    }
    iNewShape=nShape;

    if(nShape==SHAPE_SPELLCONE || nShape==SHAPE_CONE)
    {
        fTargetMustBeFrom = f0;
        fModSpread=fSpread;
        iNewShape=SHAPE_SPHERE;
    }

    vCur.x=f0;
    vCur.y=f0;
    iCntEnemiesOnTarget=i0;
    iCntAlliesOnTarget=i0;
    bSelfHit=FALSE;
    bWillHitAlly=FALSE;

    lTarget=GetLocation(OBJECT_SELF);
    oTarget = GetFirstObjectInShape(iNewShape, fModSpread, lTarget);

    while(fModSpread>=fSpread && GetIsObjectValid(oTarget))
    {
        // Need seen/heard target
        if(GetObjectSeen(oTarget) || GetObjectHeard(oTarget))
        {
            ...
            if(!GetIsDead(oTarget) && !GetPlotFlag(oTarget) &&
                !GetIgnore(oTarget) && !GetIsDM(oTarget) &&
                !AI_SpellResistanceImmune(oTarget))
            {
                if(!AI_AOENecroDeathDrainMindCheck(oTarget, iNecromanticSpell, iDeathImmune, iNegativeImmune, iMindImmune, iMindType) &&
                    (iDamageSpell || !AI_SaveImmuneAOE(oTarget, iSaveType, nLevel)) &&
                    !AI_GetSpellLevelEffectAOE(oTarget, nLevel))
                {
                    ...
                    // similar non-allies.
                        ...
                        GetHitDice(oTarget) >= iOurToughness)
                    {
                        if(bNoHittingAllies)
                        {
                            bWillHitAlly = TRUE;
                        ...
                        // We ignore if not got the setting to check HP,
                        // else, we take one from the iCntEnemiesOnTarget.
                        else if(bCheckAlliesHP && GetCurrentHitPoints(oTarget) < i50)
                        {
                            iCntAlliesOnTarget++;
                        }
                    }
                    if(fTargetMustBeFrom>f0 && oTarget==OBJECT_SELF)
                    {
                        bSelfHit = TRUE;
                    }
                }
        ...
        oTarget = GetNextObjectInShape(iNewShape, fModSpread, lTarget);
        if(!GetIsObjectValid(oTarget))
        {
            // no enemy in area.
            if(iCntEnemiesOnTarget==i0)
            {
                return FALSE;
            }
            // set new location to search
            lGroupTarget=Location(GetArea(OBJECT_SELF),Vector(vCur.x/iCntEnemiesOnTarget,vCur.y/iCntEnemiesOnTarget),f0);
            fCheckRange=f50;
            oTarget = GetFirstObjectInShape(iNewShape, fModSpread, lTarget);
            while(GetIsObjectValid(oTarget))
            {
                if((GetObjectSeen(oTarget) || GetObjectHeard(oTarget)) && GetIsEnemy(oTarget) &&
                    !GetIsDead(oTarget) && !GetPlotFlag(oTarget) &&
                    !GetIgnore(oTarget) && !GetIsDM(oTarget) &&
                    !AI_SpellResistanceImmune(oTarget))
                {
                    fDistance=GetDistanceBetweenLocations(lGroupTarget,GetLocation(oTarget));
                    if(fDistance<fCheckRange)
                    {
                        oGroupTarget=oTarget;
                        fCheckRange=fDistance;
                    }
                }
                oTarget = GetNextObjectInShape(iNewShape, fModSpread, lTarget);
            }
            lTarget=GetLocation(oGroupTarget);

            // if shape is spellcone or cone.
            if(!(iNewShape==SHAPE_SPELLCONE || iNewShape==SHAPE_CONE) && (nShape==SHAPE_SPELLCONE || nShape==SHAPE_CONE))
            {
                iNewShape=nShape;
            }
            else
            {
                // reduce spread range and reloop
                fModSpread/=f2;
            }

            oTarget = GetFirstObjectInShape(iNewShape, fModSpread, lTarget);

            // initialize when loop continue
            if(fModSpread>=fSpread)
            {
                vCur.x=f0;
                vCur.y=f0;
                iCntEnemiesOnTarget=i0;
    ...
    // if spell hit caster himself, move location a little.
    if(fTargetMustBeFrom>f0 && bSelfHit)
    {
        vTarget=GetPositionFromLocation(lGroupTarget);
        vTmp=VectorNormalize(vTarget-GetPosition(OBJECT_SELF))*(fTargetMustBeFrom-GetDistanceBetweenLocations(GetLocation(OBJECT_SELF),lGroupTarget));
        lGroupTarget=Location(GetAreaFromLocation(lGroupTarget),GetPositionFromLocation(lGroupTarget)+vTmp,GetFacingFromLocation(lGroupTarget));
    }

    // set global variable.
    GlobalAOETargetObject=oGroupTarget;
    GlobalAOETargetLocation=lGroupTarget;

    // no enemy in location or ally is more than enemy.
    // but, objecttarget is valid....maybe.
    // spell will hit more ally than enemy.
    if(bWillHitAlly || iCntEnemiesOnTarget<iCntAlliesOnTarget)
    {
        return FALSE;
    }
    // is there only one enemy(and safe location)? instead use object.
    if(iCntEnemiesOnTarget==i1 && fTargetMustBeFrom<GetDistanceToObject(GlobalAOETargetObject))
    {
        if(GetDistanceToObject(GlobalAOETargetObject)>fRange)
            return FALSE;
        else
            return i2;
    }
    // final location check.
    vCur.x=IntToFloat(GetAreaWidth(GetArea(OBJECT_SELF))*i10);
    vCur.y=IntToFloat(GetAreaHeight(GetArea(OBJECT_SELF))*i10);
    vTmp=GetPositionFromLocation(GlobalAOETargetLocation);
    if(GetDistanceBetweenLocations(GetLocation(OBJECT_SELF),GlobalAOETargetLocation)>fRange ||
        (vTmp.x<f0 && vTmp.y<f0 && vTmp.x>vCur.x && vTmp.y>vCur.y))
        return FALSE;
    else
        return TRUE;
}
...
{
    // Can we hit allies?
    int bNoHittingAllies = GetSpawnInCondition(AI_FLAG_COMBAT_NEVER_HIT_ALLIES, AI_COMBAT_MASTER);
    int iEnemy,iNearEnemy,iAlly;
    object oTarget = GetFirstObjectInShape(SHAPE_SPHERE, RADIUS_SIZE_COLOSSAL, GetLocation(OBJECT_SELF));
    while(GetIsObjectValid(oTarget))
    {
        if(!AI_SpellResistanceImmune(oTarget))
        {
            if(GetIsEnemy(oTarget))
            {
            ...
            else if(GlobalFriendlyFire && (GetIsFriend(oTarget) || GetFactionEqual(oTarget)))
            {
                if (GetDistanceBetween(oTarget, OBJECT_SELF) > 2.0)
                {
                    iAlly++;
    ...
    if(iEnemy>iAlly && iEnemy>iNearEnemy) return TRUE;
    return FALSE;
}
...
int AI_ActionDispelAOE(int iSpell, int iDamageOnly, float fRange, int iDamage, int iMax, int iPercent)
{
    ...
    location lAOElocation = GetLocation(oAOE);
    // Get damage done
        ...
        //      (iLastDamage >= TRUE || (GetHasSpellEffect(iSpell) && !iDamageOnly)))
    {
            ...
            !GlobalAnyValidTargetObject)
        {
            ...
            if(!GetIsFriend(GetAreaOfEffectCreator(oAOE)))
            {
                ...
                if(AI_ActionCastSpellAtLocation(SPELL_LESSER_DISPEL, SpellHostAreaInd, lAOElocation, i12, ItemHostAreaInd)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_DISPEL_MAGIC, SpellHostTouch, lAOElocation, i13, ItemHostTouch)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_GREATER_DISPELLING, SpellHostRanged, lAOElocation, i16, ItemHostRanged)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_MORDENKAINENS_DISJUNCTION, SpellHostAreaInd, lAOElocation, i19, ItemHostAreaInd)) return TRUE;
            }
            // Else move. We force this until we are out of the AOE
            SetAIObject(AI_AOE_FLEE_FROM, oAOE);
            SetLocalFloat(OBJECT_SELF, AI_AOE_FLEE_FROM_RANGE, fRange + GlobalOurSize);
            SetCurrentAction(AI_SPECIAL_ACTIONS_MOVE_OUT_OF_AOE);
            ActionMoveAwayFromLocation(GetLocation(oAOE), TRUE, fRange + GlobalOurSize);
            return TRUE;
        }
    }
    return FALSE;
...
int AI_AttemptSpecialChecks()
{
    ...
    if(AI_GetAIHaveEffect(GlobalEffectDarkness) ||
        // very special case : enemy cast darkness on herself with/without vision spell.
        (GlobalLastAttackerValid && GlobalNoneSeenHeardEnemy && GetDistanceToObject(GlobalLastAttacker)<f18))
    {
        if(!AI_GetAIHaveEffect(GlobalEffectUltravision) && !AI_GetAIHaveEffect(GlobalEffectTrueSeeing))
        {
            ...
            GlobalOurChosenClass == CLASS_TYPE_FEY))
        {
            ...
            if(AI_GetAIHaveEffect(GlobalEffectDarkness))
            {
                oTmpTarget=GetNearestObject(OBJECT_TYPE_AREA_OF_EFFECT);
                if(!GetIsObjectValid(oTmpTarget))
                {
                    oTmpTarget=OBJECT_SELF;
                }
            }
            else if(GlobalNoneSeenHeardEnemy)
            {
                oTmpTarget=GetNearestObject(OBJECT_TYPE_AREA_OF_EFFECT,GlobalLastAttacker);
                if(GetDistanceBetween(oTmpTarget,GlobalLastAttacker)>f6)
                {
                    oTmpTarget=OBJECT_INVALID;
                }
            }
            if(GetIsObjectValid(oTmpTarget))
            {
                location lTarget=GetLocation(oTmpTarget);

                lTarget=Location(GetAreaFromLocation(lTarget),GetPositionFromLocation(lTarget)+VectorNormalize(GetPosition(oTmpTarget)-GetPosition(OBJECT_SELF))/f2,GetFacingFromLocation(lTarget));
                ...
                if(AI_ActionCastSpell(SPELL_GUST_OF_WIND, SpellHostAreaInd, oTmpTarget, i13, TRUE, ItemHostAreaInd)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_LESSER_DISPEL, SpellHostAreaInd, lTarget, i12, ItemHostAreaInd)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_DISPEL_MAGIC, SpellHostTouch, lTarget, i13, ItemHostTouch)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_GREATER_DISPELLING, SpellHostRanged, lTarget, i16, ItemHostRanged)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_MORDENKAINENS_DISJUNCTION, SpellHostAreaInd, lTarget, i19, ItemHostAreaInd)) return TRUE;
            }

            if(!AI_GetAIHaveEffect(GlobalEffectEthereal) && !AI_GetAIHaveSpellsEffect(GlobalHasConsealmentSpells) && !AI_GetAIHaveSpellsEffect(GlobalEffectInvisible))
            {
                if(AI_ActionCastSpell(SPELL_ETHEREALNESS, SpellOtherSpell, OBJECT_SELF, i17)) return TRUE;
                if(AI_SpellWrapperConsealmentEnhancements(OBJECT_SELF)) return TRUE;
                if(AI_SpellWrapperNormalInvisibilitySpells())return TRUE;
            }

            DeleteLocalObject(OBJECT_SELF,AI_TO_ATTACK);

            // run away or core buff?
            if((GlobalOurChosenClass == CLASS_TYPE_WIZARD || GlobalOurChosenClass == CLASS_TYPE_SORCERER || GlobalOurChosenClass == CLASS_TYPE_FEY) &&
                !GlobalIamBlockedByObject && AI_GetAIHaveEffect(GlobalEffectDarkness) && d3()<i3)
            {
                ActionMoveAwayFromLocation(GetLocation(OBJECT_SELF), TRUE, f6);
                DelayCommand(f3,DetermineCombatRound());
                return TRUE;
            }
        }
        // i'm genius and enemy is not ranged attacker with vision spell
        else if(GlobalLastAttackerValid && !GlobalIamBlockedByObject && AI_GetAIHaveEffect(GlobalEffectDarkness) && GlobalIntelligenceScore>=i8 &&
            (AI_GetAIHaveEffect(GlobalEffectTrueSeeing, GlobalLastAttacker) || AI_GetAIHaveEffect(GlobalEffectUltravision, GlobalLastAttacker)) &&
            !(GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,GlobalLastAttacker)) || AI_GetIsSpellCaster(GlobalLastAttacker) || GetDistanceBetween(OBJECT_SELF,GlobalLastAttacker)>f4))
        {
            AI_AntiCornerMoveAway(GlobalLastAttacker, TRUE, f6, GlobalIamBlocked);
            DelayCommand(f3,DetermineCombatRound());
            return TRUE;
        }
        // go to melee!!
        else if(GlobalLastAttackerValid && GlobalNoneSeenHeardEnemy)
        {
            int iRun=GetObjectSeen(OBJECT_SELF,GlobalLastAttacker);
            if(iRun)
            {
                AI_EquipBestShield();
                AI_ActionTurnOffHiding();
            ...
            DeleteLocalObject(OBJECT_SELF,AI_TO_ATTACK);
            ActionMoveToObject(GlobalLastAttacker,iRun);
            return TRUE;
        }
    }
    // very long ranged attack... maybe
    else if(GlobalLastAttackerValid && GlobalNoneSeenHeardEnemy && GetDistanceToObject(GlobalLastAttacker)>f8)
    {
        int iRun=GetObjectSeen(OBJECT_SELF,GlobalLastAttacker);
        if(iRun)
        {
        ...
        if(!AI_GetAIHaveEffect(GlobalEffectEthereal) && !AI_GetAIHaveSpellsEffect(GlobalHasConsealmentSpells) && !AI_GetAIHaveSpellsEffect(GlobalEffectInvisible))
        {
            ...
            if(AI_SpellWrapperConsealmentEnhancements(OBJECT_SELF))
            {
                DelayCommand(f3,DetermineCombatRound());
                return TRUE;
            }
        ...
        {
            // 1.30/SoU trueeing should Dispel it. (Benificial conditional AOE)
            if(AI_ActionCastSpell(SPELL_TRUE_SEEING, SpellConAre, OBJECT_SELF, i16, FALSE, ItemConAre, PotionCon))
            {
                DelayCommand(f3,DetermineCombatRound());
                return TRUE;
            }
            // Ultravision - Talent category 10 (Benificial enchancement Self).
            if(AI_ActionCastSpell(SPELL_DARKVISION, SpellEnhSelf, OBJECT_SELF, i13, FALSE, ItemEnhSelf, PotionEnh))
            {
                DelayCommand(f3,DetermineCombatRound());
                return TRUE;
            }
        ...
        if(GetDistanceToObject(GlobalLastAttacker)>f35)
        {
            ActionMoveToObject(GlobalLastAttacker,TRUE,f30);
            DelayCommand(f3,DetermineCombatRound());
            return TRUE;
        }
        else if(GetDistanceToObject(GlobalLastAttacker)>f20)
        {
            ActionMoveToObject(GlobalLastAttacker,TRUE,f18);
            DelayCommand(f3,DetermineCombatRound());
            return TRUE;
        }
        else if(GetDistanceToObject(GlobalLastAttacker)>f10)
        {
            ActionMoveToObject(GlobalLastAttacker,iRun,f8);
            DelayCommand(f3,DetermineCombatRound());
            return TRUE;
        }
    }
    ...
    {
        if(!AI_GetAIHaveEffect(GlobalEffectTrueSeeing))
        {
            // 1.30/SoU trueeing should Dispel it. (Benificial conditional AOE)
            if(AI_ActionCastSpell(SPELL_TRUE_SEEING, SpellConAre, OBJECT_SELF, i16, FALSE, ItemConAre, PotionCon)) return TRUE;
        ...
        if(GetIsObjectValid(GetAreaFromLocation(lTarget)) && GetAreaFromLocation(lTarget)==GetArea(OBJECT_SELF))
        {
            /*
            ...
            */
            // Check range
            float fInvisibleDistance=GetDistanceBetweenLocations(GetLocation(OBJECT_SELF),lTarget);
            if(//GetIsObjectValid(oInvisible) &&
                fInvisibleDistance != f0 &&
                fInvisibleDistance < f40)
            {
                // Best to worst
                if(AI_ActionCastSpellAtLocation(SPELL_MORDENKAINENS_DISJUNCTION, SpellHostAreaInd, lTarget, i19, ItemHostAreaInd)) return TRUE;
                if(AI_ActionCastSpellAtLocation(SPELL_GREATER_DISPELLING, SpellHostRanged, lTarget, i16, ItemHostRanged)) return TRUE;
    ...
    // dispel AOE for ally
    oAOE = GetLocalObject(OBJECT_SELF,AI_SAVED_DISPEL_TARGET);
    if(GetObjectType(oAOE)==OBJECT_TYPE_AREA_OF_EFFECT)
    {
        DelayCommand(f12,DeleteLocalObject(OBJECT_SELF,AI_SAVED_DISPEL_TARGET));
        DelayCommand(f12,DeleteLocalInt(OBJECT_SELF,AI_SAVED_DISPEL_TARGET));
...
int AI_ActionHealObject(object oTarget)
{
    ...
    //modified magic, healing only 150 max
    iMultiUse=(IntToFloat(iTargetMaxHP-iTargetCurrentHP)/150.0)>1.75;
    ...
    if(iTargetCurrentHP < i35 || iTargetPercentHP < i40 ||
        ...
        (iTargetCurrentHP < i40 || iTargetPercentHP < i40)))
    {
        if(iPotionValue == SPELL_HEAL)
        {
            ...
            if(iMultiUse && GetLocalInt(OBJECT_SELF,RULE_VERSION)!=i3){AI_ActionUseTalentDebug(tPotionHealing, OBJECT_SELF); return i2;}
            return TRUE;
        }
        else if(!GlobalSpellFailure && iTouchHealingValue == SPELL_HEAL)
        {
            AI_EquipBestShield();
            // Touch heal spell
            ClearAllActions(TRUE);
        ...
        else if(!GlobalSpellFailure && iAOEHealingValue == SPELL_MASS_HEAL)
        {
            AI_EquipBestShield();
            // Mass heal spell
            ClearAllActions(TRUE);
    ...
    if(!GlobalSpellFailure && (GlobalBestSpontaeousHealingSpell >= i1 ||
...
int AI_ActionHealUndeadObject(object oTarget)
{
    ...
    if(//iTargetCurrentHP < i25 ||
        iTargetPercentHP < i40 ||
        // High damage at once for target (over 40)
        (GetLocalInt(oTarget, AI_INTEGER + AI_HIGHEST_DAMAGE_AMOUNT) > i40 && iTargetPercentHP < i40) ||
        // Had knockdown used on us lately
        (GetLocalTimer(AI_TIMER_KNOCKDOWN) &&
        (iTargetCurrentHP < i40 || iTargetPercentHP < i40)))
    {
        ...
        if(!GlobalSpellFailure && AI_ActionCastSpell(SPELL_HARM, SpellHostTouch, oTarget, i16, FALSE, ItemHostTouch)) return TRUE;
    }
    // Circle of doom: d8 + Caster level heal. Category 1.
    if(!GlobalSpellFailure && AI_ActionCastSpell(SPELL_CIRCLE_OF_DEATH, SpellHostRanged, oTarget, i15, TRUE, ItemHostRanged)) return TRUE;
    // Negative Energy Burst...this is good enough to always use normally...same as Circle of doom! (d8 + caster)
    if(!GlobalSpellFailure && AI_ActionCastSpell(SPELL_NEGATIVE_ENERGY_BURST, SpellHostRanged, oTarget, i13, TRUE, ItemHostRanged)) return TRUE;
    // Other Under things!
    // Inflict range...always use top 2.
    if(!GlobalSpellFailure && (!GlobalAnyValidTargetObject || GlobalOurHitDice <= i15))
    {
        ...
        if(!GlobalAnyValidTargetObject || GlobalOurHitDice <= i12)
        {
            ...
            if(!GlobalAnyValidTargetObject || GlobalOurHitDice <= i8)
            {
...
int AI_AttemptHealingSelf()
{
    ...
    if(AI_GetAIHaveEffect(GlobalEffectPolymorph) || AI_GetAIHaveEffect(GlobalEffectTensersTransformation))return FALSE;
    ...
    if(GlobalOurPercentHP < iPercent)
    {
        ...
        {
            int nWillHeal;
            // First, heal self with potions, spells or whatever.
            ...
            // mindflayer use no potion? even dragon may drink a potion... maybe...
            int iPotions = TRUE;
            if(!AI_GetAIHaveEffect(GlobalEffectPolymorph) &&
                //GlobalOurRace == RACIAL_TYPE_ABERRATION ||
                ...
                GlobalOurRace == RACIAL_TYPE_ANIMAL))
                iPotions = FALSE;
...
{
    // Check self
    if(GetHasSpellEffect(iSpell) || GetHasSpellEffect(iSpell1) || GetHasSpellEffect(iSpell2) || GetHasSpellEffect(iSpell3)) return OBJECT_SELF;
    // Check leader
    if(GetHasSpellEffect(iSpell, GlobalNearestLeader) || GetHasSpellEffect(iSpell1, GlobalNearestLeader) ||
        GetHasSpellEffect(iSpell2, GlobalNearestLeader) || GetHasSpellEffect(iSpell3, GlobalNearestLeader)) return GlobalNearestLeader;
    ...
    while(GetIsObjectValid(oAlly) && GetDistanceToObject(oAlly) <= f20)
    {
        // Has it got the effect?
        // - Stop and return oAlly.
        if(GetHasSpellEffect(iSpell, oAlly) || GetHasSpellEffect(iSpell1, oAlly) || GetHasSpellEffect(iSpell2, oAlly) || GetHasSpellEffect(iSpell3, oAlly)) return oAlly;
        // Carry on loop
        iCnt++;
        oAlly = GetLocalObject(OBJECT_SELF, ARRAY_ALLIES_RANGE_SEEN + IntToString(iCnt));
    }
...
{
    // deadmagic zone?
    if(GlobalSpellFailure)return FALSE;
    ...
    // bigby!
    oHeal = AI_GetNearestAllyWithSpell(SPELL_BIGBYS_CRUSHING_HAND, SPELL_BIGBYS_CLENCHED_FIST, SPELL_BIGBYS_GRASPING_HAND, SPELL_BIGBYS_FORCEFUL_HAND);
    if(GetIsObjectValid(oHeal) && AI_GetIsBigbyOn(oHeal)==i2)
    {
        if(oHeal!=OBJECT_SELF)
        {
            // very special. antimagic cone.
            if(GetHasSpell(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE) && GetDistanceToObject(oHeal)<f25)
            {
                if(AI_ActionCastSpell(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE,SpellHostAreaInd,oHeal))
                {
                    DelayCommand(GetDistanceBetween(OBJECT_SELF, oHeal)/f20+f1, ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BREACH), oHeal));
                    DelayCommand(GetDistanceBetween(OBJECT_SELF, oHeal)/f20+f1, AI_DoRemoveEffects(oHeal));
                    return TRUE;
                }
            }
        }

        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_MORDENKAINENS_DISJUNCTION, SpellHostAreaInd, oHeal, i19, FALSE, ItemHostAreaInd))
        {
            SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
            return TRUE;
        }
        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_GREATER_DISPELLING, SpellHostRanged, oHeal, i16, FALSE, ItemHostRanged))
        {
            SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
            return TRUE;
        }
        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_DISPEL_MAGIC, SpellHostTouch, oHeal, i13, FALSE, ItemHostTouch))
        {
            SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
            return TRUE;
        }
        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_LESSER_DISPEL, SpellHostAreaInd, oHeal, i12, FALSE, ItemHostAreaInd))
        {
            SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
            return TRUE;
        }
...
int AI_AttemptHealingAlly()
{
    ...
    if(GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_WILL_RAISE_ALLIES_IN_BATTLE, AI_OTHER_COMBAT_MASTER) && SpellConSinTar)
    {
        ...
        {
            object oResuCaster=GetLocalObject(GlobalNearestLeader,AI_SET_RESURRECTION_USER);
            // Talent 7 - Conditional single.
            if((!GetIsObjectValid(oResuCaster) || oResuCaster==OBJECT_SELF) && AI_ActionCastSpell(SPELL_RESURRECTION, SpellConSinTar, GlobalNearestLeader, i17, FALSE, ItemConSinTar))
            {
                // set local object who using resurrection
                SetLocalObject(GlobalNearestLeader,AI_SET_RESURRECTION_USER,OBJECT_SELF);
                DelayCommand(f9,DeleteLocalObject(GlobalNearestLeader,AI_SET_RESURRECTION_USER));

                DelayCommand(f9,AISpeakString(CALL_TO_ARMS));
                return TRUE;
            }
            if((!GetIsObjectValid(oResuCaster) || oResuCaster==OBJECT_SELF) && AI_ActionCastSpell(SPELL_RAISE_DEAD, SpellConSinTar, GlobalNearestLeader, i15, FALSE, ItemConSinTar))
            {
                // set local object who using resurrection
                SetLocalObject(GlobalNearestLeader,AI_SET_RESURRECTION_USER,OBJECT_SELF);
                DelayCommand(f9,DeleteLocalObject(GlobalNearestLeader,AI_SET_RESURRECTION_USER));
        ...
        iDeadHD=GetHitDice(oDead);
        if(GetIsObjectValid(oDead) && !GetIgnore(oDead) &&
            !GetLocalInt(oDead, AI_INTEGER + I_AM_TOTALLY_DEAD) &&
            (GetIsPC(oDead) || iDeadHD>=i20 || GlobalOurHitDice-i10<iDeadHD || !GetIsInCombat()))
        {
            object oResuCaster=GetLocalObject(oDead,AI_SET_RESURRECTION_USER);
            if((!GetIsObjectValid(oResuCaster) || oResuCaster==OBJECT_SELF) && AI_ActionCastSpell(SPELL_RESURRECTION, SpellConSinTar, oDead, i17, FALSE, ItemConSinTar))
            {
                // set local object who using resurrection
                SetLocalObject(oDead,AI_SET_RESURRECTION_USER,OBJECT_SELF);
                DelayCommand(f9,DeleteLocalObject(oDead,AI_SET_RESURRECTION_USER));

                DelayCommand(f9,AISpeakString(CALL_TO_ARMS));
                return TRUE;
            }
            if((!GetIsObjectValid(oResuCaster) || oResuCaster==OBJECT_SELF) && AI_ActionCastSpell(SPELL_RAISE_DEAD, SpellConSinTar, oDead, i15, FALSE, ItemConSinTar))
            {
                // set local object who using resurrection
                SetLocalObject(oDead,AI_SET_RESURRECTION_USER,OBJECT_SELF);
                DelayCommand(f9,DeleteLocalObject(oDead,AI_SET_RESURRECTION_USER));
...
void AI_ActionFleeScared()
{
    ...
    AI_AntiCornerMoveAway(oTarget, TRUE, f50, GlobalIamBlocked);
}
/*::///////////////////////////////////////////////
//:: Name Flee
//::///////////////////////////////////////////////
...
void AI_ActionAbilityAura()
{
    ...
    if(AI_GetAIHaveEffect(GlobalEffectEthereal) || GetHasSpell(SPELL_ETHEREALNESS)) return;
    if(SpellAura)
    {
        int iCnt;
        ...
        // 1.66 added?
        AI_AttemptCastAuraSpell(SPELLABILITY_TROGLODYTE_STENCH);
...
int AI_AttemptArcherRetreat()
{
    ...
    float fMoveRange=(AI_GetHaveSneakAttack())?f5:f8;
        ...
        && !GlobalIamBlockedByObject)
    {
        ...
        if((GlobalEnemiesIn4Meters && GlobalValidAlly && GlobalRangeToAlly < f10) ||
            GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_MOVE_BACK, AI_COMBAT_MASTER))
        {
            // We may, if at the right range (and got a ranged weapon) equip it.
                ...
                GetItemPossessor(oRanged) == OBJECT_SELF)
            {
                ...
                if(iValidAmmo == INVENTORY_SLOT_RIGHTHAND ||
                    GetIsObjectValid(GetItemInSlot(iValidAmmo)) || GetAIInteger(AI_WEAPON_RANGED_IS_UNLIMITED))
                {
                    ...
                    if(GlobalRangeToNearestEnemy<fMoveRange && d6()!=i1)
                    {
                        AI_AntiCornerMoveAway(GlobalNearestEnemySeen, TRUE, fMoveRange,GlobalIamBlocked);
                        AISpeakString(I_WAS_ATTACKED);
                        DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalNearestEnemySeen));
                        return TRUE;
                    }
                }
            }
...
{
    // very special. antimagic cone.
    if(GetHasSpell(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE)
        && (GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_ONLY_SELF_BUFFING_SPELLS,AI_OTHER_COMBAT_MASTER)
        || (GlobalFriendlyFire && !AI_GetIsAllyInShape(SHAPE_SPELLCONE, f25, GetLocation(GlobalDispelTarget)))))
    {
        if(AI_ActionCastSpell(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE,SpellHostAreaInd,GlobalDispelTarget)) return TRUE;
    }

    // Mordenkainens Disjunction. Level 9 (Wizard). Acts like a breach, dispel AND lowers SR, in a big area.
    if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_MORDENKAINENS_DISJUNCTION, SpellHostAreaInd, GlobalDispelTarget, i19, FALSE, ItemHostAreaInd))
    {
        SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
        return TRUE;
    }
    // Greater Dispeling. Level 5 (Bard/Innate) 6 (Cleric/Druid/Mage) General dispel up to 15 caster levels.
    if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_GREATER_DISPELLING, SpellHostRanged, GlobalDispelTarget, i16, FALSE, ItemHostRanged))
    {
        SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
        return TRUE;
    }
    // Dispel Magic. Level 3 (Bard/Cleric/Paladin/Mage/Innate) 6 (Druid) General dispel up to 10 caster levels.
    if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_DISPEL_MAGIC, SpellHostTouch, GlobalDispelTarget, i13, FALSE, ItemHostTouch))
    {
        SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
        return TRUE;
    }
    ...
    if(GlobalAverageEnemyHD < i15)
    {
        ...
        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER) && AI_ActionCastSpell(SPELL_LESSER_DISPEL, SpellHostAreaInd, GlobalDispelTarget, i12, FALSE, ItemHostAreaInd))
        {
            SetLocalTimer(AI_DISPEL_CASTED_TIMER,f8);
            return TRUE;
        }
...
int AI_SpellWrapperPhisicalProtections(int iLowest = 1)
{
    ...
    if(!AI_GetAIHaveEffect(GlobalEffectEthereal) && !GetHasSpellEffect(AI_SPELL_EPIC_WARDING))
    {
    ...
    if(!AI_GetAIHaveEffect(GlobalEffectEthereal) && !GetHasSpellEffect(AI_SPELLABILITY_PSIONIC_INERTIAL_BARRIER))
    {
...
int AI_SpellWrapperShieldProtections(int iLowest = 1)
{
    ...
    if(!GetHasSpellEffect(SPELL_MESTILS_ACID_SHEATH) && (iLowest <= i4) &&
        //    {
        // Elemental Shield. Level 4 (Mage). Does some damage to melee attackers (Casterlvl + d6(), Fire). +50% cold/fire resistance.
        AI_ActionCastSpell(SPELL_MESTILS_ACID_SHEATH, SpellProSelf, OBJECT_SELF, i14, FALSE, ItemProSelf, PotionPro)){ return TRUE;}
        //    }
    else if(!GetHasSpellEffect(SPELL_ELEMENTAL_SHIELD) && (iLowest <= i3) &&
        //    {
        // Acid Sheath. Level 3 (Mage) Does some damage to melee attackers (2 * CasterLvl + 1d6, Acid).
        AI_ActionCastSpell(SPELL_ELEMENTAL_SHIELD, SpellProSelf, OBJECT_SELF, i13, FALSE, ItemProSelf, PotionPro)){ return TRUE;}
        //    }
    else if(!GetHasSpellEffect(SPELL_WOUNDING_WHISPERS) && (iLowest <= i3) &&
        //    {
        // Wounding Whispers. Level 3 (bard) Does some damage to melee attackers (Casterlvl + d6(), Sonic).
        AI_ActionCastSpell(SPELL_WOUNDING_WHISPERS, SpellProSelf, OBJECT_SELF, i13, FALSE, ItemProSelf, PotionPro)){ return TRUE;}
        //    }
    else if(!GetHasSpellEffect(SPELL_HOLY_AURA) && (iLowest <= i2) && GetAlignmentGoodEvil(GlobalMeleeTarget)==ALIGNMENT_EVIL &&
        //    {
        // Holy: Versus Evil. Level 8 (Cleric)
        AI_ActionCastSubSpell(SPELL_HOLY_AURA, SpellEnhSelf, OBJECT_SELF, i18, FALSE, ItemEnhSelf)) return TRUE;
    //    }
    else if(!GetHasSpellEffect(SPELL_UNHOLY_AURA) && (iLowest <= i2) && GetAlignmentGoodEvil(GlobalMeleeTarget)==ALIGNMENT_GOOD &&
        //    {
        // Unholy Holy: Versus Good. Level 8 (Cleric)
        AI_ActionCastSubSpell(SPELL_UNHOLY_AURA, SpellEnhSelf, OBJECT_SELF, i18, FALSE, ItemEnhSelf)) return TRUE;
    //    }
    else if(!GetHasSpellEffect(SPELL_DEATH_ARMOR) && (iLowest <= i2) &&
        //    {
        // Death Armor. Level 2 (Mage) Does some damage to melee attackers (Caster Level/2 (to +5) + 1d4, Magical)
        AI_ActionCastSpell(SPELL_DEATH_ARMOR, SpellProSelf, OBJECT_SELF, i13, FALSE, ItemProSelf, PotionPro)) {return TRUE;}
        //    }
        return FALSE;
}
// Wrappers All Mind resistance spells - Mind blank, Lesser and Clarity. bioware likes 3's...
...
int AI_ActionCastAllyBuffSpell(float fMaxRange, int iPercent, int iSpellToUse1, int iSpellToUse2 = -1, int iSpellToUse3 = -1, int iSpellToUse4 = -1, int iSpellOther1 = -1, int iSpellOther2 = -1, int iEffect = FALSE, int iSpellEffect = FALSE)
{
    if(GlobalSelfBuffer) return FALSE;
    // Not in time stop
...
int AI_ActionCastWhenInvisible()
{
    ...
    // concealment 50% miss is important.
    if(AI_SpellWrapperConsealmentEnhancements(OBJECT_SELF)) return TRUE;

    // Hastes!
    if(AI_ActionCastAllyBuffSpell(f8, i100, SPELL_HASTE, SPELL_MASS_HASTE, iM1, iM1, iM1, iM1, GlobalEffectHaste, FALSE)) return TRUE;
    ...
    // Mantals
    if(!GlobalAntiMeleeWarrior && AI_SpellWrapperMantalProtections()) return TRUE;
    ...
    // Globes
    if(!GlobalAntiMeleeWarrior && AI_SpellWrapperGlobeProtections()) return TRUE;

    // Mind resistances
    if(!GlobalAntiMeleeWarrior && AI_SpellWrapperMindResistanceProtections()) return TRUE;

    // Epic mage armor after specials. Not the best place...
    // +20 AC is good, normally.
    if(!GetHasSpellEffect(SPELL_EPIC_MAGE_ARMOR))
    {
    ...
    // increase caster ability
    if(AI_ActionCastCasterAbilitySpell()) return TRUE;
    ...
    if(!(AI_GetAIHaveEffect(GlobalEffectTrueSeeing) || AI_GetAIHaveEffect(GlobalEffectSeeInvisible)))
    {
        // True Seeing
        if(AI_ActionCastSpell(SPELL_TRUE_SEEING, SpellConAre, OBJECT_SELF, i16, FALSE, ItemConAre, PotionCon)) return TRUE;
    ...
    if(AI_ActionCastAllyBuffSpell(f6, i100, SPELL_STONESKIN)) return TRUE;
    // TRUE SEEING
    if(AI_ActionCastAllyBuffSpell(f6, i100, SPELL_TRUE_SEEING,iM1,iM1,iM1,iM1,iM1,GlobalEffectTrueSeeing,FALSE)) return TRUE;
    ...
    if(GlobalWeAreBuffer)
    {
        ...
        if(AI_ActionCastAllyBuffSpell(f6, i100, SPELL_PROTECTION_FROM_ELEMENTS, SPELL_RESIST_ELEMENTS, SPELL_ENDURE_ELEMENTS)) return TRUE;
...
int AI_ActionCastWhenEthereal()
{
    ...
    // Haste's. short but need?
    if(AI_SpellWrapperHasteEnchantments()) return TRUE;

    // concealment 50% miss is important. long.
    if(AI_SpellWrapperConsealmentEnhancements(OBJECT_SELF)) return TRUE;

    // Visages. short?
    if(AI_SpellWrapperVisageProtections()) return TRUE;

    // Mind resistances. long;
    if(AI_SpellWrapperMindResistanceProtections()) return TRUE;

    // Stoneskin - protection from attackers. long;
    if(AI_SpellWrapperPhisicalProtections()) return TRUE;
    ...
    // Elemental protections (fireball ETC) long;
    if(AI_SpellWrapperElementalProtections()) return TRUE;
    ...
    if(AI_ActionCastAllyBuffSpell(f20, i100, SPELL_HASTE, SPELL_MASS_HASTE, iM1, iM1, iM1, iM1, GlobalEffectHaste, FALSE)) return TRUE;
    // Consealment spells. long;
    if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_IMPROVED_INVISIBILITY, SPELL_DISPLACEMENT)) return TRUE;
    // Try stoneskins as a main one. long.
    if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_STONESKIN)) return TRUE;
    // TRUE SEEING
    if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_TRUE_SEEING,iM1,iM1,iM1,iM1,iM1,GlobalEffectTrueSeeing,FALSE)) return TRUE;
    ...
    if(GlobalWeAreBuffer)
    {
        ...
        if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_PROTECTION_FROM_ELEMENTS, SPELL_RESIST_ELEMENTS, SPELL_ENDURE_ELEMENTS)) return TRUE;

        // Some AC protections. long;
        if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_MAGE_ARMOR, SPELL_BARKSKIN)) return TRUE;

        // Bulls Strength, Cats Grace, Endurance. long;
        if(AI_ActionCastAllyBuffSpell(f20, i100, SPELL_ENDURANCE, SPELL_CATS_GRACE, SPELL_BULLS_STRENGTH, SPELL_GREATER_ENDURANCE, SPELL_GREATER_BULLS_STRENGTH, SPELL_GREATER_CATS_GRACE)) return TRUE;

        // Bless, Aid. long;
        if(AI_ActionCastAllyBuffSpell(f16, i100, SPELL_AID, SPELL_BLESS)) return TRUE;
    }

    // call black blade of disaster?
...
int AI_ActionCastCasterAbilitySpell()
{
    if(GetLevelByClass(CLASS_TYPE_WIZARD)>i5 && GetHasSpell(SPELL_FOXS_CUNNING) && !GetHasSpellEffect(SPELL_FOXS_CUNNING))
    {
        ActionCastSpellAtObject(SPELL_FOXS_CUNNING,OBJECT_SELF);
        return TRUE;
    }
    if((GetLevelByClass(CLASS_TYPE_CLERIC)>i5 || GetLevelByClass(CLASS_TYPE_DRUID)>i5 || GetLevelByClass(CLASS_TYPE_SHIFTER)>i5)
        && GetHasSpell(SPELL_OWLS_WISDOM) && !GetHasSpellEffect(SPELL_OWLS_WISDOM))
    {
        ActionCastSpellAtObject(SPELL_OWLS_WISDOM,OBJECT_SELF);
        return TRUE;
    }
    if((GetLevelByClass(CLASS_TYPE_BARD)>i5 || GetLevelByClass(CLASS_TYPE_SORCERER)>i5)
        && GetHasSpell(SPELL_EAGLE_SPLEDOR) && !GetHasSpellEffect(SPELL_EAGLE_SPLEDOR))
    {
        ActionCastSpellAtObject(SPELL_EAGLE_SPLEDOR,OBJECT_SELF);
        return TRUE;
    }
    if(GetLevelByClass(CLASS_TYPE_PALADIN)>i5)
    {
        if(!GetHasSpellEffect(SPELL_EAGLE_SPLEDOR) && !GetHasSpellEffect(SPELL_AURAOFGLORY))
        {
            if(GetHasSpell(SPELL_AURAOFGLORY))
            {
                ActionCastSpellAtObject(SPELL_AURAOFGLORY, OBJECT_SELF,METAMAGIC_ANY,TRUE);
                DecrementRemainingSpellUses(OBJECT_SELF,SPELL_AURAOFGLORY);
                return TRUE;
            }
            else if(GetHasSpell(SPELL_EAGLE_SPLEDOR))
            {
                ActionCastSpellAtObject(SPELL_EAGLE_SPLEDOR, OBJECT_SELF,METAMAGIC_ANY,TRUE);
                DecrementRemainingSpellUses(OBJECT_SELF,SPELL_EAGLE_SPLEDOR);
                return TRUE;
            }
        }
    }
...
int AI_GetSpellWhoCanSeeInvis(int iLimit)
{
    ...
    int iCnt = i1;
    int iHasSeeingTotal, iTotal, iAdditional,iLoop,iCheck;
    // Loop start
    ...
    while(GetIsObjectValid(oEnemy) && iAdditional < i100)
    {
        ...
        {
            if(GetItemHasItemProperty(GetItemInSlot(iLoop, oEnemy), ITEM_PROPERTY_TRUE_SEEING))
            {
                iCheck=TRUE;
                break;
            }
        ...
        if(GetHasSpellEffect(SPELL_SEE_INVISIBILITY, oEnemy) ||
            ...
            // - We obviously can tell with creatures with true seeing hides. Only checking hides! -- why? lack?
...
int AI_AttemptAllSpells(int iHighestSpellLevel = i10, int iLowestSpellLevel = i0, int iMaxLoopRun = i2, int iLastCheckedRange = i1, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    if(AI_GetAIHaveEffect(GlobalEffectPolymorph) || AI_GetAIHaveEffect(GlobalEffectTensersTransformation) ||
        ...
        GetLocalInt(OBJECT_SELF, "X2_L_STOPCASTING") ||
        // Do we have any spells to cast?
        (GlobalSilenceSoItems==i1 && !GobalOtherItemsValid && !GobalPotionsValid) ||
    ...
    // recheck combat function if target is invalid or dead
    if(!GetIsObjectValid(GlobalSpellTarget) || GetIsDead(GlobalSpellTarget))
    {
    ...
    //            InputRangeShortValid && InputRangeTouchValid && iLastCheckedRange>i3) || iLastCheckedRange>i4)
    // touch range check twice.. maybe have been checked all-round.
    else if(InputRangeTouchValid>=iMaxLoopRun)
    {
        // All done, stop
        return FALSE;
    }
    ...
    {
        switch(iLastCheckedRange)
        {
        case i1:
            RangeLongValid = TRUE;
            RangeMediumValid = FALSE;
            RangeShortValid = FALSE;
            RangeTouchValid = FALSE;
            break;
        case i2:
            RangeLongValid = TRUE;
            RangeMediumValid = TRUE;
        ...
        // Touch
        // touch range is too short to check.. need modify.
        if(RangeTouchValid == i0)
        {
            // Range check for touch - or >= pass 4
            if(GlobalSpellTargetRange <= 3.5 || //fTouchRange ||
                (iLastCheckedRange >= i2 && (InputRangeShortValid >= i1 || RangeShortValid)))
            {
                RangeTouchValid = TRUE;
            }
        }
    ...
    if(iLastCheckedRange == i1)
    {
        ...
        if(AI_AttemptCounterSpell())return TRUE;
    }
    ...
    // Not in time stop
    if(!GlobalCounterSpellTargetPercentage && !GlobalSpellFailure && !GlobalInTimeStop && GlobalIntelligence >= (i6 - d4()))
    {
    ...
    if(!GlobalCounterSpellTargetPercentage && !GlobalSpellFailure && !GlobalInTimeStop && (GlobalIntelligence >= i10) && (GetHasSpell(SPELL_TIME_STOP) >= i2) && !AI_CompareTimeStopStored(SPELL_TIME_STOP))
    {
        GlobalPreventSpellDupleUse=TRUE;
        ...
        GlobalPreventSpellDupleUse=FALSE;
    }

    // Haste - First. Good one, I suppose. Should check for close (non-hasted)
    // allies, to choose between them.
    if(!GlobalCounterSpellTargetPercentage && !GlobalSpellFailure && !AI_GetAIHaveEffect(GlobalEffectHaste) &&
    ...
    if(!GlobalCounterSpellTargetPercentage && !GlobalSpellFailure && GlobalIntelligence >= i5)
    {
        ...
        {
            if(AI_ActionCastWhenEthereal()) return TRUE;
        }
        ...
        else if(AI_GetAIHaveEffect(GlobalEffectDarkness))
        {
    ...
    // Anti arcane spellCaster act. no buff time(time is more than gold!!!)
    // time stop -> spell protection -> dispel if need -> make uncommandable(or even blind) -> fast attack
    // ignore in ethereal effect?
    if(!GlobalCounterSpellTargetPercentage && !GlobalSpellFailure && !AI_GetAIHaveEffect(GlobalEffectEthereal) &&
        AI_GetIsTargetCastable(GlobalSpellTarget) &&
        ((GlobalAntiArcaneSpellCaster && AI_GetIsArcaneCaster(GlobalSpellTarget))
        || (AI_GetIsArcaneCaster(GlobalSpellTarget) && GlobalTotalAllies>GlobalTotalSeenHeardEnemies && GlobalAverageFriendlyHD>GlobalAverageEnemyHD)))
    {
        // time stop. rules all.
        if(!GlobalInTimeStop && GlobalDispelTargetHighestDispel==i5 && !AI_CompareTimeStopStored(SPELL_TIME_STOP))
        {
            GlobalPreventSpellDupleUse=TRUE;
            // Time Stop. Level 9 (Mage). 9 Seconds (by default. Meant to be 1d4 + 1) of frozen time for caster. Meant to be a rare spell.
            if(AI_ActionCastSpell(SPELL_TIME_STOP, SpellHostAreaDis, OBJECT_SELF, i19, FALSE, ItemHostAreaDis)) return TRUE;
        ...
        if(AI_AttemptSummonSpells()) return TRUE;
    ...
    /*
    // This is POWERFUL!
    if(IsFirstRunThrough && AI_GetAIHaveEffect(GlobalEffectEthereal) && !GetIsObjectValid(GetAssociate(ASSOCIATE_TYPE_SUMMONED)) && GlobalCanSummonSimilarLevel <= i10)
    {
    // Black Blade of Disaster. Level 9 (Mage) A powerful greatsword fights. Please note: AI abuses the "concentration" rules for it!
    if(AI_ActionCastSummonSpell(SPELL_BLACK_BLADE_OF_DISASTER, i19, i10)) return TRUE;
    }
    */
    // check core buff spell effect
    // this must be complete in ethereal or invisible status, but cast normal status as well.
    // not in anti arcane spell caster?
    if(!GlobalSpellFailure && !(GlobalAntiArcaneSpellCaster && AI_GetIsArcaneCaster(GlobalSpellTarget) && AI_GetIsTargetCastable(GlobalSpellTarget)))
    {
        if(!GlobalCounterSpellTargetPercentage && AI_CoreBuffSpell()) return TRUE;

        // Special protection
        if(!GetHasSpellEffect(AI_SPELL_EPIC_WARDING))
        {
            // Epic Warding (Mage Only) - Damage reduction 50/+20. Lasts 1 round per level.
            if(AI_ActionUseEpicSpell(AI_FEAT_EPIC_SPELL_EPIC_WARDING, AI_SPELL_EPIC_WARDING)) return TRUE;
        }
        ...
        // Epic mage armor after specials. Not the best place...
        // +20 AC is good, normally.
        if(!AI_GetAIHaveSpellsEffect(GlobalHasOtherACSpell))
        {
            // Epic Mage Armor. (Mage only) +5 of the 4 different AC types. Just +5 dodge is a great asset.
            if(AI_ActionUseEpicSpell(AI_FEAT_EPIC_SPELL_EPIC_MAGE_ARMOR, SPELL_EPIC_MAGE_ARMOR)) return TRUE;
        }
    ...
    int iLoop,iLowLoop,iHighLoop;

    iLowLoop=i5-iHighestSpellLevel/i2;
    iHighLoop=i5-iLowestSpellLevel/i2;

    for(iLoop=iLowLoop;iLoop<=iHighLoop;iLoop++)
    {
        // Dispel Good spells on the enemy.
        // - Dispel Level here.
        // Basically, level spells are mantals and spell-stoppers, or an alful
        // lot of lower level spells.

        // Dispel number need to be 5 for breach
        if(GlobalDispelTargetHighestBreach >= ((i5-iLoop<i1)?i1:i5-iLoop))
        {
            // Wrapers Greater and Lesser Breach.
            if(!GlobalSpellFailure && AI_ActionCastBreach()) return TRUE;
        }
        // Dispel >= 5
        if(GlobalDispelTargetHighestDispel >= ((i5-iLoop<i1)?i1:i5-iLoop))
        {
            // Wrappers the dispel spells
            if(!GlobalSpellFailure && AI_ActionCastDispel()) return TRUE;
        }
        ...
        if(!GlobalSpellFailure && !GlobalInTimeStop && !AI_CompareTimeStopStored(SPELL_TIME_STOP) && d100()<i80)
        {
            GlobalPreventSpellDupleUse=TRUE;
            // Time Stop. Level 9 (Mage). 9 Seconds (by default. Meant to be 1d4 + 1) of frozen time for caster. Meant to be a rare spell.
            if(AI_ActionCastSpell(SPELL_TIME_STOP, SpellHostAreaDis, OBJECT_SELF, i19, FALSE, ItemHostAreaDis)) return TRUE;
        ...
        // attempt instant death spells, or relate ability.
        if(AI_AttemptDeathSpells(iLoop, RangeLongValid, RangeMediumValid, RangeShortValid, RangeTouchValid)) return TRUE;
        // attempt mind affect spells, or relate ability.
        if(AI_AttemptMindSpells(iLoop, RangeLongValid, RangeMediumValid, RangeShortValid, RangeTouchValid)) return TRUE;
        // attempt special effect effect spells, or relate ability.
        // drain, petrify, bigby... etc
        if(AI_AttemptEffectSpells(iLoop, RangeLongValid, RangeMediumValid, RangeShortValid, RangeTouchValid)) return TRUE;
        // attempt damage dealing spells, or relate ability.
        if(AI_AttemptDamageSpells(iLoop, RangeLongValid, RangeMediumValid, RangeShortValid, RangeTouchValid)) return TRUE;
        // attempt additional buff spells.
        if(AI_AttemptAddBuffSpells(iLoop)) return TRUE;
        // attmept ally buff spells.
        if(AI_AttmeptAllyBuffSpells(iLoop))return TRUE;

        if(iLoop>i1)
        {
            if(AI_ActionCastBackupRandomSpell()) return TRUE;
        }
        // for shifter or druid, polymorph will be more effecient... maybe.
        if(iLoop>=i0 && GlobalRangeToNearestEnemy<f4 && GetHasFeat(AI_FEAT_EPIC_WILD_SHAPE_DRAGON)) return FALSE;
        if(iLoop>=i1 && GlobalRangeToNearestEnemy<f4 && GetHasFeat(AI_FEAT_EPIC_CONSTRUCT_SHAPE)) return FALSE;
        if(iLoop>=i1 && GlobalRangeToNearestEnemy<f4 && GetHasFeat(AI_FEAT_EPIC_DRUID_INFINITE_ELEMENTAL_SHAPE)) return FALSE;

        // no arcane caster and more damage in melee than stop.
        if(iLoop>=i0 && !AI_GetIsArcaneCaster(OBJECT_SELF) && GlobalOurBestAttackBonus>=GlobalMeleeTargetAC-iLoop*i5 && d100()<((GlobalOurBestAttackBonus>GlobalMeleeTargetAC)?i60:i30)+iLoop*i10) return FALSE;
    }
    ...
    if(SRA)
    {
        ...
        if(RangeLongValid)InputRangeLongValid++;
        if(RangeMediumValid)InputRangeMediumValid++;
        if(RangeShortValid)InputRangeShortValid++;
        if(RangeTouchValid)InputRangeTouchValid++;
        if(AI_AttemptAllSpells(iHighestSpellLevel, iLowestSpellLevel, iMaxLoopRun, iLastCheckedRange + i1, InputRangeLongValid, InputRangeMediumValid, InputRangeShortValid, InputRangeTouchValid)) return TRUE;
    }
    // Return false. No spell cast.
    return FALSE;
}
...
int AI_ActionUseBreath(object oTarget, talent tBreath, int iSpellID)
{
    ...
    if(!iImmune)
    {
        ...
        //        DelayCommand(f3,DetermineCombatRound(oTarget));
        return TRUE;
    }
    return FALSE;
}
int AI_ActionDragonBreath(object oTarget, int iWingCounter)
{
    ...
    if(!GetIsTalentValid(tBreath) && GetHasSpell(771))
    {
        ActionCastSpellAtLocation(771, GetLocation(oTarget));
        //        ActionAttack(oTarget);
        //        DelayCommand(f3,DetermineCombatRound(oTarget));
        return TRUE;
    }
    else if(GetIsTalentValid(tBreath) && GetHasSpell(771) && d2()==1)
    {
        ActionCastSpellAtLocation(771, GetLocation(oTarget));
        //        ActionAttack(oTarget);
        //        DelayCommand(f3,DetermineCombatRound(oTarget));
...
int AI_AttemptDragonCombat()
{
    ...
    if(SRA)
    {
        if(AI_AttemptAllSpells(i10,FALSE,i1)) return TRUE;
    }
    else
    {
        // attempt core buff
        if(AI_CoreBuffSpell()) return TRUE;
    }
    ...
    if(AI_AttemptAllSpells(i10,i9)) return TRUE;
    ...
    if(GlobalOurBestAttackBonus - i10 >= GlobalMeleeTargetAC &&
    ...
    if(AI_AttemptAllSpells(i10,i9 - iSpellLowestMinus, i1))
    {
        if(AI_AttemptFeatCombatHostile())return TRUE;
...
int AI_ActionBeholderTeleport()
{
    ...
    int iCnt=i0;
    iCnt = GetLocalInt(OBJECT_SELF, MAXINT_ + ARRAY_ALLIES_RANGE_SEEN);
    ...
    if(!GetIsObjectValid(oEnemy) || GetDistanceToObject(oEnemy) > f8) return FALSE;
    ...
    while(GetIsObjectValid(oAlly) && iBreak != TRUE)
    {
        ...
        if(GetDistanceBetween(oAlly,oEnemy) > f10)
        {
            iBreak = TRUE;
        }
        else
    ...
    if(!iBreak)
    {
        ...
        location lfrom,lto;
        float face=GetFacing(OBJECT_SELF);
        int nx,ny,rangex,rangey,minx,miny,nmapx,nmapy;
        float qx,qy;
        //        int nMaxCnt=10;
        nmapx=GetAreaWidth(oArea)*i10;
        nmapy=GetAreaHeight(oArea)*i10;
        lfrom=GetLocation(OBJECT_SELF);
        vec=GetPosition(OBJECT_SELF);
        qx=nmapx/f4;
        qy=nmapy/f4;

        minx=(qx<f10)?FloatToInt(qx):i10;
        miny=(qy<f10)?FloatToInt(qy):i10;

        rangex=(qx<f10)?FloatToInt(qx):i10;
        rangey=(qy<f10)?FloatToInt(qy):i10;

        //        do{
        nx=(d2()==i1)?Random(rangex)+minx:-(Random(rangex)+minx);
        ny=(d2()==i1)?Random(rangey)+miny:-(Random(rangey)+miny);

        if(FloatToInt(vec.x+nx)>nmapx || FloatToInt(vec.x+nx)<i0)nx=-nx;
        if(FloatToInt(vec.y+ny)>nmapy || FloatToInt(vec.y+ny)<i0)ny=-ny;
        //        }while(nMaxCnt-- && !LineOfSightVector(vec,Vector(vec.x+nx,vec.y+ny,vec.z)));

        //        if(!nMaxCnt)return FALSE;

        //        nx=(vec.x<nmapx/f2)?Random(rangex)+minx:(Random(rangex)+minx)*-i1;
        //        ny=(vec.y<nmapy/f2)?Random(rangey)+miny:(Random(rangey)+miny)*-i1;
        // 37: "[DCR] Beholder Teleport"
        ClearAllActions();
        DebugActionSpeakByInt(37);
        lto=Location(oArea,Vector(vec.x+nx,vec.y+ny,vec.z),face);
        effect eBeholder = EffectDisappearAppear(lto,(GetIsAreaInterior(oArea))?i2:i1);
        float fTime = f3 + (GetDistanceBetweenLocations(lfrom,lto)/f10);
        // Apply effect
        ApplyEffectToObject(DURATION_TYPE_TEMPORARY, eBeholder, OBJECT_SELF, fTime);
        // Determine Combat Round
        DelayCommand(fTime + f1, DetermineCombatRound());
    }
    ...
    else
    {
        ...
        ClearAllActions();
        DebugActionSpeakByInt(37);
        effect eBeholder = EffectDisappearAppear(GetLocation(oAlly),d2());
...
int AI_AttemptBeholderCombat()
{
    ...
    // dispel caster.
    if(GetDistanceToObject(GlobalDispelTarget)<f25 &&  GlobalDispelTargetHighestDispel>=i3)
        // Dispel number need to be 5 for breach
    {
        // very special. antimagic cone.
        ActionCastSpellAtObject(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE, GlobalDispelTarget, METAMAGIC_ANY, TRUE);
        return TRUE;
    }

    // bigby check.
    object oBigby = AI_GetNearestAllyWithSpell(SPELL_BIGBYS_CRUSHING_HAND, SPELL_BIGBYS_CLENCHED_FIST, SPELL_BIGBYS_GRASPING_HAND, SPELL_BIGBYS_FORCEFUL_HAND);
    if(GetIsObjectValid(oBigby) && AI_GetIsBigbyOn(oBigby)==i2 && oBigby!=OBJECT_SELF)
        /*&& (!AI_GetIsArcaneCaster(oBigby) ||
        (AI_GetIsArcaneCaster(oBigby) &&
        !AI_GetAIHaveSpellsEffect(GlobalHasConsealmentSpells, oBigby) &&
        !(GetHasSpellEffect(SPELL_MESTILS_ACID_SHEATH, oBigby) || GetHasSpellEffect(SPELL_ELEMENTAL_SHIELD, oBigby)))))*/
    {
        // very special. antimagic cone.
        ActionCastSpellAtObject(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE, oBigby, METAMAGIC_ANY, TRUE);
        DelayCommand(GetDistanceBetween(OBJECT_SELF, oBigby)/f20+f1, ApplyEffectToObject(DURATION_TYPE_INSTANT, EffectVisualEffect(VFX_IMP_BREACH), oBigby));
        DelayCommand(GetDistanceBetween(OBJECT_SELF, oBigby)/f20+f1, AI_DoRemoveEffects(oBigby));
        return TRUE;
    }


    // keep distance!!
    if(GetDistanceToObject(GlobalNearestEnemySeen)<f8 && (!AI_GetIsArcaneCaster(GlobalNearestEnemySeen) || GlobalEnemiesIn4Meters>i1) && d6()!=i1)
    {
        if(AI_ActionBeholderTeleport())
            return TRUE;
    }
    ...
    if(AI_AttemptAllSpells(i10, i8, i1)) return TRUE;
    ...
    // cast anti magic cone to spell caster?
    // remove all buff and apply spell failure short time.
    else if(GlobalAntiArcaneSpellCaster && AI_GetIsArcaneCaster(GlobalSpellTarget) && GetDistanceToObject(GlobalSpellTarget)<f25)
    {
        // very special. antimagic cone.
        ActionCastSpellAtObject(AI_SPELLABILITY_BEHOLDER_MAGIC_CONE, GlobalSpellTarget, METAMAGIC_ANY, TRUE);
        return TRUE;
    }
    // Then magic or bust - no BAB checks
    else if(AI_AttemptAllSpells(i10, FALSE, i1))
    {
        return TRUE;
    }
...
int AI_AttemptMindflayerCombat()
{
    ...
    // Check polymorph
    if(AI_GetAIHaveEffect(GlobalEffectPolymorph, OBJECT_SELF)) return FALSE;

    // healing self.
    if(AI_AttemptHealingSelf())return TRUE;

    // barrier on!
    if(!GetHasSpellEffect(AI_SPELLABILITY_PSIONIC_INERTIAL_BARRIER))
    {
        ActionCastSpellAtObject(AI_SPELLABILITY_PSIONIC_INERTIAL_BARRIER,OBJECT_SELF,METAMAGIC_ANY,TRUE);
        return TRUE;
    }
    // Stunned, held, uncommandable, it is 100%
    else if(!AI_GetAIHaveEffect(GlobalEffectImmunityDrain, GlobalMeleeTarget) &&
        ((AI_GetAIHaveEffect(GlobalEffectParalyze, GlobalMeleeTarget) ||
        AI_GetAIHaveEffect(GlobalEffectDazed, GlobalMeleeTarget) ||
        AI_GetAIHaveEffect(GlobalEffectBlindness, GlobalMeleeTarget) ||
        AI_GetAIHaveEffect(GlobalEffectPetrify, GlobalMeleeTarget) ||
        AI_GetAIHaveEffect(GlobalEffectUncommandable, GlobalMeleeTarget)) ||
        // 30% with daze only.
    ...
    // keep distance.
    else if(GetDistanceToObject(GlobalNearestEnemySeen)<f4 && (!AI_GetIsArcaneCaster(GlobalNearestEnemySeen) || GlobalEnemiesIn4Meters>i1)
        && d6()!=i1 && !GlobalIamBlockedByObject)
    {
        AI_AntiCornerMoveAway(GlobalNearestEnemySeen,TRUE,f5,GlobalIamBlocked);
        DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalNearestEnemySeen));
    }

    if(GetLocalInt(OBJECT_SELF,"DEADMAGIC_SPELLFAILURE")) return FALSE;

    // cast core buff spells.
    if(AI_CoreBuffSpell())return TRUE;

    // cast powerful spells first
    else if(AI_AttemptAllSpells(i10, i10, i1))return TRUE;

    // 70% chance of mind blast(max range=15)
    else if(GlobalRangeToMeleeTarget < f15 && d100() <= i70)
    {
        if(!GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_MIND_SPELLS))
        {
            // will save check
            int iWill=GetWillSavingThrow(GlobalMeleeTarget),iWillCheck;
            // Special mind blast - infinite use?
            if(!GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_STUN))
            {
                iWillCheck=i100-iWill/((i10+GlobalOurHitDice/i2+GetAbilityModifier(ABILITY_WISDOM))/i10)*i5;
                if(GlobalEnemiesIn4Meters>i2 && d100()<iWillCheck)
                {
                    // dc 10+hd/2+wismod
                    ActionCastSpellAtObject(AI_SPELLABILITY_MINDFLAYER_MINDBLAST_10,OBJECT_SELF,METAMAGIC_ANY,TRUE);
                    return TRUE;
                }
                iWillCheck=i100-iWill/i2*i5;
                if(d100()<iWillCheck)
                {
                    if(GlobalOurHitDice>i20)
                    {
                        //dc 19
                        ActionCastSpellAtObject(AI_SPELLABILITY_ILLITHID_MINDBLAST, GlobalMeleeTarget,METAMAGIC_ANY,TRUE,i0,PROJECTILE_PATH_TYPE_DEFAULT);
                        return TRUE;
                    }
                    // dc 17
                    ActionCastSpellAtObject(SPELLABILITY_MINDBLAST, GlobalMeleeTarget,METAMAGIC_ANY,TRUE,i0,PROJECTILE_PATH_TYPE_DEFAULT);
                    return TRUE;
                }
                //                ActionCastSpellAtObject(551, GlobalMeleeTarget,METAMAGIC_ANY,TRUE,0,PROJECTILE_PATH_TYPE_DEFAULT);
                //                return TRUE;
            }
            else if(!GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_CHARM))
            {
                iWillCheck=i100-iWill/i2*i5;
                if(d100()<i100-iWillCheck)
                {
                    // psionic charm, dc17 4 round.
                    ActionCastSpellAtObject(SPELLABILITY_CHARMMONSTER, GlobalMeleeTarget,METAMAGIC_ANY,TRUE,i0,PROJECTILE_PATH_TYPE_DEFAULT);
                    return TRUE;
                }
            }
        }
        //        else if(GetHasSpell(AI_SPELLABILITY_PSIONIC_MASS_CONCUSSION))
        ActionCastSpellAtObject(AI_SPELLABILITY_PSIONIC_MASS_CONCUSSION,GlobalMeleeTarget,METAMAGIC_ANY,TRUE);
        return TRUE;
    }
    if(AI_AttemptAllSpells(i10, FALSE, i1))return TRUE;
    // False means no special mind flayer attacks.
    ActionCastSpellAtObject(AI_SPELLABILITY_PSIONIC_MASS_CONCUSSION,GlobalMeleeTarget,METAMAGIC_ANY,TRUE);
    // no return false. if true, call AI_AttemptAllSpells again and occure error message.
    return TRUE;
}
...
void AI_SetDispelableEnchantments()
{
    ...
    if(GetIsObjectValid(oMaster))
    {
        ...
        // or modified modenkainen's sword.
        //        if(GetTag(GlobalDispelTarget) == "x2_s_bblade")
        /*        if(GetPlotFlag(GlobalDispelTarget))
        {
        // Check if seen
        ...
        if((GetObjectSeen(oMaster) || GetObjectHeard(oMaster)) && GetAssociateType(GlobalDispelTarget)==ASSOCIATE_TYPE_SUMMONED)
        {
            // Dispel the caster
            GlobalDispelTarget = oMaster;
            GlobalDispelTargetHighestDispel = i5;
        ...
        GlobalDispelTargetHighestBreach < i5)
    {
        ...
        if(iSpellID >= i0 && GetEffectSubType(eCheck) == SUBTYPE_MAGICAL)
        {
            ...
            case SPELL_ELEMENTAL_SHIELD: // level + 1d6 fire Damage Sheild (gives HTH attackers damage)
            ...
            case SPELL_IMPROVED_INVISIBILITY:// maybe melee, for support melee allies
            case SPELL_MIND_BLANK:
...
// beware shield damage.
// Get target has shield damage magic, or target is black blade of disaster(or mordenkainen's sword)
// return value=1 : swords, =2 : shield effect. =3 : has shield but uncommandable.
int AI_GetIsMustDispelMeleeTarget(object oTarget)
{
    // Summons dispelling
    ...
    while(GetIsEffectValid(eCheck))
    {
        ...
        if(iSpellID >= i0 && GetEffectSubType(eCheck) == SUBTYPE_MAGICAL)
        {
            ...
            case SPELL_ELEMENTAL_SHIELD: // level + 1d6 fire Damage Sheild (gives HTH attackers damage)
                ...
                // don't want dispel this target.
                // - Stun, sleep, fear
                if(AI_GetAIHaveEffect(GlobalEffectUncommandable, oTarget) ||
                    // - Petrify
                    AI_GetAIHaveEffect(GlobalEffectPetrify, oTarget) ||
                    // - Paralyze
                    AI_GetAIHaveEffect(GlobalEffectParalyze, oTarget) ||
                    // - Plot flag
                    GetPlotFlag(oTarget))
                {
                    return i3;
...
{
    object oTarget;
    oTarget = GetFirstObjectInShape(nShape, fSize, lTarget, TRUE, nObjectFilter);
    while(GetIsObjectValid(oTarget))
    {
        ...
        oTarget = GetNextObjectInShape(nShape, fSize, lTarget, TRUE, nObjectFilter);
    }
    return FALSE;
}
// bigby check
...
int AI_GetIsBigbyOn(object oTarget)
{
    ...
    {
        int iMod=GetLocalInt(oTarget,"X2_BIGBY_CASTERMODIFIER");
        if(GetAbilityModifier(ABILITY_STRENGTH,oTarget)<i40 ||
            (!AI_GetAIHaveEffect(GlobalEffectFreedomOfMovement, oTarget) && GetAC(oTarget)<i30+iMod && GetBaseAttackBonus(oTarget)+GetAbilityModifier(ABILITY_STRENGTH,oTarget)<i30+iMod))
        {
            return i2;
        }
        return TRUE;
...
int AI_GetIsArcaneCaster(object oTarget)
{
    ...
    if(GetLevelByClass(CLASS_TYPE_WIZARD,oTarget)>=nHD/i2 || GetLevelByClass(CLASS_TYPE_SORCERER,oTarget)>=nHD/i2)
    {
        return TRUE;
    }
    return FALSE;
...
int AI_GetIsSpellCaster(object oTarget)
{
    int nHD=GetHitDice(oTarget);
    // caster's information
    if(GetLevelByClass(CLASS_TYPE_WIZARD,oTarget)>=nHD/i2 ||
        GetLevelByClass(CLASS_TYPE_SORCERER,oTarget)>=nHD/i2 ||
        GetLevelByClass(CLASS_TYPE_BARD,oTarget)>=nHD/i2 ||
        GetLevelByClass(CLASS_TYPE_CLERIC,oTarget)>=nHD/i2 ||
        GetLevelByClass(CLASS_TYPE_DRUID,oTarget)>=nHD/i2)
    {
        return TRUE;
    }
    return FALSE;
...
int AI_GetIsTargetCastable(object oTarget)
{
    if(GetIsObjectValid(oTarget))
    {
        if(!GetIsDead(oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectBlindness,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectUncommandable,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectSilenced,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectDazed,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectPetrify,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectParalyze,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectPolymorph,oTarget)
            && !AI_GetAIHaveEffect(GlobalEffectTensersTransformation,oTarget))
        {
            return TRUE;
        }
        else
...
{
    int iSave,iResult;
    if(nSavingThrowType==SAVING_THROW_FORT)
    {
        iSave=GlobalSpellTargetFort;
    }
    if(nSavingThrowType==SAVING_THROW_REFLEX)
    {
        iSave=GlobalSpellTargetReflex;
    }
    if(nSavingThrowType==SAVING_THROW_WILL)
    {
        iSave=GlobalSpellTargetWill;
    }
    iResult=FloatToInt(IntToFloat(iDC-iSave)/f20*f100)+GlobalIntelligence*i2;
    if(iResult>i100)iResult=i100;
    if(iResult<i20)iResult=i20;
    return iResult;
}
...
int AI_GetIsRangedAttacker(object oTarget)
{
    ...
    if(GetLevelByClass(CLASS_TYPE_ARCANE_ARCHER,oTarget))return TRUE;
    if(GetLevelByClass(CLASS_TYPE_WIZARD,oTarget)>iHD/2)return TRUE;
    if(GetLevelByClass(CLASS_TYPE_SORCERER,oTarget)>iHD/2)return TRUE;
    if(GetLevelByClass(CLASS_TYPE_DRUID,oTarget)>iHD/2)return TRUE;
    if(GetLevelByClass(CLASS_TYPE_CLERIC,oTarget)>iHD/2)return TRUE;
    return FALSE;
}
...
int AI_GetCounterSpellPossibility(object oTarget,object oSource=OBJECT_SELF)
{
    ...
    int iSourceHD=GetHitDice(oSource);

    if(GetHasSpell(SPELL_MORDENKAINENS_DISJUNCTION,oSource))iCntPct=i100;
    else if(GetHasSpell(SPELL_GREATER_DISPELLING,oSource))
    {
        if(iTargetHD<=i12)iCntPct=i70;
        else iCntPct=i40;
    }
    else if(GetHasSpell(SPELL_DISPEL_MAGIC,oSource))
    {
        if(iTargetHD<=i6)iCntPct=i70;
        else if(iTargetHD<=i12)iCntPct=i30;
        else iCntPct=i15;
    }
    else if(GetHasSpell(SPELL_LESSER_DISPEL,oSource))
    {
        if(iTargetHD<=i4)iCntPct=i70;
        else if(iTargetHD<=i8)iCntPct=i20;
        else iCntPct=i5;
    }

    if((GetLevelByClass(CLASS_TYPE_BARD,oTarget)+
        GetLevelByClass(CLASS_TYPE_SORCERER,oTarget))+
        GetLevelByClass(CLASS_TYPE_WIZARD,oTarget)>=iTargetHD/i2 &&
        GetLevelByClass(CLASS_TYPE_SORCERER,oSource)+GetLevelByClass(CLASS_TYPE_WIZARD,oSource)>=iSourceHD/i2)
    {
        iCntPct+=i25;
    }
    if(GetLevelByClass(CLASS_TYPE_CLERIC,oTarget)+
        GetLevelByClass(CLASS_TYPE_DRUID,oTarget)>=iTargetHD/i2 &&
        GetLevelByClass(CLASS_TYPE_CLERIC,oSource)+GetLevelByClass(CLASS_TYPE_DRUID,oSource)>=iSourceHD/i2)
    {
        iCntPct+=i25;
    }
    return iCntPct;
...
int AI_SetUpAllObjects(object oImputBackup)
{
    ...
    SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_TEMP_ALLIES, GlobalTotalAllies);
    SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_TEMP_ENEMIES, iCnt);
    ...
    GlobalCounterSpellTarget = OBJECT_INVALID;
    GlobalCounterSpellTargetPercentage = FALSE;
    ...
    while(GetIsObjectValid(oSetUpTarget))
    {
            ...
            !GetLocalInt(oSetUpTarget, AI_TIMER_EFFECT_SET))
        {
            ...
            //            AssignCommand(oSetUpTarget,AI_SetEffectsOnTarget(oSetUpTarget));
            /*
        ...
        if(!AI_GetAIHaveEffect(GlobalEffectPetrify, oSetUpTarget) && !GetIsDead(oSetUpTarget))
        {
            ...
            if(GetObjectSeen(oSetUpTarget))
            {
                ...
                // Need a dispel spell
                if(//fCurrentRange<=f20 &&
                    AI_GetIsTargetCastable(oSetUpTarget) &&
                    GetActionMode(oSetUpTarget,ACTION_MODE_COUNTERSPELL) && GetObjectSeen(OBJECT_SELF,oSetUpTarget) &&
                    AI_GetCounterSpellPossibility(OBJECT_SELF,oSetUpTarget)>=d100())
                {
                    GlobalCounterSpellTargetPercentage++;
                }

                int iCasterLevels,iHighestLevels;
                if(//fCurrentRange<=f20 &&
                    GetSpawnInCondition(AI_FLAG_COMBAT_COUNTER_SPELL_ARCANE, AI_COMBAT_MASTER) &&
                    !GetActionMode(oSetUpTarget,ACTION_MODE_COUNTERSPELL) &&
                    AI_GetIsTargetCastable(oSetUpTarget))
                {
                    // Check caster levels
                    iCasterLevels = GetLevelByClass(CLASS_TYPE_WIZARD, oSetUpTarget) +
                        GetLevelByClass(CLASS_TYPE_SORCERER, oSetUpTarget) +
                        GetLevelByClass(CLASS_TYPE_BARD, oSetUpTarget);
                    // Check if higher.
                    oTempLoopObject = GetLocalObject(oSetUpTarget,AI_COUNTERSPELL_USER);
                    if(iCasterLevels > iHighestLevels && iCasterLevels>=GetHitDice(oSetUpTarget)/i2 && (!GetIsObjectValid(oTempLoopObject) || oTempLoopObject==OBJECT_SELF))
                    {
                        iHighestLevels = iCasterLevels;
                        GlobalCounterSpellTarget = oSetUpTarget;
                    }
                }
                if(//fCurrentRange<=f20 &&
                    !GetIsObjectValid(GlobalCounterSpellTarget) && !GetActionMode(oSetUpTarget,ACTION_MODE_COUNTERSPELL) &&
                    iHighestLevels >= GlobalOurHitDice / i3 && AI_GetIsTargetCastable(oSetUpTarget) &&
                    GetSpawnInCondition(AI_FLAG_COMBAT_COUNTER_SPELL_DIVINE, AI_COMBAT_MASTER))
                {
                    // Check caster levels
                    iCasterLevels = GetLevelByClass(CLASS_TYPE_CLERIC, oSetUpTarget) +
                        GetLevelByClass(CLASS_TYPE_DRUID, oSetUpTarget);
                    // Check if higher.
                    oTempLoopObject = GetLocalObject(oSetUpTarget,AI_COUNTERSPELL_USER);
                    if(iCasterLevels > iHighestLevels && iCasterLevels>=GetHitDice(oSetUpTarget)/i2 && (!GetIsObjectValid(oTempLoopObject) || oTempLoopObject==OBJECT_SELF))
                    {
    ...
    SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_ENEMY_RANGE_SEEN, iCnt2);
    SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_ENEMY_RANGE_HEARD, iCnt3);
    ...
    */
    if(GetGameDifficulty()>GAME_DIFFICULTY_NORMAL && GetLocalInt(GetModule(),"X2_SWITCH_ENABLE_NPC_AOE_HURT_ALLIES") == TRUE)
    {
        GlobalFriendlyFire = TRUE;        // Hostile Creature and Difficulty > Normal
    }
    else
    {
        GlobalFriendlyFire = FALSE;
    }
    ...
    if(GlobalValidAlly)
    {
        ...
        while(GetIsObjectValid(oSetUpTarget))
        {
            ...
            if(GetObjectSeen(oSetUpTarget))
            {
                if(AI_GetIsSpellCaster(oSetUpTarget) && AI_GetIsTargetCastable(oSetUpTarget))
                {
                    // tmp use of iTypeOfTarget for ally caster count
                    iTypeOfTarget++;
                }
                iCnt2++;
        ...
        SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_ALLIES_RANGE_SEEN, iCnt2);
            ...
            GetDistanceToObject(oSetUpTarget) <= fSetMaxWeCanGoTo)
        {
            ...
            // Add multi class check
            if(GetLevelByClass(CLASS_TYPE_SORCERER, oSetUpTarget)<i8 &&
                GetLevelByClass(CLASS_TYPE_WIZARD, oSetUpTarget)<i8 &&
                // - Master check
        ...
        SetLocalInt(OBJECT_SELF, MAXINT_+ARRAY_ALLIES_RANGE_SEEN_BUFF, iCnt2);
    }
    // percentage of enemy's counterspell is targeting me
    GlobalCounterSpellTargetPercentage*=i100/(iTypeOfTarget+i1);
    if(d100()<=GlobalCounterSpellTargetPercentage)
    {
        GlobalCounterSpellTargetPercentage = TRUE;
        GlobalSilenceSoItems = i2;
    }
    else
    {
        GlobalCounterSpellTargetPercentage = FALSE;
    ...
    else if(GetSpawnInCondition(AI_FLAG_OTHER_LAG_TARGET_NEAREST_ENEMY, AI_OTHER_MASTER) || GlobalIntelligenceScore<i8)
    {
    ...
    // blocked or entangled, get nearest
    else if(GlobalIamBlocked || AI_GetAIHaveEffect(GlobalEffectEntangle) && AI_GetIsMustDispelMeleeTarget(GlobalNearestEnemySeen)!=i1 && GlobalRangeToNearestEnemy < f2+(IntToFloat(GlobalOurSize)/f4))
    {
        if(GetIsObjectValid(GlobalNearestEnemySeen))
        {
            // The validness of these are checked later anyway
    ...
    //    if(!GetIsObjectValid(oLastTarget)) oLastTarget = GlobalMeleeTarget;
    ...
    if(//!GetIsObjectValid(GlobalMeleeTarget) ||
        (!GetIsObjectValid(GlobalMeleeTarget) && AI_GetTargetSanityCheck(oLastTarget) || // Sanity check (dead, valid, ETC)
    ...
    else if(!GetIsObjectValid(GlobalMeleeTarget))
    {
        GlobalMeleeTarget = oLastTarget;
    }

    oSetUpTarget=GetMaster(GlobalMeleeTarget);
    if(!AI_GetTargetSanityCheck(oSetUpTarget) &&
        (GetAssociateType(GlobalMeleeTarget)==ASSOCIATE_TYPE_SUMMONED || GetAssociateType(GlobalMeleeTarget)==ASSOCIATE_TYPE_FAMILIAR || GetAssociateType(GlobalMeleeTarget)==ASSOCIATE_TYPE_ANIMALCOMPANION) &&
        (GetObjectSeen(oSetUpTarget) || GetObjectHeard(oSetUpTarget)) &&
        GlobalIntelligenceScore>=i8)
    {
        GlobalMeleeTarget = oSetUpTarget;
    }

    // react when target has elemental shield
    if(!GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_USE_BOW, AI_COMBAT_MASTER) &&
        !GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_DISPEL_WITH_MELEE, AI_OTHER_COMBAT_MASTER) &&
        AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget)>=i2 && GlobalIntelligenceScore>=i8)
    {
        // if damage shilded, chose other target
        iCnt=i1;
        oSetUpTarget=GetLocalObject(OBJECT_SELF,ARRAY_ENEMY_RANGE_SEEN+IntToString(iCnt));
        while(GetIsObjectValid(oSetUpTarget))
        {
            if(!AI_GetIsMustDispelMeleeTarget(oSetUpTarget))
            {
                GlobalMeleeTarget = oSetUpTarget;
                break;
            }
    ...
    if(!GetIsObjectValid(GlobalMeleeTarget) ||
        !GetObjectSeen(GlobalMeleeTarget) && !GetObjectHeard(GlobalMeleeTarget))
    {
        GlobalMeleeTarget = GlobalNearestEnemySeen;
        if(!GetIsObjectValid(GlobalMeleeTarget))
        {
            GlobalMeleeTarget = GlobalNearestEnemyHeard;
        }
    }

    // If it is a new target, reset attacking counter to 0
    if(GlobalMeleeTarget != GetAIObject(AI_LAST_MELEE_TARGET))
    {
    ...
    if(GetIsObjectValid(GetAIObject(AI_WEAPON_RANGED)) &&
        (!GetIsObjectValid(GlobalRangedTarget) || AI_GetTargetSanityCheck(oLastTarget) || // Sanity check (dead, valid, ETC)
        // And must pass a % roll
    ...
    GlobalMeleeTargetBestAttackBonus = AI_GetBestAttackRoll(GlobalMeleeTarget);
    // Generic check.
    ...
    GlobalSpellClassRDD = GetLevelByClass(CLASS_TYPE_DRAGONDISCIPLE, GlobalSpellTarget)>=i10;
    // Range
    ...
    GlobalAntiArcaneSpellCaster=FALSE;
    GlobalAntiMeleeWarrior=FALSE;
    int nHD,nCaster=i0,nCasterHD=i0,nNonCaster=i0,nNonCasterHD=i0,
        nLoop=i1,nCnt=GetLocalInt(OBJECT_SELF, MAXINT_ + ARRAY_ENEMY_RANGE);
    object oCaster=GetLocalObject(OBJECT_SELF,ARRAY_ENEMY_RANGE+s1),oCaster2;
    while(GetIsObjectValid(oCaster))
    {
        nHD=GetHitDice(oCaster);
        // caster's information
        if(AI_GetIsArcaneCaster(oCaster)
            && AI_GetIsTargetCastable(oCaster))
        {
            nCaster++;
            nCasterHD+=nHD;
        }
        // noncaster's information. ignore summon.
        else if(!GetIsObjectValid(GetMaster(oCaster)))
        {
            nNonCaster++;
            nNonCasterHD+=nHD;
        }
        oCaster=GetLocalObject(OBJECT_SELF,ARRAY_ENEMY_RANGE+IntToString(++nLoop));
    }
    // one or more caster, less than 2 noncaster(maybe warrior)
    if(nCaster>i0 && nNonCaster<i2)
    {
        // no noncaster or caster's level is enouth high
        if(!nNonCaster || (nNonCaster && (nCasterHD/nCaster>nNonCasterHD/nNonCaster*i2)))
        {
            // check for special act.
            GlobalAntiArcaneSpellCaster=TRUE;
        }
    }
    if(nCaster==i0 && nNonCaster)
    {
        GlobalAntiMeleeWarrior=TRUE;
    }

    oSetUpTarget=GetLocalObject(OBJECT_SELF,AI_SAVED_DISPEL_TARGET);
    if(GetObjectType(oSetUpTarget)==OBJECT_TYPE_CREATURE && AI_GetIsMustDispelMeleeTarget(oSetUpTarget)!=i0)
    {
        GlobalDispelTarget = oSetUpTarget;
        DelayCommand(f12,DeleteLocalObject(OBJECT_SELF,AI_SAVED_DISPEL_TARGET));
    }
    if(!GetIsObjectValid(GlobalDispelTarget) || AI_GetTargetSanityCheck(GlobalDispelTarget))
    {
        GlobalDispelTarget = GlobalSpellTarget;
    }
    // Set enchantments
...
int AI_AttemptHostileSkills()
{
    if(((GlobalAntiArcaneSpellCaster && AI_GetIsArcaneCaster(GlobalMeleeTarget) && AI_GetIsTargetCastable(GlobalMeleeTarget))
        || AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget)
        || GlobalRangeToMeleeTarget < f2) &&
        !GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_USE_BOW, AI_COMBAT_MASTER) &&
        !GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ALWAYS_MOVE_BACK, AI_COMBAT_MASTER))
        // why SRA?. process this mean that we have no proper magic.
        //      !SRA)// Spell ranged attacking = AI_FLAG_COMBAT_LONGER_RANGED_SPELLS_FIRST
    {
        ...
        if(((!GetSpawnInCondition(AI_FLAG_OTHER_COMBAT_NO_PICKPOCKETING, AI_OTHER_COMBAT_MASTER) &&
            ...
            // to use pick pocket skill, rank is greater than 20.
            && GetSkillRank(SKILL_PICK_POCKET)>i20)
        {
...
int AI_AttemptFeatCombatHostile()
{
    // check differ spells and feat.
    int iUseSpells = TRUE;

    // check stop casting(for henchman AI)
    if(GetLocalInt(OBJECT_SELF, "X2_L_STOPCASTING"))return FALSE;

    if(GlobalSpellFailure || AI_GetAIHaveEffect(GlobalEffectPolymorph) || AI_GetAIHaveEffect(GlobalEffectTensersTransformation))iUseSpells=FALSE;
    ...
    if(iUseSpells)
    {
        ...
        if(!GetHasSpellEffect(SPELL_DIVINE_POWER) && AI_ActionCastSpell(SPELL_DIVINE_POWER, SpellEnhSelf, OBJECT_SELF, i14, FALSE, ItemEnhSelf, PotionPro)) return TRUE;
        ...
        // Up to +5 Dodge AC.
        if(GetHasFeat(FEAT_TURN_UNDEAD) && iCha>=i5 && GlobalOurAC+iCha>GlobalMeleeTargetBestAttackBonus)
        {
            // Divine Shield
            if(AI_ActionUseFeatOnObject(FEAT_DIVINE_SHIELD)) return TRUE;
        }
        // Divine might adds charisma bonus to Attack.
        if(GetHasFeat(FEAT_TURN_UNDEAD) && iCha>=i7 && GlobalOurBestAttackBonus+i10>=GlobalMeleeTargetAC)
        {
            // +Cha bonus to attack bonus.
            if(AI_ActionUseFeatOnObject(FEAT_DIVINE_MIGHT)) return TRUE;
        }
        // many bonus.
        if(GetHasFeat(FEAT_DIVINE_WRATH) && GlobalOurBestAttackBonus+i10>=GlobalMeleeTargetAC)
        {
            // +Cha bonus to attack bonus.
            if(AI_ActionUseFeatOnObject(FEAT_DIVINE_WRATH)) return TRUE;
        }
        // spell?
        if(!GetHasSpellEffect(SPELLABILITY_DC_DIVINE_WRATH) && GetHasSpell(SPELLABILITY_DC_DIVINE_WRATH)  && GlobalOurBestAttackBonus+i10>=GlobalMeleeTargetAC)
        {
            ActionCastSpellAtObject(SPELLABILITY_DC_DIVINE_WRATH,OBJECT_SELF,METAMAGIC_ANY);
        }
    ...
    // feat base ability check, for tenser's transformation
    else
    {
        int iCha=GetAbilityModifier(ABILITY_CHARISMA);
        // Divine Shield - a feat, but a damn good one.
    ...
    if(iUseSpells && GlobalRangeToMeleeTarget >= f20 &&
        !GetWeaponRanged(GlobalRightHandWeapon) &&
    ...
    // a ranged weapon
    if(iUseSpells &&
        ((GlobalRangeToMeleeTarget < f3 && !AI_GetIsMustDispelMeleeTarget(GlobalMeleeTarget)) ||
        GetWeaponRanged(GlobalRightHandWeapon)) &&
        !GetHasSpellEffect(SPELL_TRUE_STRIKE))
    {
        ...
        if(AI_ActionCastSpell(SPELL_TRUE_STRIKE, SpellEnhSelf, OBJECT_SELF, i11, FALSE, ItemEnhSelf, PotionEnh))
        {
            ...
            ActionAttack(GlobalMeleeTarget);
            //            DelayCommand(f3,DetermineCombatRound(GlobalMeleeTarget));
            return TRUE;
        }
    }
    // last. divine favor.. short duration but not bad.
    if(iUseSpells && !GetHasSpellEffect(SPELL_DIVINE_FAVOR) && GetHasSpell(SPELL_DIVINE_FAVOR))
    {
...
int AI_AttemptPolyMorph()
{
        ...
        !GetSpawnInCondition(AI_FLAG_COMBAT_ARCHER_ATTACKING, AI_COMBAT_MASTER))
    {
        ...
        if(!AI_GetAIHaveEffect(GlobalEffectPolymorph))
        {
            ...
            // modified, tenser first. we can use shifter ability after that.
            // modifyed magic. tenser is not polymorph
            if(!GlobalSpellFailure && !AI_GetAIHaveEffect(GlobalEffectTensersTransformation))
            {
            ...
            if(GlobalOurAC<i30 && AI_ActionPolymorph(SPELL_SHAPECHANGE, 392, 5)) return TRUE;
            // Druid feat. Elements.
            // 397   Elemental_Shape_FIRE
            // 398   Elemental_Shape_WATER
            // 399   Elemental_Shape_EARTH
            // 400   Elemental_Shape_AIR
            if(GlobalOurAC<i25 && AI_ActionPolymorph(AI_FEAT_EPIC_DRUID_INFINITE_ELEMENTAL_SHAPE, 397, 4, TRUE, FALSE)) return TRUE;
            if(GlobalOurAC<i25 && AI_ActionPolymorph(FEAT_ELEMENTAL_SHAPE, 397, 4, TRUE)) return TRUE;
            ...
            if(GlobalOurAC<i15 && AI_ActionPolymorph(AI_FEAT_EPIC_DRUID_INFINITE_WILDSHAPE, 401, 5, TRUE, FALSE)) return TRUE;
            if(GlobalOurAC<i15 && AI_ActionPolymorph(FEAT_WILD_SHAPE, 401, 5, TRUE)) return TRUE;
            ...
            if(GlobalOurAC<i15 && AI_ActionPolymorph(SPELL_POLYMORPH_SELF, 387, 5, TRUE)) return TRUE;
        }
        else /*Else we have it*/if(d10() <= i6)
        {
            // dragon breath power check. don't use breath when too low dice...
            if(GetHasSpellEffect(SPELL_SHAPECHANGE)) return FALSE;
            nAge = (GetLevelByClass(CLASS_TYPE_DRUID,OBJECT_SELF) +  GetLevelByClass(CLASS_TYPE_SHIFTER,OBJECT_SELF))/i2+i1;
            if(GetLevelByClass(CLASS_TYPE_SHIFTER,OBJECT_SELF)<i10)nAge-=i4;
            if(nAge<i15)nBreath=FALSE;
            ...
            case APPEARANCE_TYPE_DRAGON_RED:
                if(nBreath)
                {
                    ActionCastSpellAtObject(AI_SPELLABILITY_SHIFTER_REDBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                    return TRUE;
                }
                break;
            case APPEARANCE_TYPE_DRAGON_BLUE:
                if(nBreath)
                {
                    ActionCastSpellAtObject(AI_SPELLABILITY_SHIFTER_BLUEBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                    return TRUE;
                }
                break;
            case APPEARANCE_TYPE_DRAGON_GREEN:
                if(nBreath)
                {
                    ActionCastSpellAtObject(AI_SPELLABILITY_SHIFTER_GREENBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                    return TRUE;
                }
                break;
            ...
            case APPEARANCE_TYPE_WYRMLING_RED:
                ActionCastSpellAtObject(AI_SPELLABILITY_WYRMREDBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                return TRUE;
                break;
            case APPEARANCE_TYPE_WYRMLING_BLUE:
                ActionCastSpellAtObject(AI_SPELLABILITY_WYRMBLUEBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                return TRUE;
                break;
            case APPEARANCE_TYPE_WYRMLING_GREEN:
                ActionCastSpellAtObject(AI_SPELLABILITY_WYRMGREENBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                return TRUE;
                break;
            case APPEARANCE_TYPE_WYRMLING_BLACK:
                ActionCastSpellAtObject(AI_SPELLABILITY_WYRMBLACKBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                return TRUE;
                break;
            case APPEARANCE_TYPE_WYRMLING_WHITE:
                ActionCastSpellAtObject(AI_SPELLABILITY_WYRMWHITEBREATH,GlobalMeleeTarget,METAMAGIC_NONE,TRUE);
                return TRUE;
                break;
            ...
            case APPEARANCE_TYPE_RAKSHASA_TIGER_MALE:
                {
                    ...
                    if(d10() <= i6 && GlobalDispelTargetHighestDispel>i2)
                    {
...
int AI_TacticFleeHide()
{
    // if checked at AI_StopWhatWeAreDoing.
    if(GetStealthMode(OBJECT_SELF)==STEALTH_MODE_ACTIVATED  && !AI_GetAIHaveEffect(GlobalEffectTrueSeeing, GlobalMeleeTarget))
    {
        if(GlobalTotalAllies==i0 && GetHasFeat(FEAT_PRESTIGE_DEATH_ATTACK_1) && GetIsInCombat(GlobalMeleeTarget) && !GlobalIamBlockedByObject &&
            !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_CRITICAL_HIT) && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_SNEAK_ATTACK) &&
            !(AI_GetAIHaveEffect(GlobalEffectParalyze, GlobalMeleeTarget) || AI_GetAIHaveEffect(GlobalEffectPetrify, GlobalMeleeTarget) || AI_GetAIHaveEffect(GlobalEffectUncommandable, GlobalMeleeTarget)))
        {
            DeleteLocalInt(OBJECT_SELF, AI_TIMER + AI_TIMER_TURN_OFF_HIDE);
            if(GlobalRangeToMeleeTarget<f5)
                AI_AntiCornerMoveAway(GlobalMeleeTarget,FALSE,f5,GlobalIamBlocked);
            else
                ActionMoveToObject(GlobalMeleeTarget,FALSE,f6);
            DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
            return TRUE;
        ...
        if(GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND)) && !GlobalIamBlockedByObject && GlobalRangeToMeleeTarget<f5 && d6()!=i1)
        {
            AI_AntiCornerMoveAway(GlobalMeleeTarget,FALSE,f5,GlobalIamBlocked);
            DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
            return TRUE;
    ...
    // then i have no hide-in-plain-sight feat or any enemy has true seeing.
    // enemy attack me and i have sneak attack and allies, move to ally or move away...
    object oAlly,oAllyEnemy;
    int iCnt=i1;
    float iAllyRange;
    // have sneak attack and enemy don't have immunity. + no ranged weapon.
    if(AI_GetHaveSneakAttack() && GlobalTotalAllies>i0 && GetAttackTarget(GlobalMeleeTarget)==OBJECT_SELF
        && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_CRITICAL_HIT) && !GetIsImmune(GlobalMeleeTarget,IMMUNITY_TYPE_SNEAK_ATTACK)
        && !GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,GlobalMeleeTarget)))
    {
        // ally check
        // there a ally who is little away from enemy
        oAlly=GetLocalObject(OBJECT_SELF,ARRAY_ALLIES_RANGE+IntToString(iCnt));
        while(GetIsObjectValid(oAlly))
        {
            iAllyRange=GetDistanceBetween(oAlly,GlobalMeleeTarget);
            if(iAllyRange>GlobalRangeToMeleeTarget+f3)
            {
                oAllyEnemy=GetLocalObject(oAlly,ARRAY_ENEMY_RANGE_SEEN+IntToString(i1));
                if(!GetIsObjectValid(oAllyEnemy) || (GetIsObjectValid(oAllyEnemy) && GetDistanceBetween(oAlly,oAllyEnemy)>f5))
                    break;
            }
            oAlly=GetLocalObject(OBJECT_SELF,ARRAY_ALLIES_RANGE+IntToString(++iCnt));
        }
        // melee target don't have true seeing.
        if(GetHasFeat(FEAT_HIDE_IN_PLAIN_SIGHT) && !AI_GetAIHaveEffect(GlobalEffectTrueSeeing, GlobalMeleeTarget))
        {
            SetActionMode(OBJECT_SELF, ACTION_MODE_STEALTH, TRUE);
            // ranged weapon. move away.
            if(GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND)) && !GlobalIamBlockedByObject  && GlobalRangeToMeleeTarget<f5 && d6()!=i1)
            {
                AI_AntiCornerMoveAway(GlobalMeleeTarget,FALSE,f5,GlobalIamBlocked);
                DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
        ...
        // enemy has true seeing, RUN!!
        // INTELLIGENCE check
        else if(!GlobalIamBlockedByObject && GlobalRangeToMeleeTarget<f5 && d6()!=i1)
            // if(GetAbilityScore(OBJECT_SELF,ABILITY_INTELLIGENCE)>i10+d6())
        {
            SetActionMode(OBJECT_SELF, ACTION_MODE_STEALTH, FALSE);
            if(GetIsObjectValid(oAlly))
            {
                vector vTo;
                vTo=GetPosition(oAlly)-GetPosition(OBJECT_SELF);
                vTo=VectorNormalize(vTo);
                vTo*=(iAllyRange+f5);
                //run to ally
                ActionMoveToLocation(Location(GetArea(OBJECT_SELF),vTo,VectorToAngle(vTo)),TRUE);
                DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
            }
            else
            {
                //run away
                AI_AntiCornerMoveAway(GlobalMeleeTarget,TRUE,f5,GlobalIamBlocked);
                DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
            }
            return TRUE;
        }
    }
    else if(AI_GetIsArcaneCaster(OBJECT_SELF) && GlobalTotalAllies>i0 && AI_GetIsMustDispelMeleeTarget(OBJECT_SELF)!=i2 &&
        GlobalEnemiesIn4Meters && !GetWeaponRanged(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND,GlobalMeleeTarget)) &&
        !AI_GetAIHaveEffect(GlobalEffectPolymorph) && !AI_GetAIHaveEffect(GlobalEffectTensersTransformation) &&
        GlobalMeleeTargetBestAttackBonus+i20>=GlobalOurAC)
    {
        // ally check
        // there a ally who is little away from enemy
        oAlly=GetLocalObject(OBJECT_SELF,ARRAY_ALLIES_RANGE+IntToString(iCnt));
        ...
        if(!GlobalIamBlockedByObject && GlobalRangeToMeleeTarget<f5 && d6()!=i1)
            // if(GetAbilityScore(OBJECT_SELF,ABILITY_INTELLIGENCE)>i10+d6())
        {
            SetActionMode(OBJECT_SELF, ACTION_MODE_STEALTH, FALSE);
            if(GetIsObjectValid(oAlly))
            ...
            {
                //run away
                AI_AntiCornerMoveAway(GlobalMeleeTarget,TRUE,f8,GlobalIamBlocked);
                DelayCommand(GlobalDelayTime,DetermineCombatRound(GlobalMeleeTarget));
            }
            return TRUE;
        }
...
int AI_AttemptCounterSpell()
{
    ...
    (GlobalTotalAllies <= i4 || GlobalTotalSeenHeardEnemies>GlobalTotalAllies))
    {
    return FALSE;
    }*/
    // Check if valid
    if(GlobalInTimeStop || !GetIsObjectValid(GlobalCounterSpellTarget) || GetSkillRank(SKILL_SPELLCRAFT)<i24)return FALSE;

    int iAction=GetCurrentAction(GlobalCounterSpellTarget);
    if(!(iAction==ACTION_INVALID || iAction==ACTION_CASTSPELL))return FALSE;

    if(GetSpawnInCondition(AI_FLAG_COMBAT_COUNTER_SPELL_ONLY_IN_GROUP, AI_COMBAT_MASTER) &&
        GlobalTotalSeenHeardEnemies>GlobalTotalAllies+i1)
    {
        return FALSE;
    }

    if(d100()>AI_GetCounterSpellPossibility(GlobalCounterSpellTarget))
    {
        return FALSE;
    }

    // 45: "[DCR:CounterSpell] Counterspelling. [Target] " + GetName(oCounterspellTarget)
    DebugActionSpeakByInt(45, GlobalCounterSpellTarget);
    AI_SetMeleeMode(ACTION_MODE_COUNTERSPELL);
    ActionCounterSpell(GlobalCounterSpellTarget);

    SetLocalObject(GlobalCounterSpellTarget,AI_COUNTERSPELL_USER,OBJECT_SELF);
    DelayCommand(AI_GetAIHaveEffect(GlobalEffectHaste)?2.5:5.5,DeleteLocalObject(GlobalCounterSpellTarget,AI_COUNTERSPELL_USER));
...
int AI_AttemptCastAOESpell(int nSpell, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE)
{
    if(GlobalLocationTargetFail)
    {
        return AI_AttemptCastAOESpellToObject(nSpell, nTalent, iItemTalentValue, fRange, fSpread, nLevel, iSaveType, nShape, nFriendlyFire, iDamageSpell, iNecromanticSpell, iDeathImmune, iNegativeImmune, iMindImmune, iMindType);
    }
    else
    {
        // false in last checking loop, don't check again.
        if(GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(nSpell))) return FALSE;

        // 1. We need nTalent to be over 0. -1 means an invalid spell for that talent,
        // IE no spell for that talent
        // - If iRequirement is 0, we consider it innate and no talent category for some
        //   reason.
        if(((nTalent > i0 || !nLevel || (nLevel && GlobalSpellAbilityModifier >= nLevel+i10)) && !GlobalSilenceSoItems && GetHasSpell(nSpell))
            || iItemTalentValue == nSpell)
        {
            switch(AI_GetBestAreaSpellTargetAndLocation(fRange, fSpread, nLevel, iSaveType, nShape, nFriendlyFire, iDamageSpell, iNecromanticSpell, iDeathImmune, iNegativeImmune, iMindImmune, iMindType))
            {
            case i0:
                SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(nSpell),TRUE);
                DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(nSpell)));
                return FALSE;
                break;
            case i1:
                //                ActionCastSpellAtLocation(nSpell,GlobalAOETargetLocation);
                if(AI_ActionCastSpellAtLocation(nSpell, nTalent, GlobalAOETargetLocation, (!nLevel)?i0:nLevel+i10, iItemTalentValue))
                {
                    SetAIInteger(AI_LAST_CASTED_AOE_SPELL,nSpell);
                    SetAIInteger(AI_LAST_CASTED_AOE_SPELL_NUM,GetHasSpell(nSpell));
                    return TRUE;
                }
                break;
            case i2:
                //                ActionCastSpellAtObject(nSpell,GlobalAOETargetObject);
                if(AI_ActionCastSpell(nSpell, nTalent, GlobalAOETargetObject, (!nLevel)?i0:nLevel+i10, FALSE, iItemTalentValue)) return TRUE;
                break;
            }
        }
    }
...
int AI_AttemptCastAOESpellRandom(int nSpell, int nRandom, int nTalent = i0, int iItemTalentValue = iM1, float fRange = fLongRange, float fSpread = RADIUS_SIZE_COLOSSAL, int nLevel = FALSE, int iSaveType = FALSE,int nShape = SHAPE_SPHERE, int nFriendlyFire = FALSE,int iDamageSpell = FALSE, int iNecromanticSpell = FALSE, int iDeathImmune = FALSE, int iNegativeImmune = FALSE, int iMindImmune = FALSE, int iMindType = FALSE)
{
    if(d100()<=nRandom)
    {
        return AI_AttemptCastAOESpell(nSpell, nTalent, iItemTalentValue, fRange, fSpread, nLevel, iSaveType, nShape, nFriendlyFire, iDamageSpell, iNecromanticSpell, iDeathImmune, iNegativeImmune, iMindImmune, iMindType);
    }
    return FALSE;
}
// attempt AOE spell wrapper, random version. + object only version.
...
// attempt instant death spells, or relate ability.
int AI_AttemptDeathSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    // deadmagic zone?
    if(GlobalSpellFailure)return FALSE;

    // if(AI_GetSpellTargetImmunity(GlobalImmunityDeath) || GlobalImmunityDeathPercent>75)
    // return FALSE;
    if(GlobalTotalAllies<=i8)
    {
        if(GlobalNormalSpellsNoEffectLevel>i5 || d2()==i1)
        {
            if(AI_AttemptDeathAbility(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;;
            if(AI_AttemptDeathSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
        }
        else
        {
            if(AI_AttemptDeathSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
...
int AI_AttemptDeathSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    // spell resistance.
    if(iPriority>i5-GlobalNormalSpellsNoEffectLevel/i2)return FALSE;
    ...
    case i0:
        //    if(iPriority==0)
        if(GlobalNormalSpellsNoEffectLevel < i9 &&// PW kill is level 9
            ...
            !AI_CompareTimeStopStored(SPELL_CLOUDKILL, SPELL_POWER_WORD_KILL, SPELL_CIRCLE_OF_DEATH))
        {
            ...
            if(GetSpawnInCondition(AI_FLAG_COMBAT_IMPROVED_INSTANT_DEATH_SPELLS, AI_COMBAT_MASTER))
            {
                ...
                if(SpellHostAreaInd && InputRangeLongValid && (GlobalAverageEnemyHD < i4) ||
                    ((GlobalAverageEnemyHD < i7) && (d10() < i4)) &&
                    GlobalNormalSpellsNoEffectLevel < i5)
                {
                    // Cloud Kill. Level 5 (Mage). Kills if under level 7, else acid damage.
                    if(AI_AttemptCastAOESpell(SPELL_CLOUDKILL, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_HUGE, i5, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire, TRUE, FALSE, TRUE))
                        return TRUE;
                    else
                ...
                if(SpellHostAreaInd && InputRangeShortValid && GlobalSpellTargetCurrentHitPoints < i100 && !AI_GetSpellTargetImmunity(GlobalImmunityDeath))
                {
            ...
            // Meduim ranged spell.
            if(SpellHostAreaDis && InputRangeMediumValid && GlobalAverageEnemyHD <= i9 &&
                GlobalNormalSpellsNoEffectLevel < i6)
            {
                ...
                if(AI_AttemptCastAOESpell(SPELL_CIRCLE_OF_DEATH, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_LARGE, i6, SHAPE_SPHERE, GlobalFriendlyFire, TRUE, TRUE, TRUE))
                    return TRUE;
            }
        }
        ...
        if(SpellHostAreaDis && GlobalSpellTargetRace == RACIAL_TYPE_UNDEAD &&
            GlobalIntelligence >= i5 && GlobalNormalSpellsNoEffectLevel < i8)
        {
            ...
            if(GlobalNormalSpellsNoEffectLevel < i6 &&
                InputRangeMediumValid)
            {
                // Undead to Death. Level 6 (Cleric) Slays 1d4HD worth of undead/level. (Max 20d4). Lowest first.
                if(AI_ActionCastSpell(SPELL_UNDEATH_TO_DEATH, SpellHostAreaDis, GlobalSpellTarget, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i6,SAVING_THROW_WILL), TRUE, ItemHostAreaDis)) return TRUE;
            }
        }

        if(SpellHostAreaDis && InputRangeMediumValid &&
            (GetHasSpell(SPELL_WORD_OF_FAITH) || ItemHostAreaDis == SPELL_WORD_OF_FAITH)
            //modified magic. effect only lower HD creature.
            && GetLevelByClass(CLASS_TYPE_CLERIC)>=GetHitDice(GlobalSpellTarget))
        {
            GlobalPreventSpellDupleUse=TRUE;
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_WORD_OF_FAITH, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_COLOSSAL, i7, SAVING_THROW_ALL, SHAPE_SPHERE, GlobalFriendlySelectiveHostile))return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        if(InputRangeShortValid)
        {
            // Implosion - great spell! Instant death on a +3 save (!). Short range.
            if(SpellHostAreaInd && (GetHasSpell(SPELL_IMPLOSION) || ItemHostAreaInd == SPELL_IMPLOSION))
            {
                ...
                if(AI_AttemptCastAOESpellRandom(SPELL_IMPLOSION, i60, SpellHostAreaInd, ItemHostAreaInd, fShortRange, RADIUS_SIZE_MEDIUM, i9, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            }
            // Wail of the Banshee
            // Fort save, else death, and it never affects us, but can kill allies.
            if(SpellHostAreaDis && (GetHasSpell(SPELL_WAIL_OF_THE_BANSHEE) || ItemHostAreaDis == SPELL_WAIL_OF_THE_BANSHEE))
            {
                ...
                if(AI_AttemptCastAOESpellRandom(SPELL_WAIL_OF_THE_BANSHEE, i60, SpellHostAreaDis, ItemHostAreaDis, fShortRange, RADIUS_SIZE_COLOSSAL, i9, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, TRUE, TRUE)) return TRUE;
            }
            ...
            if(SpellHostAreaDis && (GetHasSpell(SPELL_WEIRD) || ItemHostAreaDis == SPELL_WEIRD))
            {
                ...
                if(AI_AttemptCastAOESpellRandom(SPELL_WEIRD, i60, SpellHostAreaDis, ItemHostAreaDis, fShortRange, RADIUS_SIZE_COLOSSAL, i9, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_FEAR)) return TRUE;
            }
        }
    ...
    case i1:
        ...
        if(SpellHostRanged && GlobalNormalSpellsNoEffectLevel < i7 &&
            //               GetSpawnInCondition(AI_FLAG_COMBAT_IMPROVED_INSTANT_DEATH_SPELLS, AI_COMBAT_MASTER) &&
            GlobalSeenSpell && InputRangeShortValid &&
            !AI_CompareTimeStopStored(SPELL_DESTRUCTION, SPELL_FINGER_OF_DEATH))
        {
            ...
            if(//(GlobalSpellTargetFort + i20) <= (GlobalSpellBaseSaveDC + i7) &&
                d100()<=AI_GetPercentageDC(GlobalSpellBaseSaveDC + i7, SAVING_THROW_FORT) &&
        ...
        if(InputRangeTouchValid && SpellHostRanged)
        {
            // Slay living. 60% chance to cast - it is a touch spell.
            if(GlobalNormalSpellsNoEffectLevel < i5 && !AI_CompareTimeStopStored(SPELL_SLAY_LIVING) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityDeath) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy))
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i5))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_SLAY_LIVING, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC + i5,SAVING_THROW_FORT), GlobalSpellTarget, i15, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    case i2:
        if(iPriority<i2) return FALSE;
        ...
        if(SpellHostAreaInd && InputRangeMediumValid &&
            ...
            (GetHasSpell(SPELL_PRISMATIC_SPRAY) || ItemHostAreaInd == SPELL_PRISMATIC_SPRAY))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_PRISMATIC_SPRAY, i60, SpellHostAreaInd, ItemHostAreaInd, f11, f11, i7, FALSE, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            // Is it valid? 40% chance of casting.
            //            if(AI_ActionCastSpellRandom(SPELL_PRISMATIC_SPRAY, SpellHostAreaInd, i40, GlobalSpellTarget, i17, FALSE, ItemHostAreaInd)) return TRUE;
        }
        if(InputRangeMediumValid && SpellHostRanged && GlobalNormalSpellsNoEffectLevel < i4)
            ...
            //           !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i4))
        {
            ...
            if(!AI_CompareTimeStopStored(SPELL_PHANTASMAL_KILLER) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityFear) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityMind))
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i4))
            {
                // Phantasmal Killer. Level 4 (Mage). Will save (Illusion) then fort save, or death.
                if(AI_ActionCastSpellRandom(SPELL_PHANTASMAL_KILLER, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC + i4,SAVING_THROW_FORT), GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    }
...
int AI_AttemptDeathAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    case i0:
        ...
        if(!AI_GetSpellTargetImmunity(GlobalImmunityDeath))
        {
            // Pulse_Death - Large. Death if fail Fort Save, DC: 10 + HD
            if(InputRangeShortValid && SpellHostAreaInd && !GlobalInTimeStop &&
                GlobalSpellTargetRange < fTouchRange &&
                d100()<AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))
            {
                if(AI_ActionCastSpell(SPELLABILITY_PULSE_DEATH)) return TRUE;
            }
            // bolt, all touch no save.
            if(GlobalSeenSpell && SpellHostRanged && InputRangeMediumValid)
            {
                if(AI_ActionCastSpell(SPELLABILITY_BOLT_DEATH, SpellHostRanged, GlobalSpellTarget)) return TRUE;
            }
            // Gazes have short ranges.
            // Why this high? (compared to say, fire storm?) because they are innate
            // and so no concentration checks, and pretty good DC's.
            // dc 10+hd/2 will save.
            if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
            {
                // 50% chance of either.
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DEATH, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                // Destroy X are powerful. 50% chance each. They are basically as DEATH but for alignments.
                if(GetAlignmentGoodEvil(GlobalSpellTarget) == ALIGNMENT_GOOD)
                {
                    if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DESTROY_GOOD, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                }
                else if(GetAlignmentGoodEvil(GlobalSpellTarget) == ALIGNMENT_EVIL)
                {
                    if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DESTROY_EVIL, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                }
                if(GetAlignmentLawChaos(GlobalSpellTarget) == ALIGNMENT_CHAOTIC)
                {
                    if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DESTROY_CHAOS, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                }
                else if(GetAlignmentLawChaos(GlobalSpellTarget) == ALIGNMENT_LAWFUL)
                {
                    if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DESTROY_LAW, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                }
            }
            break;
        }
    case i1:
        ...
        if(InputRangeTouchValid)
        {
            ...
            if(GetCreatureSize(GlobalSpellTarget) <= CREATURE_SIZE_LARGE &&
                !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
                // Fort save DC 17
                d100()<AI_GetPercentageDC(i17+((GetLevelByClass(CLASS_TYPE_PALEMASTER)-i10<i0)?i0:GetLevelByClass(CLASS_TYPE_PALEMASTER)-i10)/i2,SAVING_THROW_FORT))
            ...
            // Pulse_Drown - None Constructs, Undeads, Elementals DIE if fail a fort check, DC: 20.
            if(!GlobalInTimeStop &&
                GlobalSpellTargetRange < fTouchRange &&
                d100()<AI_GetPercentageDC(i20,SAVING_THROW_FORT))
            {
                // All innate, so no matter about talents really.
                if(AI_ActionCastSpell(SPELLABILITY_PULSE_DROWN)) return TRUE;
            }
        }

        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
        {
            // Death gazes first - Golem one is the most deadly! -- deadly? dc 17?
            if(AI_ActionCastSpellRandom(SPELLABILITY_GOLEM_BREATH_GAS, FALSE, AI_GetPercentageDC(i17,SAVING_THROW_FORT), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
        }

        if(InputRangeTouchValid && GlobalSeenSpell)
        {
            // howl of death, dc 10+hd/4.
            if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_DEATH, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
        }
        break;
    }
    return FALSE;
...
int AI_AttemptMindSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    //    if(AI_GetSpellTargetImmunity(GlobalImmunityMind) || GlobalImmunityMindPercent>75)
    //    return FALSE;
    if(GlobalTotalAllies<=i8)
    {
        if(GlobalNormalSpellsNoEffectLevel>i5 || d2()==i1)
        {
            if(AI_AttemptMindAbility(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;;
            if(AI_AttemptMindSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
        }
        else
        {
            if(AI_AttemptMindSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
...
int AI_AttemptMindSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    case i0:
        ...
        if(GlobalSpellTargetCurrentHitPoints <= i150 &&
            ...
            //           GlobalTotalSeenHeardEnemies < i3 &&
            GlobalAverageEnemyHD > i10 &&
            GlobalSeenSpell && InputRangeTouchValid &&
        ...
        if(!GlobalInTimeStop && GlobalSeenSpell && InputRangeMediumValid &&
            !AI_GetSpellTargetImmunity(GlobalImmunityMind) &&
            !AI_GetSpellTargetImmunity(GlobalImmunityDomination) &&
            (GlobalOurHitDice - GlobalAverageEnemyHD) <= i8)
        {
                ...
                !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i9))
            {
                ...
                if(!GlobalWeAreSorcerorBard)
                {
                    ...
                    if(AI_AttemptCastAOESpellRandom(SPELL_MASS_CHARM, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_LARGE, i8, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_CHARM)) return TRUE;
            ...
            GlobalIntelligence >= i5 && GlobalNormalSpellsNoEffectLevel < i8)
        {
                ...
                !GetIsObjectValid(GetAssociate(ASSOCIATE_TYPE_DOMINATED)))
            {
                ...
                if(AI_ActionCastSpell(SPELL_CONTROL_UNDEAD, SpellHostRanged, GlobalSpellTarget, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i7,SAVING_THROW_WILL), FALSE, ItemHostRanged)) return TRUE;
            }
        }

        // AOE targets. Most...but not all...are short-range spells.
        if(InputRangeMediumValid) // No GlobalNormalSpellsNoEffectLevel for this. AOE spells may affect someone who is not immune!
        {
            ...
            {
                if(AI_ActionCastSpellRandom(SPELL_STORM_OF_VENGEANCE, SpellHostAreaDis, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i9,SAVING_THROW_REFLEX), OBJECT_SELF, i19, FALSE, ItemHostAreaDis)) return TRUE;
            }
        }
        break;
    case i1:
        ...
        {
            if(AI_AttemptCastAOESpellRandom(SPELL_CONFUSION, i80, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_LARGE, i4, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_CONFUSED)) return TRUE;
        }
        // Fear - fear!
        if(SpellHostAreaDis && InputRangeMediumValid &&
            (GetHasSpell(SPELL_FEAR) || ItemHostAreaDis == SPELL_FEAR))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_FEAR, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_LARGE, i4, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_CONFUSED)) return TRUE;
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i4)
        {
            ...
            if(GlobalSpellTargetRange <= RADIUS_SIZE_COLOSSAL)
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_WAR_CRY, SpellHostAreaDis, i30, OBJECT_SELF, i14, FALSE, ItemHostAreaDis)) return TRUE;
            }
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i5)
        {
            ...
            if(InputRangeMediumValid && !AI_CompareTimeStopStored(SPELL_HOLD_MONSTER) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityMind) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityStun))
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i5))
            {
                // Hold monster - Paralyze's an enemy monster (any race)
                if(AI_ActionCastSpellRandom(SPELL_HOLD_MONSTER, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i5,SAVING_THROW_WILL), GlobalSpellTarget, i15, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        // Dominate spells
        if(!GlobalInTimeStop && GlobalSeenSpell && InputRangeMediumValid &&
            ...
            //           (GlobalOurHitDice - GlobalAverageEnemyHD) <= i8)
        {
                ...
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i5))
            {
                ...
                if(!GetIsPlayableRacialType(GlobalSpellTarget))
                {
                    ...
                    if(AI_ActionCastSpell(SPELL_DOMINATE_PERSON, SpellHostRanged, GlobalSpellTarget, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i5,SAVING_THROW_WILL), FALSE, ItemHostRanged)) return TRUE;
                }
            }
        }
        ...
        if(GlobalSeenSpell && GlobalNormalSpellsNoEffectLevel < i4)
        {
            ...
            if(InputRangeMediumValid &&
                !AI_GetSpellTargetImmunity(GlobalImmunityMind) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityDomination))
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i4))
            {
                // Charm Monster. Level 4 (mage) 3 (Bard). Charm any monster, will save to resist.
                if(AI_ActionCastSpellRandom(SPELL_CHARM_MONSTER, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i4,SAVING_THROW_WILL), GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
            }
        }
            ...
            (GetHasSpell(SPELL_HAMMER_OF_THE_GODS) || ItemHostAreaDis == SPELL_HAMMER_OF_THE_GODS))
        {
            ...
            // Shpere, no friends affected, we cast even if saves VS will. :-)
            if(AI_AttemptCastAOESpellRandom(SPELL_HAMMER_OF_THE_GODS, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_HUGE, i4, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlySelectiveHostile, TRUE)) return TRUE;
        }

        if(GlobalNormalSpellsNoEffectLevel < i3 &&  InputRangeMediumValid)
        {
                ...
                //                  !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i3))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_HOLD_PERSON, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i3,SAVING_THROW_WILL), GlobalSpellTarget, i13, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    case i2:
        ...
        if(GlobalNormalSpellsNoEffectLevel < i5 &&  InputRangeLongValid)
        {
            if(AI_AttemptCastAOESpellRandom(SPELL_MIND_FOG, i60, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_COLOSSAL, i5, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE)) return TRUE;
        }

        break;
    case i3:
        //    if(iPriority<i3) return FALSE;
            ...
            (GetHasSpell(SPELL_STINKING_CLOUD) || ItemHostAreaInd == SPELL_STINKING_CLOUD))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_STINKING_CLOUD, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_LARGE, i3, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE)) return TRUE;
        }

        // Sound burst - best part is the stun! Trust me!  Long range too!
        if(SpellHostAreaInd && InputRangeLongValid &&
            (GetHasSpell(SPELL_SOUND_BURST) || ItemHostAreaInd == SPELL_SOUND_BURST))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_SOUND_BURST, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_MEDIUM, i2, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }

        if(GlobalNormalSpellsNoEffectLevel < i2)
        {
            // Ghoul Touch. Paralysis is good :-D
            if(InputRangeTouchValid && !AI_GetSpellTargetImmunity(GlobalImmunityMind) && !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy))
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i2))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_GHOUL_TOUCH, SpellHostTouch, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_FORT), GlobalSpellTarget, i12, FALSE, ItemHostTouch)) return TRUE;
            }
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i3 &&  InputRangeMediumValid)
        {
                ...
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i3))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_DOMINATE_ANIMAL, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i3,SAVING_THROW_WILL), GlobalSpellTarget, i13, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    case i4:
        //    if(iPriority<i4) return FALSE;

        // Color Spray - Does at least blind higher levels. Will save, however, negates
        if(SpellHostAreaInd && InputRangeShortValid &&
            (GetHasSpell(SPELL_COLOR_SPRAY) || ItemHostAreaInd == SPELL_COLOR_SPRAY))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_COLOR_SPRAY, i60, SpellHostAreaInd, ItemHostAreaInd, fShortRange, f10, i1, SAVING_THROW_WILL, SHAPE_SPELLCONE, GlobalFriendlyFire)) return TRUE;
            //            if(AI_ActionCastSpellRandom(SPELL_COLOR_SPRAY, SpellHostAreaInd, i50, GlobalSpellTarget, i11, FALSE, ItemHostAreaInd)) return TRUE;
        }

        if(InputRangeShortValid)
        {
            // Charm Person or Animal. Charms an animal, or humanoid, if fail mind will save.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDomination) && !AI_GetSpellTargetImmunity(GlobalImmunityMind) &&
                ...
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i2))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_CHARM_PERSON_OR_ANIMAL, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_WILL), GlobalSpellTarget, i12, FALSE, ItemHostRanged)) return TRUE;
            }
        }

        // Sleep - 8HD or less average HD for enemy to target this.
        if( InputRangeMediumValid && GlobalAverageEnemyHD <= i8 &&
            (GetHasSpell(SPELL_SLEEP) || GetHasFeat(FEAT_HARPER_SLEEP) || ItemHostAreaInd == SPELL_SLEEP))
        {
            // false in last checking loop, don't check again.
            if(!(GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SLEEP)) ||
                GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(FEAT_HARPER_SLEEP))))
            {
                object oAOE;
                // Huge AOE, medium ranged, will based save. Reaction type enemy
                oAOE = AI_GetBestAreaSpellTarget(fMediumRange, RADIUS_SIZE_HUGE, i1, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire);
                ...
                if(GetIsObjectValid(oAOE))
                {
                    ...
                    if(AI_ActionCastSpellRandom(SPELL_SLEEP, SpellHostAreaInd, i50, oAOE, i11, FALSE, ItemHostAreaInd)) return TRUE;
                }
                else
                {
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SLEEP),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SLEEP)));
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(FEAT_HARPER_SLEEP),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(FEAT_HARPER_SLEEP)));
                }
            }
        }
        ...
        if(InputRangeShortValid)
        {
                ...
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i1))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_SCARE, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i1,SAVING_THROW_WILL), GlobalSpellTarget, i11, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i1 && GlobalSeenSpell)
        {
                ...
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i0))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_DAZE, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC,SAVING_THROW_WILL), GlobalSpellTarget, i10, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    }
...
int AI_AttemptMindAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    {
    case i0:
        if(AI_GetSpellTargetImmunity(GlobalImmunityMind)) return FALSE;
        // Bolts 80% chance. Not too good, but oh well.
        if(GlobalSeenSpell && InputRangeMediumValid)
        {
            // And the damaging bolts/status affecting bolts.
            // I really can't be bothered to add in a lot of checks for immunities.
            // Might do later.
            // bolt, ranged touch attack with no save.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_PARALYZE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_STUN, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDomination) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_DOMINATE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityConfusion) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_CONFUSE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDomination) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_CHARM, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_DAZE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
        }
        ...
        if(InputRangeTouchValid && GlobalSeenSpell)
        {
            // mind blast '10, dc 10+hd/2+wismod
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_MINDFLAYER_MINDBLAST_10, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i2+GetAbilityModifier(ABILITY_WISDOM),SAVING_THROW_WILL))) return TRUE;
        }

        if(InputRangeTouchValid)
        {
            // Undead graft paralyzes!
            if(!GetIsImmune(GlobalSpellTarget,IMMUNITY_TYPE_MIND_SPELLS) &&
                !GetIsImmune(GlobalSpellTarget,IMMUNITY_TYPE_PARALYSIS) &&
                !AI_GetAIHaveEffect(GlobalEffectParalyze,GlobalSpellTarget) &&
                !AI_GetAIHaveEffect(GlobalEffectUncommandable,GlobalSpellTarget) &&
                GlobalSpellTargetRace !=  RACIAL_TYPE_ELF &&
                // Fort save - 14 + Palemaster levels / 2
                d100()<AI_GetPercentageDC(i14 + GetLevelByClass(CLASS_TYPE_PALEMASTER)/i2,SAVING_THROW_FORT))
    ...
    case i1:
        ...
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_PARALYSIS, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_STUNNED, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
            if(!AI_GetSpellTargetImmunity(GlobalImmunityFear))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_FEAR, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDomination))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DOMINATE, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_CHARM, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
            if(!AI_GetSpellTargetImmunity(GlobalImmunityConfusion))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_CONFUSION, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
        }
    ...
    case i3:
        if(AI_GetSpellTargetImmunity(GlobalImmunityMind)) return FALSE;
        // Medium range spells.
        if((InputRangeMediumValid || InputRangeShortValid) && GlobalSeenSpell)
        {
            // Paralisis and daze (mind effects, and stunning ones)
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun))
            {
                // Mind blast(dc19)
                if(AI_ActionCastSpellRandom(AI_SPELLABILITY_ILLITHID_MINDBLAST, SpellHostAreaInd, AI_GetPercentageDC(i19,SAVING_THROW_WILL),GlobalSpellTarget)) return TRUE;
                // Mind blast(dc17)
                if(AI_ActionCastSpellRandom(SPELLABILITY_MINDBLAST, SpellHostAreaInd, AI_GetPercentageDC(i17,SAVING_THROW_WILL),GlobalSpellTarget)) return TRUE;
                // Other one(dc?)
                //            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_MINDFLAYER_PARAGON_MINDBLAST, SpellHostAreaInd, i20,GlobalSpellTarget)) return TRUE;
            }
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDomination))
            {
                // psionic charm(dc17)
                if(AI_ActionCastSpellRandom(SPELLABILITY_CHARMMONSTER, SpellHostRanged, AI_GetPercentageDC(i17,SAVING_THROW_WILL),GlobalSpellTarget)) return TRUE;
            }
            // beholder ray, dc 15.
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_BEHOLDER_ALLRAYS, SpellHostAreaInd, AI_GetPercentageDC(i15,SAVING_THROW_WILL),GlobalSpellTarget)) return TRUE;
        }
    ...
    case i4:
        ...
        if(InputRangeTouchValid && GlobalSeenSpell)
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityFear))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_FEAR, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
            }
            // Paralisis and daze (mind effects, and stunning ones)
            if(!AI_GetSpellTargetImmunity(GlobalImmunityStun))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_PARALYSIS, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_STUN, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_DAZE, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
            }
            if(!AI_GetSpellTargetImmunity(GlobalImmunityConfusion))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_CONFUSE, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
            }
        }
        break;
    case i5:
        ...
        if(InputRangeTouchValid && GlobalSeenSpell)
        {
            ...
            {
                // Harpy song.
                if(AI_ActionCastSpellRandom(AI_SPELLABILITY_HARPYSONG, SpellHostAreaInd, AI_GetPercentageDC(i15,SAVING_THROW_WILL))) return TRUE;
            }
        }
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityFear))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_KRENSHAR_SCARE, FALSE, AI_GetPercentageDC(i12,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
        }
        break;
    }
...
int AI_AttemptEffectSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    if(GlobalTotalAllies<=i8)
    {
        if(GlobalNormalSpellsNoEffectLevel>i5 || d2()==i1)
        {
            if(AI_AttemptEffectAbility(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;;
            if(AI_AttemptEffectSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
        }
        else
        {
            if(AI_AttemptEffectSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
...
int AI_AttemptEffectSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    {
    case i0:
        //    if(iPriority<i0) return FALSE;

        if(InputRangeMediumValid && GlobalNormalSpellsNoEffectLevel < i8 &&
            !AI_GetSpellTargetImmunity(GlobalImmunityBlindDeaf) &&
            !GlobalWeAreSorcerorBard)
            //          !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i8))
        {
            if(AI_AttemptCastAOESpellRandom(SPELL_MASS_BLINDNESS_AND_DEAFNESS, i80, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_MEDIUM, i8, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            // Mass Blindness and Deafness. Level 8 (Mage) AOE fort save, enemies only, who save or are blinded and deafened.
            //            if(AI_ActionCastSpell(SPELL_MASS_BLINDNESS_AND_DEAFNESS, SpellHostAreaDis, GlobalSpellTarget, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i8,SAVING_THROW_FORT), TRUE, ItemHostAreaDis)) return TRUE;
        }
        ...
        // why? blind is good effect.
        if(InputRangeLongValid &&
            (GetHasSpell(SPELL_SUNBURST) || ItemHostAreaDis == SPELL_SUNBURST))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_SUNBURST, i60, SpellHostAreaDis, ItemHostAreaDis, fLongRange, RADIUS_SIZE_COLOSSAL, i8, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlySelectiveHostile, TRUE)) return TRUE;
        }
        if(InputRangeLongValid &&
            (GetHasSpell(SPELL_SUNBEAM) || ItemHostAreaDis == SPELL_SUNBEAM))
        {
            // 40M range, lagre (5.0 across) area. Relfex saves.
            // Sunbeam. Level 8 (Cleric/Druid) 3d6 to non-undead. Blindness. Limit of 20 dice for undead damage. Medium range/colosal size
            if(AI_AttemptCastAOESpellRandom(SPELL_SUNBEAM, i60, SpellHostAreaDis, ItemHostAreaDis, fLongRange, RADIUS_SIZE_COLOSSAL, i8, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_GREAT_THUNDERCLAP) || ItemHostAreaInd == SPELL_GREAT_THUNDERCLAP))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_GREAT_THUNDERCLAP, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_GARGANTUAN, i7, SAVING_THROW_ALL, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }

        // bigby...
        if(InputRangeLongValid && !AI_GetIsBigbyOn(GlobalSpellTarget))
        {
            if(GlobalNormalSpellsNoEffectLevel < i9 && !AI_CompareTimeStopStored(SPELL_BIGBYS_CRUSHING_HAND,SPELL_BIGBYS_CLENCHED_FIST,SPELL_BIGBYS_GRASPING_HAND,SPELL_BIGBYS_FORCEFUL_HAND))
            {
                //modified magic. ignore stun.
                // Bigby's Crushing Hand. Level 9 (Mage). 2d6 + 12 damage/round.
                if(AI_ActionCastSpellRandom(SPELL_BIGBYS_CRUSHING_HAND, SpellHostRanged, i80, GlobalSpellTarget, i19, FALSE, ItemHostRanged)) return TRUE;
            }
            if(GlobalNormalSpellsNoEffectLevel < i8 && !AI_CompareTimeStopStored(SPELL_BIGBYS_CRUSHING_HAND,SPELL_BIGBYS_CLENCHED_FIST,SPELL_BIGBYS_GRASPING_HAND,SPELL_BIGBYS_FORCEFUL_HAND))
            {
                //modified magic.
            ...
            if(GlobalNormalSpellsNoEffectLevel < i7 && !AI_CompareTimeStopStored(SPELL_BIGBYS_CRUSHING_HAND,SPELL_BIGBYS_CLENCHED_FIST,SPELL_BIGBYS_GRASPING_HAND,SPELL_BIGBYS_FORCEFUL_HAND))
                //modified magic. ignore stun.
                //           !AI_GetSpellTargetImmunity(GlobalImmunityStun))
            {
                // Bigby's Grasping Hand. Level 7 (Mage) Hold target if sucessful grapple
                if(AI_ActionCastSpellRandom(SPELL_BIGBYS_GRASPING_HAND, SpellHostRanged, i60, GlobalSpellTarget, i18, FALSE, ItemHostRanged)) return TRUE;
            }
            if(GlobalNormalSpellsNoEffectLevel < i6 && !AI_CompareTimeStopStored(SPELL_BIGBYS_CRUSHING_HAND,SPELL_BIGBYS_CLENCHED_FIST,SPELL_BIGBYS_GRASPING_HAND,SPELL_BIGBYS_FORCEFUL_HAND))
                //modified magic. ignore stun.
                //           !AI_GetSpellTargetImmunity(GlobalImmunityStun))
            {
                // Bigby's Forceful Hand. Level 6 (Mage) Bullrush to make the target Knockdowned and Dazed all in one.
                if(AI_ActionCastSpellRandom(SPELL_BIGBYS_FORCEFUL_HAND, SpellHostRanged, i60, GlobalSpellTarget, i16, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        // Dirge.
        // - Cast always, basically. Boring :-) but its an OK spell
        if(!GetHasSpellEffect(SPELL_DIRGE))
        {
        ...
        if(GlobalNormalSpellsNoEffectLevel < i9)
        {
            if(InputRangeShortValid && GlobalSpellTargetRace != RACIAL_TYPE_UNDEAD &&
                !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy))
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i9))
            {
                ...
                //modified magic. no save, ranged touch attack
        ...
        if(GlobalNormalSpellsNoEffectLevel < i6)
        {
            ...
            if(InputRangeMediumValid && !AI_CompareTimeStopStored(SPELL_FLESH_TO_STONE) &&
                ...
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i6))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_FLESH_TO_STONE, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i6,SAVING_THROW_FORT), GlobalSpellTarget, i16, FALSE, ItemHostRanged)) return TRUE;
            }
        }
    ...
    case i1:
            ...
            (GetHasSpell(SPELL_SLOW) || ItemHostAreaDis == SPELL_SLOW))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_SLOW, i60, SpellHostAreaDis, ItemHostAreaDis, fShortRange, RADIUS_SIZE_COLOSSAL, i3, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlySelectiveHostile)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        ...
        if(InputRangeLongValid && GlobalSpellTargetRange >= f10 &&
            ...
            GetLevelByClass(CLASS_TYPE_CLERIC, GlobalSpellTarget)))
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_SILENCE, SpellOtherSpell, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_WILL), GlobalSpellTarget, i12)) return TRUE;
        }
        // Feeblemind is Good if in medium range, and is a mage :-)
        if(InputRangeMediumValid && GlobalSeenSpell &&
        ...
        if(GlobalNormalSpellsNoEffectLevel < i5 && InputRangeLongValid && !AI_CompareTimeStopStored(SPELL_BIGBYS_INTERPOSING_HAND) &&
            !AI_GetIsBigbyOn(GlobalSpellTarget) &&
            GetBaseAttackBonus(GlobalSpellTarget) >= GlobalOurHitDice/i2)
        {
            ...
            if(AI_ActionCastSpell(SPELL_BIGBYS_INTERPOSING_HAND, SpellHostRanged, GlobalSpellTarget, i16, FALSE, ItemHostRanged)) return TRUE;
        }

        // Battletide is not bad. Level 5 (Cleric)
        // - Oddly classed under SpellHostAreaDis
        if(!GetHasSpellEffect(SPELL_BATTLETIDE))
        {
            // Battletide. Level 5 (Cleric). -2 Attack/Saves/damage to enemies who come in. +2 to same for caster.
            if(AI_ActionCastSpell(SPELL_BATTLETIDE, SpellHostAreaDis, OBJECT_SELF, i15, FALSE, ItemHostAreaDis)) return TRUE;
        }
        break;
    case i2:
        //    if(iPriority<i2) return FALSE;
        ...
        if(InputRangeMediumValid &&// GlobalAverageEnemyHD <= i10 &&
            (GetHasSpell(SPELL_EVARDS_BLACK_TENTACLES) || ItemHostAreaInd == SPELL_EVARDS_BLACK_TENTACLES))
        {
            // 5M sized AOE spell, medium range.
            if(AI_AttemptCastAOESpellRandom(SPELL_EVARDS_BLACK_TENTACLES, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_LARGE, i4, FALSE, SHAPE_SPHERE, GlobalFriendlyFire, TRUE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_STUN)) return TRUE;
        }

        // Enervation. 1d4 negative levels. Short range
        // modified magic. ranged touch, no save.
        if(GlobalSeenSpell && GlobalNormalSpellsNoEffectLevel < i4)
        {
            if(InputRangeMediumValid && !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityNegativeEnergy))
            {
                // Enervation. Level 4 (Mage). 1d4 negative levels, fortitude save
                if(AI_ActionCastSpell(SPELL_ENERVATION, SpellHostRanged, GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
            }


            // Contagion. Disease! Quite good, but still check spell save DC at fort above.
            // Necromancy.
            if(InputRangeTouchValid && !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityDisease))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_CONTAGION, SpellHostTouch, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i4,SAVING_THROW_FORT), GlobalSpellTarget, i14, FALSE, ItemHostTouch)) return TRUE;
            }

            // Bestow Curse - Inflicts poison (sadly, static fortitude save) Necro spell.
            if(InputRangeTouchValid && !AI_GetSpellTargetImmunity(GlobalImmunityCurse))
            {
                // Bestow Curse. Level 4 (Mage) 3 (Cleric/Bard) -2 to all stats VS Fortitude save.
                if(AI_ActionCastSpellRandom(SPELL_BESTOW_CURSE, SpellHostTouch, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i4,SAVING_THROW_FORT), GlobalSpellTarget, i14, FALSE, ItemHostTouch)) return TRUE;
            }
                ...
                !AI_GetSpellTargetImmunity(GlobalImmunityPoison))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_POISON, SpellHostRanged, AI_GetPercentageDC(i18,SAVING_THROW_FORT), GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    case i3:
            ...
            GetHasSpell(SPELL_GUST_OF_WIND) >= i2)
        {
            GlobalPreventSpellDupleUse=TRUE;
            // Allies are hit, will save to be immune.
            if(AI_AttemptCastAOESpellRandom(SPELL_GUST_OF_WIND, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_HUGE, i3, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        ...
        if(InputRangeTouchValid && !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy))
        {
            ...
            if(!GetHasSpellEffect(SPELL_INFESTATION_OF_MAGGOTS, GlobalSpellTarget))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_INFESTATION_OF_MAGGOTS, SpellHostTouch, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i3,SAVING_THROW_FORT), GlobalSpellTarget, i13, FALSE, ItemHostTouch)) return TRUE;
            }
        }
            ...
            (GetHasSpell(SPELL_SPIKE_GROWTH) || ItemHostAreaInd == SPELL_SPIKE_GROWTH))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_SPIKE_GROWTH, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_LARGE, i3, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
            ...
            (GetHasSpell(SPELL_CLOUD_OF_BEWILDERMENT) || ItemHostAreaInd == SPELL_CLOUD_OF_BEWILDERMENT))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CLOUD_OF_BEWILDERMENT, i70, SpellHostAreaInd, ItemHostAreaInd, fShortRange, RADIUS_SIZE_LARGE, i2, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, FALSE, FALSE, TRUE, IMMUNITY_TYPE_BLINDNESS)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        ...
        {
            // false in last checking loop, don't check again.
            if(!GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_GREATER_SHADOW_CONJURATION_WEB)))
            {

                object oAOE;
                // large AOE, medium ranged, reflex based save. Reaction friendly.
                oAOE = AI_GetBestAreaSpellTarget(fMediumRange, RADIUS_SIZE_LARGE, i2, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire);
                ...
                if(GetIsObjectValid(oAOE))
                {
                    ...
                    // Web. Level 2 (Mage) Entangles on reflex sve.
                    if(AI_ActionCastSpellRandom(SPELL_WEB, SpellHostAreaInd, i60, oAOE, i12, FALSE, ItemHostAreaInd)) return TRUE;
                }
                else
                {
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_GREATER_SHADOW_CONJURATION_WEB),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_GREATER_SHADOW_CONJURATION_WEB)));
                }
            }
        }
        ...
        if(InputRangeMediumValid)
        {
                ...
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i2))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_BLINDNESS_AND_DEAFNESS, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_FORT), GlobalSpellTarget, i12, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        break;
    case i4:
        ...
        if(GlobalSpellTargetRange <= f5)
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_BALAGARNSIRONHORN, SpellHostAreaDis, i60, OBJECT_SELF, i12, FALSE, ItemHostAreaDis)) return TRUE;
        }
        ...
        if(InputRangeMediumValid)
        {
            ...
            if(AI_GetIsTargetCastable(GlobalSpellTarget))
            {
                // Tasha's Hideous Laughter. Level 2 (Bard/Mage) Knockdown for 1d3 rounds, if fail will save. -4 DC if different races
                if(AI_ActionCastSpellRandom(SPELL_TASHAS_HIDEOUS_LAUGHTER, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_WILL), GlobalSpellTarget, i12, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        ...
        if(InputRangeShortValid)
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_HORIZIKAULS_BOOM, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i2,SAVING_THROW_WILL), GlobalSpellTarget, i11, FALSE, ItemHostRanged)) return TRUE;
        }
        break;
    case i5:
        //    if(iPriority<i4) return FALSE;
            ...
            (GetHasSpell(SPELL_GREASE) || ItemHostAreaInd == SPELL_GREASE))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_GREASE, i70, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_MEDIUM, i1, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
            ...
            (GetHasSpell(SPELL_ENTANGLE) || ItemHostAreaInd == SPELL_ENTANGLE))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_ENTANGLE, i60, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_HUGE, i1, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        ...
        if(InputRangeShortValid)
        {
                ...
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i1))
            {
                ...
                if(AI_ActionCastSpellRandom(SPELL_RAY_OF_ENFEEBLEMENT, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i1,SAVING_THROW_FORT), GlobalSpellTarget, i11, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        ...
        if(InputRangeMediumValid)
        {
            ...
            if(!GetHasSpellEffect(SPELL_DOOM, GlobalSpellTarget) && !AI_GetSpellTargetImmunity(GlobalImmunityCurse))
                //               !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i1))
            {
                // Doom. Level 1 (Mage) -2 Saves, Damage, to hit at a mind will save.
                if(AI_ActionCastSpellRandom(SPELL_DOOM, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i1,SAVING_THROW_WILL), GlobalSpellTarget, i11, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        // Color Spray - Does at least blind higher levels. Will save, however, negates
        if(InputRangeShortValid &&
            ...
            (GetHasSpell(SPELL_BANE) || ItemEnhSinTar == SPELL_BANE))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_BANE, i60, SpellEnhSinTar, ItemEnhSinTar, fMediumRange, RADIUS_SIZE_COLOSSAL, i1, SAVING_THROW_WILL, SHAPE_SPHERE, GlobalFriendlySelectiveHostile)) return TRUE;
            GlobalPreventSpellDupleUse=FALSE;
        }
        break;
    }
...
int AI_AttemptEffectAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    case i1:
        ...
        if(InputRangeTouchValid && !GlobalInTimeStop &&
            GlobalSpellTargetRange < fTouchRange)
        {
            // All innate, so no matter about talents really.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel))
            {
                // Pulse_Level_Drain - 1 Negative Level, if fail Fort Save, DC: 10 + HD.
                if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_LEVEL_DRAIN, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
            }
        }
        if(GlobalSeenSpell && InputRangeMediumValid && d10() <= i8)
        {
            // And the damaging bolts/status affecting bolts.
            // I really can't be bothered to add in a lot of checks for immunities.
            // Might do later.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_LEVEL_DRAIN, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunitySlow) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_SLOW, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
        }
        break;
    case i2:
            ...
            GlobalSpellTargetRange < fTouchRange)
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel))
            {
                // Pulse_Ability_Drain_Strength - Large. -(HD/5) STR, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_STRENGTH) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_STRENGTH, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
                // Pulse_Ability_Drain_Dexterity - Large. -(HD/5) DEX, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_DEXTERITY) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_DEXTERITY, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
                // Pulse_Ability_Drain_Constitution - Large. -(HD/5) CON, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_CONSTITUTION) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_CONSTITUTION, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
                // Pulse_Ability_Drain_Intelligence - Large. -(HD/5) INT, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_INTELLIGENCE) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_INTELLIGENCE, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
                // Pulse_Ability_Drain_Wisdom - Large. -(HD/5) WIS, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_WISDOM) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_WISDOM, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
                // Pulse_Ability_Drain_Charisma - Large. -(HD/5) CHA, if fail fort save VS: 10 + HD.
                if(GetAbilityScore(GlobalSpellTarget, ABILITY_CHARISMA) >= i10)
                    if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_ABILITY_DRAIN_CHARISMA, SpellHostAreaDis, AI_GetPercentageDC(i10+GlobalOurHitDice,SAVING_THROW_FORT))) return TRUE;
            }
            // Pulse_Disease - Varying Save. See diseases.2da, and it is based on the
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDisease) &&
                AI_ActionCastSpellRandom(SPELLABILITY_PULSE_DISEASE, SpellHostAreaDis, i30)) return TRUE;
            // Pulse_Poison - Varying Poison instantly applied. Check nw_s1_pulspois.nss, and poison.2da files.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityPoison) &&
                AI_ActionCastSpellRandom(SPELLABILITY_PULSE_POISON, SpellHostAreaDis, i30)) return TRUE;
        }
        ...
        if(GlobalSeenSpell && InputRangeMediumValid && d10() <= i8)
        {
            ...
            // I really can't be bothered to add in a lot of checks for immunities.
            // Might do later.
            if(!GetHasSpellEffect(SPELLABILITY_BOLT_KNOCKDOWN) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_KNOCKDOWN, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityEntangle) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_WEB, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDisease) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_DISEASE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityPoison) &&
                AI_ActionCastSpellRandom(SPELLABILITY_BOLT_POISON, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel))
            {
        ...
        // Bolts 80% chance. Not too good, but oh well.
        if(GlobalSeenSpell && InputRangeTouchValid && d10() <= i8)
        {
            // Shadow attack
            if(!GetHasSpellEffect(AI_SPELLABILITY_SHADOW_ATTACK, GlobalSpellTarget) && !AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel))
            {
                if(AI_ActionCastSpellRandom(AI_SPELLABILITY_SHADOW_ATTACK, SpellHostTouch, i30, GlobalSpellTarget)) return TRUE;
            }
        }
        // Medium range spells.
        if((InputRangeMediumValid || InputRangeShortValid) && GlobalSeenSpell)
        {
            // Other one 2 - this is magical damage, little powerful... need high intelligence?
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_PSIONIC_MASS_CONCUSSION, SpellHostAreaDis, AI_GetPercentageDC(i15+GlobalOurHitDice/i2,SAVING_THROW_REFLEX),GlobalSpellTarget)) return TRUE;
        }
    ...
    case i3:
            ...
            GlobalSpellTargetRange < fTouchRange)
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityNegativeLevel))
            {
                // PULSE_SPORES - DISEASE_SOLDIER_SHAKES, dc24.
                if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_SPORES, SpellHostAreaInd, AI_GetPercentageDC(i24,SAVING_THROW_FORT))) return TRUE;
            }
        }
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityPetrify))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_BREATH_PETRIFY, FALSE, AI_GetPercentageDC(i17,SAVING_THROW_FORT), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
        }
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel check
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityDeath))
            {
                // Death gazes first - Golem one is the most deadly! dc 17.
                if(AI_ActionCastSpellRandom(SPELLABILITY_GOLEM_BREATH_GAS, FALSE, AI_GetPercentageDC(i17,SAVING_THROW_FORT), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
        }
        // Medium range spells.
        if((InputRangeMediumValid || InputRangeShortValid) && GlobalSeenSpell && d10() <= i8)
        {
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_BEHOLDER_ALLRAYS, SpellHostAreaInd, AI_GetPercentageDC(i15,SAVING_THROW_REFLEX),GlobalSpellTarget)) return TRUE;
        }
        ...
        if(GlobalSeenSpell && InputRangeMediumValid)
        {
            ...
            if(!AI_GetSpellTargetImmunity(GlobalImmunityPetrify))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_TOUCH_PETRIFY, SpellHostTouch, AI_GetPercentageDC(i15,SAVING_THROW_FORT), GlobalSpellTarget)) return TRUE;
            }
        }
        if(InputRangeShortValid && d10() <= i8) // No GlobalNormalSpellsNoEffectLevel check
        {
            // Petrify - SoU.
            if(!AI_GetSpellTargetImmunity(GlobalImmunityPetrify))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_PETRIFY, FALSE, AI_GetPercentageDC(i13,SAVING_THROW_FORT), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            }
        }
        break;
    case i4:
        ...
        {
            // Pulse_Level_Drain - 1 Negative Level, if fail Fort Save, DC: 10 + HD.
            if(AI_ActionCastSpellRandom(SPELLABILITY_PULSE_WHIRLWIND, SpellHostAreaInd, AI_GetPercentageDC(i14,SAVING_THROW_REFLEX))) return TRUE;
        }

        if(InputRangeShortValid  && !AI_GetSpellTargetImmunity(GlobalImmunityCurse)) // No GlobalNormalSpellsNoEffectLevel check
        {
            if(AI_ActionCastSpellRandom(SPELLABILITY_GAZE_DOOM, FALSE, AI_GetPercentageDC(i10+GlobalOurHitDice/i2,SAVING_THROW_WILL), GlobalSpellTarget, FALSE, FALSE)) return TRUE;
        }
        if(InputRangeShortValid && GlobalSeenSpell && !AI_GetSpellTargetImmunity(GlobalImmunityCurse))
        {
            // Doom last. -X's amounts of stats. Also note, don't cast if already
            // affected :-)
            if(!GetHasSpellEffect(SPELLABILITY_HOWL_DOOM))
            {
                if(AI_ActionCastSpellRandom(SPELLABILITY_HOWL_DOOM, SpellHostAreaInd, AI_GetPercentageDC(i10+GlobalOurHitDice/i4,SAVING_THROW_WILL))) return TRUE;
            }
        }
        // Evil Blight. This is an AOE curse, but note that we cannot check
        // if an AOE already has it.
        if(InputRangeMediumValid && !AI_CompareTimeStopStored(AI_SPELL_EVIL_BLIGHT) &&
            ...
            //          !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i6))
        {
            ...
            if(AI_ActionCastSpellRandom(AI_SPELL_EVIL_BLIGHT, SpellHostTouch, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i5,SAVING_THROW_WILL), GlobalSpellTarget, i16, FALSE, ItemHostTouch)) return TRUE;
        }
    ...
    case i5:
        ...
        if(InputRangeShortValid)
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_DISEASE, i40, SpellHostAreaInd, iM1, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire)) return TRUE;
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_POISON, i40, SpellHostAreaInd, iM1, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire)) return TRUE;

            // Cones
            // Uses the AOE object for cone of cold.
            // These are the "Cones". Appropriate to put it here, don'tca think?
            //            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_DISEASE, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            //            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_POISON, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
        }

        // powerful ability damage effect, but too low dc. single target?
        if(AI_ActionCastSpellRandom(SPELLABILITY_SEAHAG_EVILEYE, SpellHostAreaInd, AI_GetPercentageDC(i11,SAVING_THROW_FORT), GlobalSpellTarget)) return TRUE;
            ...
            GetHasSpell(SPELL_GREATER_SHADOW_CONJURATION_WEB) || ItemHostAreaInd == SPELL_GREATER_SHADOW_CONJURATION_WEB))
        {
            // large AOE, medium ranged, reflex based save. Reaction friendly.
            // Beblith version
            if(AI_AttemptCastAOESpellRandom(AI_SPELLABILITY_BEBELITH_WEB, i60, SpellHostRanged, iM1, fMediumRange, RADIUS_SIZE_LARGE, i2, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire)) return TRUE;
        }
        break;
    }
    return FALSE;
...
int AI_AttemptDamageSpells(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    if(GlobalTotalAllies<=i8)
    {
        if(GlobalNormalSpellsNoEffectLevel>i5 || d2()==i1)
        {
            if(AI_AttemptDamageAbility(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;;
            if(AI_AttemptDamageSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
        }
        else
        {
            if(AI_AttemptDamageSpell(iPriority, InputRangeLongValid, InputRangeMediumValid , InputRangeShortValid, InputRangeTouchValid))return TRUE;
...
int AI_AttemptDamageSpell(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    case i0:
        ...
        // Futhest one away.
        // epic spell ignore spell protection.
        if(GlobalSeenSpell)
        {
        ...
        // AOE targets. Most...but not all...are short-range spells.
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel for this. AOE spells may affect someone who is not immune!
        {
            // Storm - a very good AOE spell. May as well use here!
            // AOE is 10M across.
            // - May add in elemental protections check.
            ...
            if(!GlobalInTimeStop && GlobalSpellTargetRange < f6)
            {
                if(AI_ActionCastSpellRandom(SPELL_STORM_OF_VENGEANCE, SpellHostAreaDis, i60, OBJECT_SELF, i19, FALSE, ItemHostAreaDis)) return TRUE;
            }
        }

        // AOE targets. Most...but not all...are short-range spells.
        // why short... no effect in 5m..
        if(InputRangeShortValid) // No GlobalNormalSpellsNoEffectLevel for this. AOE spells may affect someone who is not immune!
        {
            //Meteor Swarm
            ...
            // 40% chance.
            if(AI_GetAreaCheckForMeteor())
            {
                if(AI_ActionCastSpellRandom(SPELL_METEOR_SWARM, SpellHostAreaDis, i60, OBJECT_SELF, i19, FALSE, ItemHostAreaDis)) return TRUE;
            }
        }
        ...
        {
            if(AI_AttemptCastAOESpellRandom(SPELL_INCENDIARY_CLOUD, i60, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_LARGE, i8, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
        if(GlobalNormalSpellsNoEffectLevel < i6)
        {
            // Drown! We don't do this if they are under 30HP already.
            // 80% chance to cast if we have it, and not immune to the save.
            if(InputRangeMediumValid && !AI_CompareTimeStopStored(SPELL_DROWN) &&
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i6) &&
                GlobalSpellTargetCurrentHitPoints >= i30)
            {
                // Drown. level 6 (Druid) Up to 90% of current HP damage done. Fort save for none.
                if(AI_ActionCastSpellRandom(SPELL_DROWN, SpellHostRanged, AI_GetPercentageDC(GlobalSpellBaseSaveDC+i6,SAVING_THROW_FORT), GlobalSpellTarget, i16, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        // Horrid Wilting
            ...
            (GetHasSpell(SPELL_HORRID_WILTING) || ItemHostAreaDis == SPELL_HORRID_WILTING))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_HORRID_WILTING, i60, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_HUGE, i8, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire, TRUE, TRUE)) return TRUE;
        }

        // Fire storm - cast on self with a 10M range around caster (circle). 60% chance.
        if(InputRangeShortValid && GlobalSpellTargetRange <= f8 &&
            GlobalNormalSpellsNoEffectLevel < i8)
            //          !AI_SaveImmuneSpellTarget(SAVING_THROW_REFLEX, i8))
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_FIRE_STORM, SpellHostAreaDis, i50, OBJECT_SELF, i18, FALSE, ItemHostAreaDis)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_DELAYED_BLAST_FIREBALL) || ItemHostAreaInd == SPELL_DELAYED_BLAST_FIREBALL))
        {
            ...
            if(AI_AttemptCastAOESpellToObjectRandom(SPELL_DELAYED_BLAST_FIREBALL, i70, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_HUGE, i7, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
            /*
            // 20M medium range, blast is RADIUS_SIZE_HUGE, lower then Fireball, but more deadly (both save + damage)
            object oAOE = AI_GetBestAreaSpellTarget(fMediumRange, RADIUS_SIZE_HUGE, i7, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, TRUE);
            // Is it valid? 60% chance of casting.
            if(GetIsObjectValid(oAOE))
            {
            // Delayed Fireball Blast. Level 7 (Mage) Up to 20d6 fire reflex damage. Can be set up as a trap (heh, nah!)
            if(AI_ActionCastSpellRandom(SPELL_DELAYED_BLAST_FIREBALL, SpellHostAreaInd, i50, oAOE, i17, FALSE, ItemHostAreaInd)) return TRUE;
            }*/
        }
        ...
        if(InputRangeLongValid && !AI_CompareTimeStopStored(SPELL_CHAIN_LIGHTNING))
            //                             !AI_SaveImmuneSpellTarget(SAVING_THROW_REFLEX, i6))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CHAIN_LIGHTNING, i60, SpellHostAreaDis, ItemHostAreaDis, fLongRange, RADIUS_SIZE_COLOSSAL, i6, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlySelectiveHostile, TRUE)) return TRUE;
        ...
        if(InputRangeMediumValid && !AI_CompareTimeStopStored(SPELL_FIREBRAND) &&
            (GetHasSpell(SPELL_FIREBRAND) || ItemHostRanged == SPELL_FIREBRAND))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_FIREBRAND, i60, SpellHostRanged, ItemHostRanged, fMediumRange, RADIUS_SIZE_COLOSSAL, i5, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlySelectiveHostile, TRUE)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_EARTHQUAKE) || ItemHostAreaInd == SPELL_EARTHQUAKE))
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_EARTHQUAKE, SpellHostAreaInd, i40, OBJECT_SELF, i18, FALSE, ItemHostAreaInd)) return TRUE;
        }

        if(InputRangeLongValid && GlobalNormalSpellsNoEffectLevel < i6)
        {
            // need more check... worst area?
            ...
            if(AI_ActionCastSpellRandom(SPELL_ISAACS_GREATER_MISSILE_STORM, SpellHostRanged, i70, GlobalSpellTarget, i16, FALSE, ItemHostRanged)) return TRUE;
        }

        if(GlobalNormalSpellsNoEffectLevel < i3 && InputRangeLongValid && !GlobalSpellClassRDD)
        {
        ...
        if(//(GlobalAverageEnemyHD >= (GlobalOurHitDice - i5)) &&
            GlobalSpellTargetCurrentHitPoints > i20 && InputRangeTouchValid &&
            ...
            GlobalNormalSpellsNoEffectLevel < i8)// Mass heal = 8.
        {
            if(GlobalSeenSpell && GlobalSpellTargetRace != RACIAL_TYPE_UNDEAD &&
                ...
                !AI_GetSpellTargetImmunity(GlobalImmunityNegativeEnergy))
            {
                // If we are undead, we make sure we leave at least 1 for our own healing. - cant't target self.
                if(GlobalNormalSpellsNoEffectLevel < i6 && GetHasSpell(SPELL_HARM))
                {
                    // Harm
        ...
        // modified magic....
        if(InputRangeMediumValid && !GlobalInTimeStop &&
            (GetHasSpell(SPELL_CREEPING_DOOM) || ItemHostAreaDis == SPELL_CREEPING_DOOM))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CREEPING_DOOM, i50, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_HUGE, i7, FALSE, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }

        // bigby...
        if(InputRangeLongValid && !AI_GetIsBigbyOn(GlobalSpellTarget))
        {
            //modified magic. ignore stun......etc
            // Bigby's Crushing Hand. Level 9 (Mage). 2d6 + 12 damage/round.
            if(GlobalNormalSpellsNoEffectLevel < i9 && !AI_CompareTimeStopStored(SPELL_BIGBYS_CRUSHING_HAND,SPELL_BIGBYS_CLENCHED_FIST,SPELL_BIGBYS_GRASPING_HAND,SPELL_BIGBYS_FORCEFUL_HAND))
            {
            ...
            {
                // Bigby's Clenched Fist. Level 8 (Mage) Attack Each Round. 1d8 + 12 damage/round. Fort VS stunning as well.
                if(AI_ActionCastSpellRandom(SPELL_BIGBYS_CLENCHED_FIST, SpellHostRanged, i50, GlobalSpellTarget, i18, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        ...
        {
            if(AI_AttemptCastAOESpellToObjectRandom(SPELL_BLADE_BARRIER, i60, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_LARGE, i6, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
            /*
            // 20M medium range, large area we'll say. Reflex save
            object oAOE = AI_GetBestAreaSpellTarget(fMediumRange, RADIUS_SIZE_LARGE, i6, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, TRUE);
            // Is it valid? 50% chance of casting.
            if(GetIsObjectValid(oAOE))
            {
            // Blade Barrier. Level 6 (Cleric) Lots of spikes = Lots of damage (to 20d6). Piercing, relfex saves.
            if(AI_ActionCastSpellRandom(SPELL_BLADE_BARRIER, SpellHostAreaInd, i40, oAOE, i16, FALSE, ItemHostAreaInd)) return TRUE;
            }*/
        }
        break;
    case i1:
            ...
            (GetHasSpell(SPELL_ICE_STORM) || ItemHostAreaInd == SPELL_ICE_STORM))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_ICE_STORM, i50, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_HUGE, i4, FALSE, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
            ...
            GetHasSpell(SPELL_CONE_OF_COLD) || ItemHostAreaInd == SPELL_CONE_OF_COLD))
        {
            ...
            if(AI_ActionCastSubSpell(SPELL_SHADES_CONE_OF_COLD, SpellHostAreaInd, GlobalSpellTarget, i17, TRUE, ItemHostAreaInd)) return TRUE;

            if(AI_ActionCastSpellRandom(SPELL_CONE_OF_COLD, SpellHostAreaInd, i50, GlobalSpellTarget, i15, FALSE, ItemHostAreaInd)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_FLAME_STRIKE) || ItemHostAreaInd == SPELL_FLAME_STRIKE))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_FLAME_STRIKE, i50, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, RADIUS_SIZE_MEDIUM, i5, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
        ...
        {
            // need more code, for worst area selection.
            // Ball Lightning. Level 5 (Mage) 1d6/missile, to 15 missiles. Reflex based. Cast at singal target (like missile storms)
            if(AI_ActionCastSpellRandom(SPELL_BALL_LIGHTNING, SpellHostAreaInd, i60, GlobalSpellTarget, i15, FALSE, ItemHostAreaInd)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_BOMBARDMENT) || ItemHostAreaInd == SPELL_BOMBARDMENT))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_BOMBARDMENT, i60, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_COLOSSAL, i8, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }

        // Flame Lash is an alright amount of flame damage.
        if(InputRangeShortValid && !GlobalSpellClassRDD && !AI_SaveImmuneSpellTarget(SAVING_THROW_REFLEX, i2))
        {
            // [Flame Lash] 2d6 + 1d6/3 caster levels of fire damage. Reflex save.
            if(AI_ActionCastSpellRandom(SPELL_FLAME_LASH, SpellHostRanged, i60, GlobalSpellTarget, i12, FALSE, ItemHostRanged)) return TRUE;
        }

        // Acid fog - slow, and damage in acid fog.
        // Decent..but ...well, its alright :-)
        // THIS is spell 0 spell :-) we cast 100% and no backup casting.
        if(InputRangeLongValid && SpellHostAreaInd && !GlobalInTimeStop &&
            (GetHasSpell(SPELL_ACID_FOG) || SpellHostAreaInd == SPELL_ACID_FOG))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_ACID_FOG, i70, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_LARGE, i6, SAVING_THROW_FORT, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_CLOUDKILL) || ItemHostAreaInd == SPELL_CLOUDKILL))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CLOUDKILL, i70, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_LARGE, i5, FALSE, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_PRISMATIC_SPRAY) || ItemHostAreaInd == SPELL_PRISMATIC_SPRAY))
        {
            // 8M short range, blast is a cone, and no save. Spell script has fSpread at 11.0
            // Prismatic Spray. Level 7 (Mage) Random damage/effects. Chance of doing double amount of effects.
            if(AI_AttemptCastAOESpellRandom(SPELL_PRISMATIC_SPRAY, i70, SpellHostAreaInd, ItemHostAreaInd, f11, f11, i7, FALSE, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            // Is it valid? 40% chance of casting.
            //            if(AI_ActionCastSpellRandom(SPELL_PRISMATIC_SPRAY, SpellHostAreaInd, i40, GlobalSpellTarget, i17, FALSE, ItemHostAreaInd)) return TRUE;
        }

        if(GlobalSpellTargetRace == CLASS_TYPE_CONSTRUCT)
        {
        ...
        if(SpellHostAreaDis && InputRangeLongValid &&
            (GetHasSpell(SPELL_CALL_LIGHTNING) || ItemHostAreaDis == SPELL_CALL_LIGHTNING))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CALL_LIGHTNING, i70, SpellHostAreaDis, ItemHostAreaDis, fLongRange, RADIUS_SIZE_HUGE, i3, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlySelectiveHostile, TRUE)) return TRUE;
        }

        if(GlobalNormalSpellsNoEffectLevel < i7 &&
            GlobalSeenSpell && InputRangeShortValid &&
            !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
            !AI_CompareTimeStopStored(SPELL_DESTRUCTION))
        {
            // Note: No items, because it will be a much lower save.
            // Destruction, level 7 (Cleric). Fort (Death) for Death if fail, or 10d6 damage if pass.
            if(AI_ActionCastSpellRandom(SPELL_DESTRUCTION, SpellHostRanged, i70, GlobalSpellTarget, i17)) return TRUE;
        }

        break;
    case i2:
        if(GlobalNormalSpellsNoEffectLevel < i4 && InputRangeLongValid)
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_ISAACS_LESSER_MISSILE_STORM, SpellHostRanged, i70, GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
        }
            ...
            (GetHasSpell(SPELL_LIGHTNING_BOLT) || ItemHostAreaInd == SPELL_LIGHTNING_BOLT))
        {
            ...
            //            if(AI_AttemptCastAOESpellRandom(SPELL_LIGHTNING_BOLT, i50, SpellHostAreaInd, ItemHostAreaInd, fMediumRange, f30, i3, SAVING_THROW_REFLEX, SHAPE_SPELLCYLINDER, GlobalFriendlyFire, TRUE)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELL_LIGHTNING_BOLT, SpellHostAreaInd, i60, GlobalSpellTarget, i13, FALSE, ItemHostAreaInd)) return TRUE;
        }
        ...
        {
            // false in last checking loop, don't check again.
            if(!GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_FIREBALL)))
            {

                // Huge, long ranged, reflex based save. Shades == No enemies hit.
                object oAOE = AI_GetBestAreaSpellTarget(fLongRange, RADIUS_SIZE_HUGE, i3, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, TRUE);
                ...
                {
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_FIREBALL),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_FIREBALL)));
                }
            }
        }
            ...
            GetHasSpell(SPELL_SCINTILLATING_SPHERE) || ItemHostAreaInd == SPELL_SCINTILLATING_SPHERE))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_FIREBALL, i70, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_HUGE, i3, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE))return TRUE;
            // Scintillating Sphere. Level 3 (Mage) Explosion of up to 10d6 Damage (Electical) - An electiric fireball (reflex save)
            if(AI_AttemptCastAOESpellRandom(SPELL_SCINTILLATING_SPHERE, i70, SpellHostAreaInd, ItemHostAreaInd, fLongRange, RADIUS_SIZE_HUGE, i3, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE))return TRUE;
        }
            ...
            (GetHasSpell(SPELL_MESTILS_ACID_BREATH) || ItemHostAreaDis == SPELL_MESTILS_ACID_BREATH))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_MESTILS_ACID_BREATH, i60, SpellHostAreaInd, ItemHostAreaInd, fShortRange, f11, i3, SAVING_THROW_REFLEX, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            // Is it valid? 60% chance of casting.
            //            if(AI_ActionCastSpellRandom(SPELL_MESTILS_ACID_BREATH, SpellHostAreaInd, i50, GlobalSpellTarget, i13, FALSE, ItemHostAreaInd)) return TRUE;
        }

        break;
    case i3:

        if(GlobalNormalSpellsNoEffectLevel < i3 && InputRangeTouchValid && GlobalSpellTargetRace != RACIAL_TYPE_UNDEAD && !AI_GetSpellTargetImmunity(GlobalImmunityNegativeEnergy))
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_VAMPIRIC_TOUCH, SpellHostTouch, i40, GlobalSpellTarget, i13, FALSE, ItemHostTouch)) return TRUE;
        }
        ...
        if(GlobalSeenSpell && InputRangeShortValid)
        {
            // Glyph of Warding. Level 3 (Mage) AOE, if entered, does up to 1d6/2 caster levels (to 5d6) damage.
            if(AI_ActionCastSpellRandom(SPELL_GLYPH_OF_WARDING, SpellHostAreaInd, i60, GlobalSpellTarget, i13, FALSE, ItemHostAreaInd)) return TRUE;
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i5)
        {
            ...
            // ---- No save!!
            if(InputRangeShortValid && !GetHasSpellEffect(SPELL_INFERNO))
            {
                // Inferno. Level 5 (Druid) 2d6 Fire damage/round like acid arrow. No save, only SR.
                if(AI_ActionCastSpellRandom(SPELL_INFERNO, SpellHostRanged, i60, GlobalSpellTarget, i15, FALSE, ItemHostRanged)) return TRUE;
            }
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i3 && InputRangeMediumValid)
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_SEARING_LIGHT, SpellHostRanged, i60, GlobalSpellTarget, i13, FALSE, ItemHostRanged)) return TRUE;
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i2 && InputRangeLongValid)
        {
    ...
    case i4:
        if(GlobalNormalSpellsNoEffectLevel < i7 &&
            GlobalSeenSpell && InputRangeShortValid &&
            !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
            !AI_CompareTimeStopStored(SPELL_FINGER_OF_DEATH))
        {
            // Note: No items, because it will be a much lower save.
            // Destruction, level 7 (Cleric). Fort (Death) for Death if fail, or 10d6 damage if pass.
            if(AI_ActionCastSpellRandom(SPELL_FINGER_OF_DEATH, SpellHostRanged, i60, GlobalSpellTarget, i17)) return TRUE;
        }

        if(GlobalNormalSpellsNoEffectLevel < i5 &&
            InputRangeTouchValid && !AI_CompareTimeStopStored(SPELL_SLAY_LIVING) &&
            !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy))
            //          !AI_SaveImmuneSpellTarget(SAVING_THROW_FORT, i5))
        {
            // Slay living. 60% chance to cast - it is a touch spell.
            ...
            (GetHasSpell(SPELL_CIRCLE_OF_DOOM) || ItemHostAreaDis == SPELL_CIRCLE_OF_DOOM))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_CIRCLE_OF_DOOM, i50, SpellHostAreaDis, ItemHostAreaDis, fMediumRange, RADIUS_SIZE_MEDIUM, i5, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE, TRUE)) return TRUE;
        }

        if(//GlobalNormalSpellsNoEffectLevel < i3 &&
            InputRangeTouchValid &&
            !AI_GetSpellTargetImmunity(GlobalImmunityNecromancy) &&
            !AI_GetSpellTargetImmunity(GlobalImmunityNegativeEnergy))
        {
            ...
            if(AI_ActionCastSpellRandom(SPELL_HEALING_STING, SpellHostTouch, i50, GlobalSpellTarget, i13, FALSE, ItemHostTouch)) return TRUE;
        }
        ...
        {
            // false in last checking loop, don't check again.
            if(!(GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_WALL_OF_FIRE)) ||
                GetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_WALL_OF_FIRE))))
            {

                // Ok, retangle. Take it as a medium sized sphere.
                object oAOE = AI_GetBestAreaSpellTarget(fMediumRange, RADIUS_SIZE_MEDIUM, i4, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, FALSE, FALSE, TRUE);
                // Is it valid? 50% chance of casting.
                if(GetIsObjectValid(oAOE))
                {
                    // Shades version
                    if(AI_ActionCastSubSpell(SPELL_SHADES_WALL_OF_FIRE, SpellHostAreaInd, oAOE, i14, FALSE, ItemHostAreaInd)) return TRUE;

                    // Wall of Fire. Level 4 (Mage) 5 (Druid) 4d6 fire reflex damage in a retangle persistant AOE
                    if(AI_ActionCastSpellRandom(SPELL_WALL_OF_FIRE, SpellHostAreaInd, i60, oAOE, i14, FALSE, ItemHostAreaInd)) return TRUE;
                }
                else
                {
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_WALL_OF_FIRE),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_WALL_OF_FIRE)));
                    SetLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_WALL_OF_FIRE),TRUE);
                    DelayCommand(f2,DeleteLocalInt(OBJECT_SELF,AI_CHECKED_AOE_SPELL+IntToString(SPELL_SHADES_WALL_OF_FIRE)));
                }
            }
        }
        ...
        break;
    case i5:
        if(GlobalNormalSpellsNoEffectLevel < i1)
        {
            // Magic Missile - Is a nice long range spell. Can do damage to almost anything.
            if(InputRangeLongValid && !GetHasSpellEffect(SPELL_SHIELD, GlobalSpellTarget))
            {
                if(d10() <= i6)
                {
                    // Shad. conjuration
            ...
            (GetHasSpell(SPELL_BURNING_HANDS) || ItemHostAreaInd == SPELL_BURNING_HANDS))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_BURNING_HANDS, i60, SpellHostAreaInd, ItemHostAreaInd, fShortRange, f10, i1, SAVING_THROW_REFLEX, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            // Is it valid? 70% chance of casting.
            // Burning Hands. Level 1 (Mage) 1d4/level to 5d4 Reflex Fire damage to a cone AOE.
            //            if(AI_ActionCastSpellRandom(SPELL_BURNING_HANDS, SpellHostAreaInd, i60, GlobalSpellTarget, i11, FALSE, ItemHostAreaInd)) return TRUE;
        }
        ...
        {
            // Phantismal Killer. Will and Fortitude save VS death. :-)
            if(InputRangeMediumValid && !AI_CompareTimeStopStored(SPELL_PHANTASMAL_KILLER) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityFear) &&
                !AI_GetSpellTargetImmunity(GlobalImmunityMind))
                //              !AI_SaveImmuneSpellTarget(SAVING_THROW_WILL, i4))
            {
                // Phantasmal Killer. Level 4 (Mage). Will save (Illusion) then fort save, or death.
                if(AI_ActionCastSpellRandom(SPELL_PHANTASMAL_KILLER, SpellHostRanged, i60, GlobalSpellTarget, i14, FALSE, ItemHostRanged)) return TRUE;
            }
        }

        if(GlobalNormalSpellsNoEffectLevel < i3 && InputRangeShortValid)
        {
            // Quillfire. Level 3 (Mage) 1 quill at 1d8 + 1-5 damage. Scorpion poison too.
            if(AI_ActionCastSpellRandom(SPELL_QUILLFIRE, SpellHostRanged, i40, GlobalSpellTarget, i13, FALSE, ItemHostRanged)) return TRUE;
        }
        ...
        if(SpellHostAreaDis && InputRangeShortValid &&
            (GetHasSpell(SPELL_GEDLEES_ELECTRIC_LOOP) || ItemHostAreaDis == SPELL_GEDLEES_ELECTRIC_LOOP))
        {
            ...
            if(AI_AttemptCastAOESpellRandom(SPELL_GEDLEES_ELECTRIC_LOOP, i60, SpellHostAreaDis, ItemHostAreaDis, fShortRange, RADIUS_SIZE_SMALL, i2, SAVING_THROW_REFLEX, SHAPE_SPHERE, GlobalFriendlyFire, TRUE)) return TRUE;
        }
        ...
        if(GlobalNormalSpellsNoEffectLevel < i1)
        {
            ...
            if(InputRangeMediumValid && !GetHasSpellEffect(SPELL_FLARE, GlobalSpellTarget) &&
...
int AI_AttemptDamageAbility(int iPriority, int InputRangeLongValid = FALSE, int InputRangeMediumValid = FALSE, int InputRangeShortValid = FALSE, int InputRangeTouchValid = FALSE)
{
    ...
    case i0:
        ...
        if(InputRangeTouchValid && !GlobalInTimeStop &&
            GlobalSpellTargetRange < fTouchRange)
        {
            // Pulse_Cold - Huge. d6(HD) in cold damage. Reflex Save, DC: 10 + HD
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_COLD)) return TRUE;
            // Pulse_Fire - Huge. d6(HD) in fire damage. Reflex Save, DC: 10 + HD
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_FIRE)) return TRUE;
            // Pulse_Holy - Large. Heals (Non-undead) allies. Harms all undead. Damage/Heal: d4(HD). Reflex Save, DC: 10 + HD.
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_HOLY)) return TRUE;
            // Pulse_Lightning - Huge. d6(HD) in electrical damage. Reflex Save, DC: 10 + HD
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_LIGHTNING)) return TRUE;
            // Pulse_Negative - Large. Heals (Undead) allies. Harms all non-undead. Damage/Heal: d4(HD). Reflex Save, DC: 10 + HD.
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_NEGATIVE)) return TRUE;
        }
        // Bolts 80% chance. Not too good, but oh well.
        if(GlobalSeenSpell && InputRangeMediumValid)
        {
            ...
            // I really can't be bothered to add in a lot of checks for immunities.
            // Might do later.
            if(AI_ActionCastSpellRandom(SPELLABILITY_BOLT_ACID, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_BOLT_COLD, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(!GlobalSpellClassRDD && AI_ActionCastSpellRandom(SPELLABILITY_BOLT_FIRE, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_BOLT_LIGHTNING, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_BOLT_SHARDS, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
        }
        // Medium range spells.
        if((InputRangeMediumValid || InputRangeShortValid) && GlobalSeenSpell)
        {
            // slaad's chaos spittle.. ranged touch, magic damage.
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_SLAAD_CHAOS_SPITTLE, SpellHostRanged, i30,GlobalSpellTarget)) return TRUE;
            // Other one 2 - this is magical damage, little powerful... need high intelligence?
            if(AI_ActionCastSpellRandom(AI_SPELLABILITY_PSIONIC_MASS_CONCUSSION, SpellHostAreaDis, i30,GlobalSpellTarget)) return TRUE;
        }
    ...
    case i1:
        ...
        if(InputRangeTouchValid && !GlobalInTimeStop &&
            GlobalSpellTargetRange < fTouchRange)
        {
            // Pulse_Whirlwind - Large. Reflex DC 14 check, or Knockdown (2 rounds) and d3(HD) Damage.
            if(AI_ActionCastSpell(SPELLABILITY_PULSE_WHIRLWIND)) return TRUE;
        }
        ...
        if(InputRangeShortValid)
        {
            ...
            /*
            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_ACID, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_COLD, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_FIRE, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_LIGHTNING, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            if(AI_ActionCastSpellRandom(SPELLABILITY_CONE_SONIC, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
            */
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_ACID, i40, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_COLD, i40, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_FIRE, i40, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_LIGHTNING, i40, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_CONE_SONIC, i40, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
        }

        break;
    case i2:
        // Golem ranged slam. 80% chance of using.
        if(InputRangeLongValid && GlobalSeenSpell)
        {
            ...
            GlobalSpellTargetReflex < (i19 + (GetLevelByClass(CLASS_TYPE_DRAGONDISCIPLE) - i10)/i4))
        {
            ...
            {
                ActionCastSpellAtObject(690,GlobalSpellTarget,METAMAGIC_ANY,TRUE);
        ...
        // Most are decent enough to cast as level 6 spells, centred on self, 80% chance to cast.
        // We also randomly choose one (and always cast one if we can cast one :-) )
        if(InputRangeTouchValid && GlobalSeenSpell && d10() <= i8)
        {
        ...
        if(InputRangeLongValid && GlobalSeenSpell)
        {
            ...
            if(AI_ActionCastSpell(AI_SPELLABILITY_GIANT_HURL_ROCK, SpellHostRanged, GlobalSpellTarget, FALSE, FALSE)) return TRUE;

            // Battle Boulder Toss - from Campaign, but is an ability too. d6(3)+5 Bud dam.
            if(AI_ActionCastSpell(AI_SPELLABILITY_BATTLE_BOULDER_TOSS, SpellHostRanged, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
        }
    ...
    case i3:
        ...
        if(InputRangeShortValid)
        {
            ...
            // - Take it as no level, and no save. These scale up with the HD of the
            //   monster, so on average should be used all the time.
            if(AI_AttemptCastAOESpellRandom(SPELLABILITY_HELL_HOUND_FIREBREATH, i50, SpellHostAreaInd, FALSE, fShortRange, f11, FALSE, SAVING_THROW_ALL, SHAPE_SPELLCONE, GlobalFriendlyFire, TRUE)) return TRUE;
            //            if(AI_ActionCastSpellRandom(SPELLABILITY_HELL_HOUND_FIREBREATH, SpellHostAreaInd, i40, GlobalSpellTarget, FALSE, FALSE)) return TRUE;
        }
        ...
        if(GlobalSeenSpell && InputRangeMediumValid)
        {
            ...
            // Azer blast
            if(!GlobalSpellClassRDD && AI_ActionCastSpellRandom(AI_SPELLABILITY_AZER_FIRE_BLAST, SpellHostRanged, i30, GlobalSpellTarget)) return TRUE;
        }
        break;
    case i4:
...
int AI_AttemptAddBuffSpells(int iPriority)
{
    ...
    case i0:
        ...
        // Divine Shield - a feat, but a damn good one.
        // Up to +5 Dodge AC.
        if(!GetHasFeatEffect(FEAT_DIVINE_SHIELD) && GetHasFeat(FEAT_TURN_UNDEAD) && GetAbilityModifier(ABILITY_CHARISMA)>=i7 && GlobalOurAC+GetAbilityModifier(ABILITY_CHARISMA)>GlobalMeleeTargetBestAttackBonus)
        {
            // Divine Shield
            if(AI_ActionUseFeatOnObject(FEAT_DIVINE_SHIELD)) return TRUE;
        }
        ...
        // Level 9 (Cleric)
        if(!GetHasSpellEffect(SPELL_UNDEATHS_ETERNAL_FOE) && AI_ActionCastSpell(SPELL_UNDEATHS_ETERNAL_FOE, SpellEnhSinTar, OBJECT_SELF, i19, FALSE, ItemEnhSinTar, PotionEnh)) return TRUE;

        // Cast regeneration + Natures Balance here if we are lacking HP.
        if(GlobalOurPercentHP <= i70)
        {
        ...
        if(!GlobalAntiMeleeWarrior && // there is casters, at least one.
            GlobalMeleeAttackers <= i1 /*We won't cast it with melee attackers - cast phisicals first*/ &&
            !GlobalInTimeStop && GlobalIntelligence >= i7 &&
            !AI_GetAIHaveSpellsEffect(GlobalHasMantalProtections) &&
    ...
    case i4:
        ...
        if(GetAlignmentGoodEvil(GlobalMeleeTarget) == ALIGNMENT_GOOD &&
        ...
        else if(GetAlignmentGoodEvil(GlobalMeleeTarget) == ALIGNMENT_EVIL &&
    ...
    case i5:
        ...
        if(GlobalOurPercentHP >= i60 && !GlobalEnemiesIn4Meters)
        {
...
int AI_AttmeptAllyBuffSpells(int iPriority)
{
    ...
    if(AI_ActionCastAllyBuffSpell(f6, i60, SPELL_MASS_HASTE, SPELL_HASTE, iM1, iM1, iM1, iM1, GlobalEffectHaste, FALSE)) return TRUE;
    ...
    if(GetBaseAttackBonus(GlobalSpellTarget) < GlobalSpellTargetHitDice - i2)
    {
        ...
        if(AI_ActionCastAllyBuffSpell(f10, i60, SPELL_NEGATIVE_ENERGY_PROTECTION)) return TRUE;
    }
...
int AI_AttemptSummonSpells()
{
    //    // if there are more allies, than do not summon(for prevent overheat)
    //    if(GlobalTotalAllies>GlobalTotalSeenHeardEnemies) return FALSE;

    object oSummon = GetAssociate(ASSOCIATE_TYPE_SUMMONED);
    if(GetIsObjectValid(oSummon) &&
        !(GetIsDead(oSummon) || GetHasSpellEffect(SPELL_FLESH_TO_STONE,oSummon))) return FALSE;

    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i12)
    {
    ...
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i11)
    {
    ...
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i10 &&
    ...
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i9)
    {
    ...
    if(GlobalCanSummonSimilarLevel <= i8 &&
        (GlobalOurHitDice <= i20 || GlobalMeleeAttackers <= i2))
    {
        // Create Greater undead - Pale Master
        //        if(AI_ActionCastSummonSpell(SPELLABILITY_PM_SUMMON_GREATER_UNDEAD, i0, i8)) return TRUE;
        if(GetHasFeat(AI_FEAT_PM_CREATE_GREATER_UNDEAD))
        {
            ActionCastSpellAtObject(SPELLABILITY_PM_SUMMON_GREATER_UNDEAD,OBJECT_SELF,METAMAGIC_NONE,TRUE);
            DecrementRemainingFeatUses(OBJECT_SELF,AI_FEAT_PM_CREATE_GREATER_UNDEAD);
            return TRUE;
        }

        // Create Greater Undead. Level 8 (Cleric) Create Vampire, Doom knight, Lich, Mummy Cleric.
        if(!GlobalSpellFailure && AI_ActionCastSummonSpell(SPELL_CREATE_GREATER_UNDEAD, i18, i8)) return TRUE;
        // Summon an Greater elemental. Summon 8 - Druid/Cleric/Bard/Mage.
        if(!GlobalSpellFailure && AI_ActionCastSummonSpell(SPELL_SUMMON_CREATURE_VIII, i18, i8)) return TRUE;
        // Greater Planar Binding. Level 8 (Mage) Death Slaad (Evil) Vrock (Neutral) Trumpet Archon (Good)
        if(!GlobalSpellFailure && AI_ActionCastSummonSpell(SPELL_GREATER_PLANAR_BINDING, i18, i8)) return TRUE;
    }

    // - Shadow based on level
    //        if(AI_ActionCastSummonSpell(SPELLABILITY_BG_FIENDISH_SERVANT, i0, i7)) return TRUE;
    if(GetHasFeat(AI_FEAT_BG_FIENDISH_SERVANT))
    {
        ActionCastSpellAtObject(SPELLABILITY_BG_FIENDISH_SERVANT,OBJECT_SELF,METAMAGIC_NONE,TRUE);
        DecrementRemainingFeatUses(OBJECT_SELF,AI_FEAT_BG_FIENDISH_SERVANT);
        return TRUE;
    }

    if(GlobalAverageEnemyHD>i15) return FALSE;

    // Level 7 summon spells. Also cast the unique class-based summons (like
    // a blackguards undead, a shadowdancers shadow ETC).
    if(GlobalCanSummonSimilarLevel <= i7)
    {
        ...
        {
            ActionCastSpellAtObject(SPELL_SUMMON_SHADOW,OBJECT_SELF,METAMAGIC_NONE,TRUE);
            DecrementRemainingFeatUses(OBJECT_SELF,FEAT_SUMMON_SHADOW);
            return TRUE;
        }
        // - Undead warrior (EG: doomknight) based on level
        //        if(AI_ActionCastSummonSpell(SPELLABILITY_BG_CREATEDEAD, i0, i7)) return TRUE;
        if(GetHasFeat(AI_FEAT_BG_CREATE_UNDEAD))
        {
            ActionCastSpellAtObject(SPELLABILITY_BG_CREATEDEAD,OBJECT_SELF,METAMAGIC_NONE,TRUE);
        ...
        // Pale master
        //        if(AI_ActionCastSummonSpell(SPELLABILITY_PM_SUMMON_UNDEAD, i0, i7)) return TRUE;
        if(GetHasFeat(AI_FEAT_PM_CREATE_UNDEAD))
        {
            ActionCastSpellAtObject(SPELLABILITY_PM_SUMMON_UNDEAD,OBJECT_SELF,METAMAGIC_NONE,TRUE);
            DecrementRemainingFeatUses(OBJECT_SELF,AI_FEAT_PM_CREATE_UNDEAD);
            return TRUE;
        }

        // Then, the normal summons.
        if(!GlobalSpellFailure && GlobalOurHitDice <= i18 || GlobalMeleeAttackers <= i2)
        {
    ...
    // Level 6 summons
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i6 &&
        (GlobalOurHitDice <= i16 || GlobalMeleeAttackers <= i2))
    {
        ...
        if(AI_ActionCastSummonSpell(SPELL_CREATE_UNDEAD, i16, i6)) return TRUE;
    ...
    if(GlobalAverageEnemyHD>i13) return FALSE;

    // Level 5 summons
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i5 &&
    ...
    // Level 4 summons
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i4 &&
    ...
    // Level 3 summons
    if(GlobalCanSummonSimilarLevel <= i3 &&
        (GlobalOurHitDice <= i10 || GlobalMeleeAttackers <= i2))
    {
        // Pale master
        //        if(AI_ActionCastSummonSpell(SPELLABILITY_PM_ANIMATE_DEAD, i0, i3)) return TRUE;
        if(GetHasFeat(AI_FEAT_PM_ANIMATE_DEAD))
        {
            ActionCastSpellAtObject(SPELLABILITY_PM_ANIMATE_DEAD,OBJECT_SELF,METAMAGIC_NONE,TRUE);
            DecrementRemainingFeatUses(OBJECT_SELF,AI_FEAT_PM_ANIMATE_DEAD);
            return TRUE;
        }

        // Animate Dead. Level 3 (Mage). Skeleton or zomie summon. Tough DR, long lasting, but hard to heal.
        if(!GlobalSpellFailure && AI_ActionCastSummonSpell(SPELL_ANIMATE_DEAD, i13, i3)) return TRUE;

        // Summon Monster III (3). Level 3 (Most classes) Summons a Dire Wolf.
        if(!GlobalSpellFailure && AI_ActionCastSummonSpell(SPELL_SUMMON_CREATURE_III, i13, i3)) return TRUE;
    }

    // Level 2 summons
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i2 &&
    ...
    // Level 1 summons
    if(!GlobalSpellFailure && GlobalCanSummonSimilarLevel <= i1 && GlobalOurHitDice <= i10 &&
...
int AI_CoreBuffSpell()
{
    ...
    if(!GlobalAntiArcaneSpellCaster)
    {
        // Stoneskin - protection from attackers.
        if(AI_SpellWrapperPhisicalProtections()) return TRUE;
...
void AI_DetermineCombatRound(object oIntruder = OBJECT_INVALID)
{
    ...
    {
        DelayCommand(f1,DetermineCombatRound(oIntruder));
        return;
    }
    ...
    if(!GlobalInTimeStop)
    {
        if(GetAIInteger(AI_LAST_CALLED_TIME))return;
        SetAIInteger(AI_LAST_CALLED_TIME,TRUE);
        DelayCommand(1.45f,DeleteAIInteger(AI_LAST_CALLED_TIME));
        /*
        int ilast=GetAIInteger(AI_LAST_CALLED_TIME);
        int icur=GetTimeSecond()*1000+GetTimeMillisecond();
        if(((icur<ilast)?icur+60000:icur)-ilast<1450) return;
        SetAIInteger(AI_LAST_CALLED_TIME,icur);
        */
    }

    // location targeting check
    GlobalLocationTargetFail=FALSE;
    if(GetAIInteger(AI_AOE_LOCATION_TARGETING_FAILED))
    {
        GlobalLocationTargetFail=TRUE;
    }
    else
    {
        int nSpell=GetAIInteger(AI_LAST_CASTED_AOE_SPELL);
        int nSpellNum=GetAIInteger(AI_LAST_CASTED_AOE_SPELL_NUM);
        if(GetHasSpell(nSpell) && (GetHasSpell(nSpell)==nSpellNum))
        {
            GlobalLocationTargetFail=TRUE;
            SetAIInteger(AI_AOE_LOCATION_TARGETING_FAILED,TRUE);
        }
    }


    // check position change for block check.
    AI_BlockedCheck();

    GlobalDelayTime=AI_GetAIHaveEffect(GlobalEffectHaste)?1.5:f3;
    ...
    else if(AI_GetAIHaveEffect(GlobalEffectDazed))
    {
        ...
        AI_AntiCornerMoveAway(GlobalNearestEnemyHeard,FALSE,f40,GlobalIamBlocked);
        return;
    }
    // Tempory integer
    int iTempInt;
    ...
    // Last Attacker Set
    GlobalLastAttacker = GetLocalObject(OBJECT_SELF,AI_TO_ATTACK);
    if(GlobalValidNearestSeenEnemy)
    {
        GlobalLastAttacker = GlobalNearestEnemySeen;
    }
    else if(GlobalValidNearestHeardEnemy)
    {
        GlobalLastAttacker = GlobalNearestEnemyHeard;
    }
    else if(!GetIsObjectValid(GlobalLastAttacker) || !GetIsEnemy(GlobalLastAttacker) || GetIsDead(GlobalLastAttacker) || GetIsDM(GlobalLastAttacker) || GetIgnore(GlobalLastAttacker) || GetArea(OBJECT_SELF)!=GetArea(GlobalLastAttacker))
    {
        GlobalLastAttacker = GetLastHostileActor();
        if(!GetIsObjectValid(GlobalLastAttacker) || !GetIsEnemy(GlobalLastAttacker) || GetIsDead(GlobalLastAttacker) || GetIsDM(GlobalLastAttacker) || GetIgnore(GlobalLastAttacker) || GetArea(OBJECT_SELF)!=GetArea(GlobalLastAttacker))
        {
            GlobalLastAttacker = OBJECT_INVALID;
        }
    }
    SetLocalObject(OBJECT_SELF,AI_TO_ATTACK,GlobalLastAttacker);
    GlobalLastAttackerValid = GetIsObjectValid(GlobalLastAttacker);
    GlobalNoneSeenHeardEnemy = !(GlobalValidNearestSeenEnemy || GlobalValidNearestHeardEnemy || GetObjectSeen(GlobalLastAttacker) || GetObjectHeard(GlobalLastAttacker));

    // Turn of searching and hiding here, if we want to!
    if(GlobalValidNearestSeenEnemy && !GetHasFeat(FEAT_KEEN_SENSE) && GetDetectMode(OBJECT_SELF) == DETECT_MODE_ACTIVE)
    {
        SetActionMode(OBJECT_SELF, ACTION_MODE_DETECT, FALSE);
    }
    ...
    // black blade of disaster && ethereal
    // don't attack and cast spell, just move around
    object oSummon=GetAssociate(ASSOCIATE_TYPE_SUMMONED);
    if(AI_GetAIHaveEffect(GlobalEffectEthereal)
        && GetIsObjectValid(oSummon)
        && GetLocalInt(oSummon,"X2_L_CREATURE_NEEDS_CONCENTRATION")
        && GlobalValidNearestSeenEnemy
        && !GetObjectSeen(OBJECT_SELF,GlobalNearestEnemySeen))
    {
        if(GlobalRangeToNearestEnemy>f8)
        {
            ActionMoveToObject(GlobalNearestEnemySeen,FALSE,f7);
        }
        else
        {
            AI_AntiCornerMoveAway(GlobalNearestEnemySeen,FALSE,f6);
        }
        DelayCommand(GlobalDelayTime,DetermineCombatRound(oIntruder));
        // need more code !!
        // move out of aoe or near enemy
        return;
    }
    ...
    if(GlobalAnyValidTargetObject)
    {
        ...
        // we can use this twice : haste, potion, kit(multiple).
        //        if(AI_AttemptHealingSelf()){return;}
        if(AI_AttemptHealingSelf()==i2)
        {
            return;
        }
        ...
        // dispel ally for remove bigby effect.
        if(AI_AttemptCureCondition()){return;}

        // tactical flee and hide
        if(AI_TacticFleeHide())return;
        ...
        if(AI_GetIsDragon() && !AI_GetAIHaveEffect(GlobalEffectPolymorph))
        {
        ...
        else
        {
            ...
            // Spells attempt
            // overheat prevent
            if(GlobalTotalAllies>i8 || GlobalSilenceSoItems==i2)
            {
                int iSpellToggle=GetLocalInt(OBJECT_SELF,AI_SPELL_HIGH_LOW_TOGGLE);
                if(iSpellToggle)
                {
                    if(AI_AttemptAllSpells(i10,i6,i1)){return;}
                }
                else
                {
                    if(AI_AttemptAllSpells(i6,i0,i1)){return;}
                }
                SetLocalInt(OBJECT_SELF,AI_SPELL_HIGH_LOW_TOGGLE,!iSpellToggle);
                if(!GlobalIamBlockedByObject && AI_GetIsSpellCaster(OBJECT_SELF) && (SpellAnySpellValid || GobalOtherItemsValid))
                {
                    if(GlobalRangeToNearestEnemy<f5)
                    {
                        AI_AntiCornerMoveAway(GlobalNearestEnemySeen,FALSE,f6);
                    }
                    else if(GlobalSilenceSoItems==i2)
                    {
                        GlobalSilenceSoItems=FALSE;
                        if(!GetLocalTimer(AI_DISPEL_CASTED_TIMER))SetLocalTimer(AI_DISPEL_CASTED_TIMER,f1);
                        if(AI_AttemptAllSpells(i4,i0,i1)){return;}
                    }
                    DelayCommand(GlobalDelayTime,DetermineCombatRound(oIntruder));
                    return;
                }
