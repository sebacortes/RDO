...
void main()
{
   ...
   if(GetHasFeatEffect(413) == FALSE)
   {
        ...
        if (GetHasFeat(FEAT_EPIC_DIVINE_MIGHT, OBJECT_SELF)) {
        ...
        if (nCharismaBonus>0)
        {
            ...
            int damageType = Item_GetWeaponDamageType(GetItemInSlot(INVENTORY_SLOT_RIGHTHAND, OBJECT_SELF));

            effect eDamage1 = EffectDamageIncrease(nDamage1,damageType);
